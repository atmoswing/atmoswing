...
target_link_libraries(asbase -lcurl)
target_link_libraries(atmoswing-forecaster -lcurl)
target_link_libraries(atmoswing-tests -lcurl)
...
if (BUILD_FORECASTER)
    ...
    if (PATH_CURL)
        ...
        add_dependencies(atmoswing-forecaster libcurl)
        target_link_libraries(atmoswing-forecaster -lcurl)
    endif (PATH_CURL)
    if (PATH_JASPER)
        target_link_libraries(atmoswing-forecaster ${JASPER_LIBRARIES})
    else (PATH_JASPER)
        add_dependencies(atmoswing-forecaster jasper)
        target_link_libraries(atmoswing-forecaster -ljasper)
    endif (PATH_JASPER)
...
if (BUILD_VIEWER)
    ...
    if (PATH_CURL)
        ...
        add_dependencies(atmoswing-viewer libcurl)
        target_link_libraries(atmoswing-viewer -lcurl)
    endif (PATH_CURL)
...
if (BUILD_TESTS)
    ...
    if (PATH_CURL)
        ...
        add_dependencies(atmoswing-tests libcurl)
        target_link_libraries(atmoswing-tests -lcurl)
    endif (PATH_CURL)
