if (BUILD_FORECASTER)
    ...
    target_link_libraries(atmoswing-forecaster ${GRIB2C_LIBRARIES})
...
if (BUILD_VIEWER)
    ...
    target_link_libraries(atmoswing-viewer ${GRIB2C_LIBRARIES})
...
if (BUILD_OPTIMIZER)
    ...
    target_link_libraries(atmoswing-optimizer ${GRIB2C_LIBRARIES})
    if (USE_WXHGVERSION)
...
if (BUILD_TESTS)
    ...
    target_link_libraries(atmoswing-tests ${GRIB2C_LIBRARIES})
