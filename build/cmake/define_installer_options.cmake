...
if (UNIX AND NOT APPLE)
    ...
    elseif(DEBIAN_DISTRO_RELEASE VERSION_EQUAL "1604")
        set(CPACK_DEBIAN_PACKAGE_DEPENDS "${CPACK_DEBIAN_PACKAGE_DEPENDS}, libnetcdf11, libproj9, libgeos-c1v5")
        if (USE_GUI)
    ...
    elseif(DEBIAN_DISTRO_RELEASE VERSION_EQUAL "1804")
        set(CPACK_DEBIAN_PACKAGE_DEPENDS "${CPACK_DEBIAN_PACKAGE_DEPENDS}, libnetcdf13, libproj12, libgeos-c1v5")
        if (USE_GUI)
            set(CPACK_DEBIAN_PACKAGE_DEPENDS "${CPACK_DEBIAN_PACKAGE_DEPENDS}, libwxgtk3.0-0v5")
        else ()
            set(CPACK_DEBIAN_PACKAGE_DEPENDS "${CPACK_DEBIAN_PACKAGE_DEPENDS}, libwxbase3.0-0v5")
