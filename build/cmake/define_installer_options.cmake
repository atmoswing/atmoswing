...
if (UNIX AND NOT APPLE)
    ...
    if (BUILD_FORECASTER)
        install(FILES cpack/linux/atmoswing-forecaster.desktop DESTINATION share/applications)
    endif (BUILD_FORECASTER)
    if (BUILD_VIEWER)
        install(FILES cpack/linux/atmoswing-viewer.desktop DESTINATION share/applications)
    endif (BUILD_VIEWER)
    if (BUILD_OPTIMIZER)
        install(FILES cpack/linux/atmoswing-optimizer.desktop DESTINATION share/applications)
    endif (BUILD_OPTIMIZER)
    set(CPACK_GENERATOR "DEB")
    set(CPACK_PACKAGE_NAME "${CPACK_FILE_NAME}")
    set(CPACK_DEBIAN_PACKAGE_ARCHITECTURE "amd64")
    set(CPACK_DEBIAN_PACKAGE_MAINTAINER "Pascal Horton <horton.pascal@gmail.com>")
    set(CPACK_PACKAGE_VENDOR "Terranum")
    SET(CPACK_DEBIAN_PACKAGE_DEPENDS "netcdf, libproj0, gdal-bin, libcurl3, libjasper1, libssl, libwxbase3.0-0, libwxgtk3.0-0")
