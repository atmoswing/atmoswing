...
elseif (WIN32)
    set_target_properties(asbase PROPERTIES COMPILE_FLAGS "${CMAKE_CXX_FLAGS} -W4 -pedantic")
    if (BUILD_FORECASTER)
        set_target_properties(atmoswing-forecaster PROPERTIES COMPILE_FLAGS "${CMAKE_CXX_FLAGS} -W4 -pedantic")
        set_target_properties(asprocessing PROPERTIES COMPILE_FLAGS "${CMAKE_CXX_FLAGS} -W4 -pedantic")
    endif (BUILD_FORECASTER)
    if (BUILD_VIEWER)
        set_target_properties(atmoswing-viewer PROPERTIES COMPILE_FLAGS "${CMAKE_CXX_FLAGS} -W4 -pedantic")
    ...
    if (BUILD_OPTIMIZER)
        set_target_properties(atmoswing-optimizer PROPERTIES COMPILE_FLAGS "${CMAKE_CXX_FLAGS} -W4 -pedantic")
        set_target_properties(asprocessing PROPERTIES COMPILE_FLAGS "${CMAKE_CXX_FLAGS} -W4 -pedantic")
    endif (BUILD_OPTIMIZER)
    if (BUILD_TESTS)
        set_target_properties(atmoswing-tests PROPERTIES COMPILE_FLAGS "${CMAKE_CXX_FLAGS} -W4 -pedantic")
    endif (BUILD_TESTS)
    if (USE_WXHGVERSION)
