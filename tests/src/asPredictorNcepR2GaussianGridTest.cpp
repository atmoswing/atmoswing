...
TEST(PredictorNcepR2Gaussian, LoadEasy) {
  double xMin = 7.5;
  int xPtsNb = 5;
  double yMin = 29.523;
  int yPtsNb = 3;
  ...
  asPredictor *predictor = asPredictor::GetInstance("NCEP_Reanalysis_v2", "gaussian_grid/air", predictorDataDir);
...
TEST(PredictorNcepR2Gaussian, LoadComposite) {
  double xMin = -7.5;
  int xPtsNb = 7;
  double yMin = 29.523;
  int yPtsNb = 3;
...
TEST(PredictorNcepR2Gaussian, LoadBorderLeft) {
  double xMin = 0;
  int xPtsNb = 3;
  double yMin = 29.523;
  int yPtsNb = 3;
...
TEST(PredictorNcepR2Gaussian, LoadBorderLeftOn720) {
  double xMin = 360;
  int xPtsNb = 3;
  double yMin = 29.523;
  int yPtsNb = 3;
...
TEST(PredictorNcepR2Gaussian, LoadBorderRight) {
  double xMin = 352.5;
  int xPtsNb = 5;
  double yMin = 29.523;
  int yPtsNb = 3;
