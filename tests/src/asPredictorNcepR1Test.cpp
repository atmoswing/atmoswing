...
TEST(PredictorNcepR1, LoadWithNegativeVals) {
    double xMin = -10;
    int xPtsNb = 7;
    double yMin = 35;
    int yPtsNb = 3;
...
TEST(PredictorNcepR1, LoadWithNegativeValsStepLon) {
    double xMin = -10;
    int xPtsNb = 7;
    double yMin = 35;
    int yPtsNb = 3;
...
TEST(PredictorNcepR1v2014, RegularLoadWithNegativeValsStepLon) {
    double xMin = -10;
    double xWidth = 15;
    double yMin = 35;
    double yWidth = 5;
...
TEST(PredictorNcepR1, LoadWithNegativeValsStepLonMoved) {
    double xMin = -7.5;
    int xPtsNb = 5;
    double yMin = 35;
    int yPtsNb = 3;
...
TEST(PredictorNcepR1, LoadWithNegativeValsStepLonLat) {
    double xMin = -10;
    int xPtsNb = 4;
    double yMin = 35;
    int yPtsNb = 2;
...
TEST(PredictorNcepR1, LoadWithNegativeValsStepLonLatTime) {
    double xMin = -10;
    int xPtsNb = 4;
    double yMin = 35;
    int yPtsNb = 2;
...
TEST(PredictorNcepR1, RegularLoadWithNegativeValsStepLonLatTime) {
    double xMin = -10;
    double xWidth = 15;
    double yMin = 35;
    double yWidth = 5;
...
TEST(PredictorNcepR1, GaussianLoadWithNegativeVals) {
    double xMin = -7.5;
    int xPtsNb = 7;
    double yMin = 29.523;
    int yPtsNb = 3;
