...
TEST(PredictorNcepR2Regular, LoadEasy) {
  double xMin = 10;
  double xWidth = 10;
  double yMin = 35;
  double yWidth = 5;
...
TEST(PredictorNcepR2Regular, GetMinMaxValues) {
  double xMin = 10;
  double xWidth = 10;
  double yMin = 35;
  double yWidth = 5;
...
TEST(PredictorNcepR2Regular, LoadComposite) {
  double xMin = -10;
  double xWidth = 15;
  double yMin = 35;
  double yWidth = 5;
...
TEST(PredictorNcepR2Regular, LoadBorderLeft) {
  double xMin = 0;
  double xWidth = 5;
  double yMin = 35;
  double yWidth = 5;
...
TEST(PredictorNcepR2Regular, LoadBorderLeftOn720) {
  double xMin = 360;
  double xWidth = 5;
  double yMin = 35;
  double yWidth = 5;
...
TEST(PredictorNcepR2Regular, LoadBorderRight) {
  double xMin = 350;
  double xWidth = 10;
  double yMin = 35;
  double yWidth = 5;
...
TEST(PredictorNcepR2Regular, LoadCompositeStepLon) {
  double xMin = -10;
  double xWidth = 15;
  double yMin = 35;
  double yWidth = 5;
...
TEST(PredictorNcepR2Regular, LoadCompositeStepLonMoved) {
  double xMin = -7.5;
  double xWidth = 10;
  double yMin = 35;
  double yWidth = 5;
...
TEST(PredictorNcepR2Regular, LoadCompositeStepLonLat) {
  double xMin = -10;
  double xWidth = 15;
  double yMin = 35;
  double yWidth = 5;
...
TEST(PredictorNcepR2Regular, LoadCompositeStepLonLatTime) {
  double xMin = -10;
  double xWidth = 15;
  double yMin = 35;
  double yWidth = 5;
