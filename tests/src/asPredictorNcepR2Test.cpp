...
TEST(PredictorNcepR2, LoadComposite) {
  double xMin = -10;
  int xPtsNb = 7;
  double yMin = 35;
  int yPtsNb = 3;
...
TEST(PredictorNcepR2, LoadCompositeStepLon) {
  double xMin = -10;
  int xPtsNb = 7;
  double yMin = 35;
  int yPtsNb = 3;
...
TEST(PredictorNcepR2, LoadCompositeStepLonMoved) {
  double xMin = -7.5;
  int xPtsNb = 5;
  double yMin = 35;
  int yPtsNb = 3;
...
TEST(PredictorNcepR2, LoadCompositeStepLonLat) {
  double xMin = -10;
  int xPtsNb = 4;
  double yMin = 35;
  int yPtsNb = 2;
...
TEST(PredictorNcepR2, LoadCompositeStepLonLatTime) {
  double xMin = -10;
  int xPtsNb = 4;
  double yMin = 35;
  int yPtsNb = 2;
...
TEST(PredictorNcepR2, RegularLoadCompositeStepLonLatTime) {
  double xMin = -10;
  double xWidth = 15;
  double yMin = 35;
  double yWidth = 5;
...
TEST(PredictorNcepR2, GaussianLoadComposite) {
  double xMin = -7.5;
  int xPtsNb = 7;
  double yMin = 29.523;
  int yPtsNb = 3;
