...
void asPredictorOper::SetDefaultPredictorsUrls() {
  ...
  url =
      ...
      "leftlon=-20&rightlon=30&toplat=70&bottomlat=30&dir=%2Fgfs.[CURRENTDATE-YYYYMMDD]%2F[CURRENTDATE-hh]";
  ...
  url =
      ...
      "-20&rightlon=30&toplat=70&bottomlat=30&dir=%2Fgfs.[CURRENTDATE-YYYYMMDD]%2F[CURRENTDATE-hh]";
  ...
  url =
      ...
      "dir=%2Fgfs.[CURRENTDATE-YYYYMMDD]%2F[CURRENTDATE-hh]";
...
bool asPredictorOper::BuildFilenamesUrls() {
  ...
  if (m_restrictDownloads) {
    ...
    m_leadTimeEnd = (int)floor((m_leadTimeEnd - m_leadTimeStart) / m_leadTimeStep) * m_leadTimeStep + m_leadTimeStart;
  }
