...
asFrameForecasterVirtual::asFrameForecasterVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    _staticText41 = new wxStaticText(_panelMain, wxID_ANY, _("Start the forecast for a given date"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    _staticText41->Wrap(-1);
    _staticText41->SetFont(
    ...
    _calendarForecastDate = new wxCalendarCtrl(_panelMain, wxID_ANY, wxDefaultDateTime, wxDefaultPosition,
                                               wxDefaultSize,
    ...
    _staticTextForecastHour = new wxStaticText(_panelMain, wxID_ANY, _("Hour (UTM)"), wxDefaultPosition, wxDefaultSize,
                                               0);
    ...
    _bpButtonNow = new wxBitmapButton(_panelMain, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize(-1, -1),
    ...
    _staticText34 = new wxStaticText(_panelMain, wxID_ANY, _("Opened batch file:"), wxDefaultPosition, wxDefaultSize,
                                     0);
    ...
    _bpButtonAdd = new wxBitmapButton(_scrolledWindowForecasts, wxID_ANY, wxNullBitmap, wxDefaultPosition,
    ...
    _menuItemOpenBatchFile = new wxMenuItem(_menuFile, wxID_ANY, wxString(_("Open a batch file")), wxEmptyString,
                                            wxITEM_NORMAL);
    _menuFile->Append(_menuItemOpenBatchFile);

    wxMenuItem* _menuItemSaveBatchFile;
    _menuItemSaveBatchFile = new wxMenuItem(_menuFile, wxID_ANY, wxString(_("Save batch file")), wxEmptyString,
                                            wxITEM_NORMAL);
    _menuFile->Append(_menuItemSaveBatchFile);

    wxMenuItem* _menuItemSaveBatchFileAs;
    _menuItemSaveBatchFileAs = new wxMenuItem(_menuFile, wxID_ANY, wxString(_("Save batch file as")), wxEmptyString,
                                              wxITEM_NORMAL);
    _menuFile->Append(_menuItemSaveBatchFileAs);

    wxMenuItem* _menuItemNewBatchFile;
    _menuItemNewBatchFile = new wxMenuItem(_menuFile, wxID_ANY, wxString(_("Create a new batch file")), wxEmptyString,
                                           wxITEM_NORMAL);
    ...
    // Connect Events
    _bpButtonNow->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(asFrameForecasterVirtual::OnSetPresentDate), NULL, this);
    _button2->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                      wxCommandEventHandler(asFrameForecasterVirtual::OnConfigureDirectories), NULL, this);
    _bpButtonAdd->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameForecasterVirtual::AddForecast),
                          NULL, this);
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecasterVirtual::OnOpenBatchForecasts),
                    this, _menuItemOpenBatchFile->GetId());
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecasterVirtual::OnSaveBatchForecasts),
                    this, _menuItemSaveBatchFile->GetId());
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED,
                    wxCommandEventHandler(asFrameForecasterVirtual::OnSaveBatchForecastsAs), this,
                    _menuItemSaveBatchFileAs->GetId());
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecasterVirtual::OnNewBatchForecasts),
                    this, _menuItemNewBatchFile->GetId());
    _menuOptions->Bind(wxEVT_COMMAND_MENU_SELECTED,
                       wxCommandEventHandler(asFrameForecasterVirtual::OpenFramePreferences), this,
                       _menuItemPreferences->GetId());
    _menuTools->Bind(wxEVT_COMMAND_MENU_SELECTED,
                     wxCommandEventHandler(asFrameForecasterVirtual::OpenFramePredictandDB), this,
                     _menuItemBuildPredictandDB->GetId());
    _menuLog->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecasterVirtual::OnShowLog), this,
                   _menuItemShowLog->GetId());
    _menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecasterVirtual::OnLogLevel1), this,
                        _menuItemLogLevel1->GetId());
    _menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecasterVirtual::OnLogLevel2), this,
                        _menuItemLogLevel2->GetId());
    _menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecasterVirtual::OnLogLevel3), this,
                        _menuItemLogLevel3->GetId());
    _menuHelp->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecasterVirtual::OpenFrameAbout), this,
                    _menuItemAbout->GetId());
}

asFrameForecasterVirtual::~asFrameForecasterVirtual() {
    // Disconnect Events
    _bpButtonNow->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                             wxCommandEventHandler(asFrameForecasterVirtual::OnSetPresentDate), NULL, this);
    _button2->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                         wxCommandEventHandler(asFrameForecasterVirtual::OnConfigureDirectories), NULL, this);
    _bpButtonAdd->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameForecasterVirtual::AddForecast),
                             NULL, this);
}
...
asPanelForecastVirtual::asPanelForecastVirtual(wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size,
    ...
    _bpButtonWarning = new wxBitmapButton(this, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxDefaultSize,
                                          wxBU_AUTODRAW | 0 | wxBORDER_NONE);
    _bpButtonWarning->SetToolTip(_("File not found"));

    _sizerHeader->Add(_bpButtonWarning, 0, wxRIGHT | wxLEFT | wxALIGN_CENTER_VERTICAL, 5);

    _bpButtonEdit = new wxBitmapButton(this, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxDefaultSize,
                                       wxBU_AUTODRAW | 0 | wxBORDER_NONE);
    _bpButtonEdit->SetToolTip(_("Edit path"));

    _sizerHeader->Add(_bpButtonEdit, 0, wxALIGN_CENTER_VERTICAL | wxRIGHT | wxLEFT, 5);

    _bpButtonInfo = new wxBitmapButton(this, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxDefaultSize,
                                       wxBU_AUTODRAW | 0 | wxBORDER_NONE);
    _sizerHeader->Add(_bpButtonInfo, 0, wxALIGN_CENTER_VERTICAL | wxRIGHT | wxLEFT, 5);

    _bpButtonDetails = new wxBitmapButton(this, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxDefaultSize,
                                          wxBU_AUTODRAW | 0 | wxBORDER_NONE);
    _bpButtonDetails->SetToolTip(_("See details"));

    _sizerHeader->Add(_bpButtonDetails, 0, wxALL, 5);

    _bpButtonClose = new wxBitmapButton(this, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize(-1, -1),
                                        wxBU_AUTODRAW | 0 | wxBORDER_NONE);
    ...
    // Connect Events
    _bpButtonEdit->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                           wxCommandEventHandler(asPanelForecastVirtual::OnEditForecastFile), NULL, this);
    _bpButtonDetails->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                              wxCommandEventHandler(asPanelForecastVirtual::OnDetailsForecastFile), NULL, this);
    _bpButtonClose->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asPanelForecastVirtual::ClosePanel),
                            NULL, this);
}

asPanelForecastVirtual::~asPanelForecastVirtual() {
    // Disconnect Events
    _bpButtonEdit->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                              wxCommandEventHandler(asPanelForecastVirtual::OnEditForecastFile), NULL, this);
    _bpButtonDetails->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                 wxCommandEventHandler(asPanelForecastVirtual::OnDetailsForecastFile), NULL, this);
    _bpButtonClose->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asPanelForecastVirtual::ClosePanel),
                               NULL, this);
}
...
asFramePreferencesForecasterVirtual::asFramePreferencesForecasterVirtual(wxWindow* parent, wxWindowID id,
    ...
    _staticTextParametersDir = new wxStaticText(_panelPathsCommon, wxID_ANY,
                                                _("Directory containing the parameters files"), wxDefaultPosition,
                                                wxDefaultSize, 0);
    _staticTextParametersDir->Wrap(-1);
    _sizerPanelPaths->Add(_staticTextParametersDir, 0, wxTOP | wxRIGHT | wxLEFT, 5);

    _dirPickerParameters = new wxDirPickerCtrl(_panelPathsCommon, wxID_ANY, wxEmptyString, _("Select a folder"),
    ...
    _staticTextPredictandDBDir = new wxStaticText(
        _panelPathsCommon, wxID_ANY, _("Directory containing the predictand DB"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextPredictandDBDir->Wrap(-1);
    _sizerPanelPaths->Add(_staticTextPredictandDBDir, 0, wxTOP | wxRIGHT | wxLEFT, 5);

    _dirPickerPredictandDB = new wxDirPickerCtrl(_panelPathsCommon, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                 wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL);
    _sizerPanelPaths->Add(_dirPickerPredictandDB, 0, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 5);

    _staticTextArchivePredictorsDir = new wxStaticText(
        _panelPathsCommon, wxID_ANY, _("Directory containing archive predictors"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextArchivePredictorsDir->Wrap(-1);
    _sizerPanelPaths->Add(_staticTextArchivePredictorsDir, 0, wxTOP | wxRIGHT | wxLEFT, 5);

    _dirPickerArchivePredictors = new wxDirPickerCtrl(_panelPathsCommon, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                      wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL);
    _sizerPanelPaths->Add(_dirPickerArchivePredictors, 0, wxBOTTOM | wxRIGHT | wxLEFT | wxEXPAND, 5);

    _staticTextRealtimePredictorSavingDir = new wxStaticText(
        _panelPathsCommon, wxID_ANY, _("Directory to save downloaded real-time predictors (GCM forecasts)"),
    ...
    _dirPickerRealtimePredictorSaving = new wxDirPickerCtrl(_panelPathsCommon, wxID_ANY, wxEmptyString,
    ...
    _staticTextForecastResultsDir = new wxStaticText(_panelPathsCommon, wxID_ANY,
                                                     _("Directory to save forecast outputs (netCDF)"),
                                                     wxDefaultPosition, wxDefaultSize, 0);
    _staticTextForecastResultsDir->Wrap(-1);
    _sizerPanelPaths->Add(_staticTextForecastResultsDir, 0, wxTOP | wxRIGHT | wxLEFT, 5);

    _dirPickerForecastResults = new wxDirPickerCtrl(_panelPathsCommon, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                    wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL);
    _sizerPanelPaths->Add(_dirPickerForecastResults, 0, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 5);

    _staticTextForecastResultsExportsDir = new wxStaticText(_panelPathsCommon, wxID_ANY,
                                                            _("Directory to save forecast exports (xml)"),
                                                            wxDefaultPosition, wxDefaultSize, 0);
    ...
    _dirPickerForecastResultsExports = new wxDirPickerCtrl(_panelPathsCommon, wxID_ANY, wxEmptyString,
                                                           _("Select a folder"), wxDefaultPosition, wxDefaultSize,
                                                           wxDIRP_USE_TEXTCTRL);
    ...
    _staticTextExport = new wxStaticText(_panelPathsCommon, wxID_ANY, _("Export:"), wxDefaultPosition, wxDefaultSize,
                                         0);
    ...
    _choiceExports = new wxChoice(_panelPathsCommon, wxID_ANY, wxDefaultPosition, wxDefaultSize, _choiceExportsNChoices,
                                  _choiceExportsChoices, 0);
    ...
    _staticText34 = new wxStaticText(sbSizer71->GetStaticBox(), wxID_ANY,
    ...
    _staticTextEcCodesDefs = new wxStaticText(sbSizer6->GetStaticBox(), wxID_ANY, _("ecCodes definitions"),
                                              wxDefaultPosition, wxDefaultSize, 0);
    _staticTextEcCodesDefs->Wrap(-1);
    bSizer341->Add(_staticTextEcCodesDefs, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _textCtrlEcCodesDefs = new wxTextCtrl(sbSizer6->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                          wxDefaultSize, 0);
    ...
    _staticTextNumberFails = new wxStaticText(sbSizer11->GetStaticBox(), wxID_ANY,
    ...
    _textCtrlMaxPrevStepsNb = new wxTextCtrl(sbSizer11->GetStaticBox(), wxID_ANY, _("5"), wxDefaultPosition,
                                             wxSize(30, -1), 0);
#ifdef __WXGTK__
    ...
    _checkBoxRestrictDownloads = new wxCheckBox(sbSizer11->GetStaticBox(), wxID_ANY,
                                                _("Restrict downloads to needed lead times."), wxDefaultPosition,
                                                wxDefaultSize, 0);
    ...
    _checkBoxMultiInstancesForecaster = new wxCheckBox(
        _panelGeneral, wxID_ANY, _("Allow multiple instances of the forecaster"), wxDefaultPosition, wxDefaultSize, 0);
...
asWizardBatchForecastsVirtual::asWizardBatchForecastsVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    _staticText37 = new wxStaticText(_wizPage1, wxID_ANY, _("Load / create a batch file"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    ...
    _staticText35 = new wxStaticText(_wizPage1, wxID_ANY, _("Provide the path to an existing file"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    ...
    _staticText46 = new wxStaticText(_wizPage1, wxID_ANY, _("or continue to create a new batch file"),
                                     wxDefaultPosition, wxDefaultSize, 0);
    ...
    _staticText36 = new wxStaticText(_wizPage2, wxID_ANY, _("Create a new batch file"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    ...
    _staticText43 = new wxStaticText(_wizPage2, wxID_ANY, _("Path to save the new batch file"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    _staticText43->Wrap(-1);
    bSizer49->Add(_staticText43, 0, wxALL | wxEXPAND, 5);

    _filePickerBatchFile = new wxFilePickerCtrl(_wizPage2, wxID_ANY, wxEmptyString, _("Select a file"), _("*.xml"),
    ...
    _staticText45 = new wxStaticText(_wizPage2, wxID_ANY,
...
asFrameStyledTextCtrlVirtual::asFrameStyledTextCtrlVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
                                                           const wxPoint& pos, const wxSize& size, long style)
    : wxFrame(parent, id, title, pos, size, style) {
