...
asFrameMainVirtual::asFrameMainVirtual(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos,
    ...
    m_staticText41 = new wxStaticText(m_panelMain, wxID_ANY, _("Start the forecast for a given date"),
    ...
    m_calendarForecastDate =
        new wxCalendarCtrl(m_panelMain, wxID_ANY, wxDefaultDateTime, wxDefaultPosition, wxDefaultSize,
    ...
    m_staticTextForecastHour =
        new wxStaticText(m_panelMain, wxID_ANY, _("Hour (UTM)"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_bpButtonNow = new wxBitmapButton(m_panelMain, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize(-1, -1),
    ...
    m_scrolledWindowForecasts =
        new wxScrolledWindow(m_panelMain, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxVSCROLL);
    ...
    m_bpButtonAdd = new wxBitmapButton(m_scrolledWindowForecasts, wxID_ANY, wxNullBitmap, wxDefaultPosition,
                                       wxSize(28, 28), wxBU_AUTODRAW | 0 | wxBORDER_NONE);
    ...
    m_menuItemOpenBatchFile =
        new wxMenuItem(m_menuFile, wxID_ANY, wxString(_("Open a batch file")), wxEmptyString, wxITEM_NORMAL);
    m_menuFile->Append(m_menuItemOpenBatchFile);

    wxMenuItem* m_menuItemSaveBatchFile;
    m_menuItemSaveBatchFile =
        new wxMenuItem(m_menuFile, wxID_ANY, wxString(_("Save batch file")), wxEmptyString, wxITEM_NORMAL);
    m_menuFile->Append(m_menuItemSaveBatchFile);

    wxMenuItem* m_menuItemSaveBatchFileAs;
    m_menuItemSaveBatchFileAs =
        new wxMenuItem(m_menuFile, wxID_ANY, wxString(_("Save batch file as")), wxEmptyString, wxITEM_NORMAL);
    m_menuFile->Append(m_menuItemSaveBatchFileAs);

    wxMenuItem* m_menuItemNewBatchFile;
    m_menuItemNewBatchFile =
        new wxMenuItem(m_menuFile, wxID_ANY, wxString(_("Create a new batch file")), wxEmptyString, wxITEM_NORMAL);
    ...
    // Connect Events
    m_bpButtonNow->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameMainVirtual::OnSetPresentDate),
                           NULL, this);
    m_button2->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameMainVirtual::OnConfigureDirectories),
                       NULL, this);
    m_bpButtonAdd->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameMainVirtual::AddForecast), NULL,
                           this);
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameMainVirtual::OnOpenBatchForecasts), this,
                     m_menuItemOpenBatchFile->GetId());
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameMainVirtual::OnSaveBatchForecasts), this,
                     m_menuItemSaveBatchFile->GetId());
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameMainVirtual::OnSaveBatchForecastsAs),
                     this, m_menuItemSaveBatchFileAs->GetId());
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameMainVirtual::OnNewBatchForecasts), this,
                     m_menuItemNewBatchFile->GetId());
    m_menuOptions->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameMainVirtual::OpenFramePreferences),
                        this, m_menuItemPreferences->GetId());
    m_menuTools->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameMainVirtual::OpenFramePredictandDB),
                      this, m_menuItemBuildPredictandDB->GetId());
    m_menuLog->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameMainVirtual::OnShowLog), this,
                    m_menuItemShowLog->GetId());
    m_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameMainVirtual::OnLogLevel1), this,
                         m_MenuItemLogLevel1->GetId());
    m_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameMainVirtual::OnLogLevel2), this,
                         m_MenuItemLogLevel2->GetId());
    m_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameMainVirtual::OnLogLevel3), this,
                         m_MenuItemLogLevel3->GetId());
    m_menuHelp->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameMainVirtual::OpenFrameAbout), this,
                     m_menuItemAbout->GetId());
}

asFrameMainVirtual::~asFrameMainVirtual() {
    // Disconnect Events
    m_bpButtonNow->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameMainVirtual::OnSetPresentDate),
                              NULL, this);
    m_button2->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(asFrameMainVirtual::OnConfigureDirectories), NULL, this);
    m_bpButtonAdd->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameMainVirtual::AddForecast),
                              NULL, this);
}

asPanelForecastVirtual::asPanelForecastVirtual(wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size,
    ...
    m_bpButtonClose = new wxBitmapButton(this, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize(-1, -1),
                                         wxBU_AUTODRAW | 0 | wxBORDER_NONE);
    ...
    // Connect Events
    m_bpButtonClose->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asPanelForecastVirtual::ClosePanel),
                             NULL, this);
}

asPanelForecastVirtual::~asPanelForecastVirtual() {
    // Disconnect Events
    m_bpButtonClose->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asPanelForecastVirtual::ClosePanel),
                                NULL, this);
}

asFramePreferencesForecasterVirtual::asFramePreferencesForecasterVirtual(wxWindow* parent, wxWindowID id,
    ...
    m_staticTextParametersDir =
        new wxStaticText(m_panelPathsCommon, wxID_ANY, _("Directory containing the parameters files"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextParametersDir->Wrap(-1);
    m_sizerPanelPaths->Add(m_staticTextParametersDir, 0, wxTOP | wxRIGHT | wxLEFT, 5);

    m_dirPickerParameters = new wxDirPickerCtrl(m_panelPathsCommon, wxID_ANY, wxEmptyString, _("Select a folder"),
    ...
    m_staticTextPredictandDBDir = new wxStaticText(
        m_panelPathsCommon, wxID_ANY, _("Directory containing the predictand DB"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextPredictandDBDir->Wrap(-1);
    m_sizerPanelPaths->Add(m_staticTextPredictandDBDir, 0, wxTOP | wxRIGHT | wxLEFT, 5);

    m_dirPickerPredictandDB = new wxDirPickerCtrl(m_panelPathsCommon, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                  wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL);
    m_sizerPanelPaths->Add(m_dirPickerPredictandDB, 0, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 5);

    m_staticTextArchivePredictorsDir =
        new wxStaticText(m_panelPathsCommon, wxID_ANY, _("Directory containing archive predictors"), wxDefaultPosition,
                         wxDefaultSize, 0);
    ...
    m_dirPickerArchivePredictors =
        new wxDirPickerCtrl(m_panelPathsCommon, wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition,
                            wxDefaultSize, wxDIRP_USE_TEXTCTRL);
    m_sizerPanelPaths->Add(m_dirPickerArchivePredictors, 0, wxBOTTOM | wxRIGHT | wxLEFT | wxEXPAND, 5);

    m_staticTextRealtimePredictorSavingDir = new wxStaticText(
        m_panelPathsCommon, wxID_ANY, _("Directory to save downloaded real-time predictors (GCM forecasts)"),
        wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_dirPickerRealtimePredictorSaving =
        new wxDirPickerCtrl(m_panelPathsCommon, wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition,
                            wxDefaultSize, wxDIRP_USE_TEXTCTRL);
    ...
    m_staticTextForecastResultsDir =
        new wxStaticText(m_panelPathsCommon, wxID_ANY, _("Directory to save forecast outputs (netCDF)"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextForecastResultsDir->Wrap(-1);
    m_sizerPanelPaths->Add(m_staticTextForecastResultsDir, 0, wxTOP | wxRIGHT | wxLEFT, 5);

    m_dirPickerForecastResults = new wxDirPickerCtrl(m_panelPathsCommon, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                     wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL);
    m_sizerPanelPaths->Add(m_dirPickerForecastResults, 0, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 5);

    m_staticTextForecastResultsExportsDir =
        new wxStaticText(m_panelPathsCommon, wxID_ANY, _("Directory to save forecast exports (xml)"), wxDefaultPosition,
                         wxDefaultSize, 0);
    ...
    m_dirPickerForecastResultsExports =
        new wxDirPickerCtrl(m_panelPathsCommon, wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition,
                            wxDefaultSize, wxDIRP_USE_TEXTCTRL);
    m_sizerPanelPaths->Add(m_dirPickerForecastResultsExports, 0, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 5);

    m_checkBoxExportSyntheticXml = new wxCheckBox(m_panelPathsCommon, wxID_ANY, _("Export forecasts as synthetic xml"),
                                                  wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextNumberFails = new wxStaticText(sbSizer11->GetStaticBox(), wxID_ANY,
                                               _("Maximum number of previous time steps if download fails"),
                                               wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextNumberFails->Wrap(-1);
    fgSizer2->Add(m_staticTextNumberFails, 0, wxALL, 5);

    m_textCtrlMaxPrevStepsNb =
        new wxTextCtrl(sbSizer11->GetStaticBox(), wxID_ANY, _("5"), wxDefaultPosition, wxSize(30, -1), 0);
#ifdef __WXGTK__
    ...
    m_staticTextMaxRequestsNb =
        new wxStaticText(sbSizer11->GetStaticBox(), wxID_ANY, _("Maximum parallel requests number"), wxDefaultPosition,
                         wxDefaultSize, 0);
    m_staticTextMaxRequestsNb->Wrap(-1);
    fgSizer2->Add(m_staticTextMaxRequestsNb, 0, wxALL, 5);

    m_textCtrlMaxRequestsNb =
        new wxTextCtrl(sbSizer11->GetStaticBox(), wxID_ANY, _("3"), wxDefaultPosition, wxSize(30, -1), 0);
#ifdef __WXGTK__
    ...
    m_checkBoxRestrictDownloads =
        new wxCheckBox(sbSizer11->GetStaticBox(), wxID_ANY, _("Restrict downloads to needed lead times."),
                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_checkBoxMultiInstancesForecaster = new wxCheckBox(
        m_panelGeneral, wxID_ANY, _("Allow multiple instances of the forecaster"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_checkBoxAllowMultithreading->Connect(
        ...
        wxCommandEventHandler(asFramePreferencesForecasterVirtual::OnChangeMultithreadingCheckBox), NULL, this);
    m_buttonsConfirmationApply->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                        wxCommandEventHandler(asFramePreferencesForecasterVirtual::ApplyChanges), NULL,
                                        this);
    m_buttonsConfirmationCancel->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                         wxCommandEventHandler(asFramePreferencesForecasterVirtual::CloseFrame), NULL,
                                         this);
    m_buttonsConfirmationOK->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                     wxCommandEventHandler(asFramePreferencesForecasterVirtual::SaveAndClose), NULL,
                                     this);
}
...
asFramePreferencesForecasterVirtual::~asFramePreferencesForecasterVirtual() {
    ...
    m_buttonsConfirmationApply->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                           wxCommandEventHandler(asFramePreferencesForecasterVirtual::ApplyChanges),
                                           NULL, this);
    m_buttonsConfirmationCancel->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                            wxCommandEventHandler(asFramePreferencesForecasterVirtual::CloseFrame),
                                            NULL, this);
...
asWizardBatchForecastsVirtual::asWizardBatchForecastsVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    m_staticText37 =
        new wxStaticText(m_wizPage1, wxID_ANY, _("Load / create a batch file"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText35 = new wxStaticText(m_wizPage1, wxID_ANY, _("Provide the path to an existing file"),
                                      wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText46 = new wxStaticText(m_wizPage1, wxID_ANY, _("or continue to create a new batch file"),
                                      wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText36 =
        new wxStaticText(m_wizPage2, wxID_ANY, _("Create a new batch file"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText43 = new wxStaticText(m_wizPage2, wxID_ANY, _("Path to save the new batch file"), wxDefaultPosition,
                                      wxDefaultSize, 0);
    m_staticText43->Wrap(-1);
    bSizer49->Add(m_staticText43, 0, wxALL | wxEXPAND, 5);

    m_filePickerBatchFile = new wxFilePickerCtrl(m_wizPage2, wxID_ANY, wxEmptyString, _("Select a file"), _("*.xml"),
    ...
    m_staticText45 = new wxStaticText(m_wizPage2, wxID_ANY,
                                      _("The preferences frame will open to configure the required directories."),
                                      wxDefaultPosition, wxDefaultSize, 0);
    ...
    this->Connect(wxID_ANY, wxEVT_WIZARD_FINISHED,
                  wxWizardEventHandler(asWizardBatchForecastsVirtual::OnWizardFinished));
    m_button4->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                       wxCommandEventHandler(asWizardBatchForecastsVirtual::OnLoadExistingBatchForecasts), NULL, this);
}
...
asWizardBatchForecastsVirtual::~asWizardBatchForecastsVirtual() {
    ...
    m_button4->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(asWizardBatchForecastsVirtual::OnLoadExistingBatchForecasts), NULL,
                          this);
