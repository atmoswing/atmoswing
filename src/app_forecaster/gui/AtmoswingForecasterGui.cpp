...
asFrameMainVirtual::asFrameMainVirtual(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos,
  ...
  m_staticText41 = new wxStaticText(m_panelMain, wxID_ANY, _("Start the forecast for a given date"), wxDefaultPosition,
                                    wxDefaultSize, 0);
  ...
  m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameMainVirtual::OnSaveBatchForecastsAs), this,
                   m_menuItemSaveBatchFileAs->GetId());
  ...
  m_menuTools->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameMainVirtual::OpenFramePredictandDB), this,
...
asFrameMainVirtual::~asFrameMainVirtual() {
  ...
  m_bpButtonNow->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameMainVirtual::OnSetPresentDate),
                            NULL, this);
  m_button2->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameMainVirtual::OnConfigureDirectories),
                        NULL, this);
  m_bpButtonAdd->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameMainVirtual::AddForecast), NULL,
                            this);
}
...
asFramePreferencesForecasterVirtual::asFramePreferencesForecasterVirtual(wxWindow* parent, wxWindowID id,
  ...
  m_staticTextParametersDir =
      new wxStaticText(m_panelPathsCommon, wxID_ANY, _("Directory containing the parameters files"), wxDefaultPosition,
                       wxDefaultSize, 0);
  ...
  m_staticTextArchivePredictorsDir = new wxStaticText(
      m_panelPathsCommon, wxID_ANY, _("Directory containing archive predictors"), wxDefaultPosition, wxDefaultSize, 0);
  m_staticTextArchivePredictorsDir->Wrap(-1);
  m_sizerPanelPaths->Add(m_staticTextArchivePredictorsDir, 0, wxTOP | wxRIGHT | wxLEFT, 5);

  m_dirPickerArchivePredictors = new wxDirPickerCtrl(m_panelPathsCommon, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                     wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL);
  ...
  m_staticTextForecastResultsExportsDir = new wxStaticText(
      m_panelPathsCommon, wxID_ANY, _("Directory to save forecast exports (xml)"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticTextMaxRequestsNb = new wxStaticText(
      sbSizer11->GetStaticBox(), wxID_ANY, _("Maximum parallel requests number"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_buttonsConfirmationCancel->Connect(
      wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFramePreferencesForecasterVirtual::CloseFrame), NULL, this);
...
asWizardBatchForecastsVirtual::asWizardBatchForecastsVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
  ...
  m_staticText35 = new wxStaticText(m_wizPage1, wxID_ANY, _("Provide the path to an existing file"), wxDefaultPosition,
                                    wxDefaultSize, 0);
  ...
  m_staticText43 =
      new wxStaticText(m_wizPage2, wxID_ANY, _("Path to save the new batch file"), wxDefaultPosition, wxDefaultSize, 0);
