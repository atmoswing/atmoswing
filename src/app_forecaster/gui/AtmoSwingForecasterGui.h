...
class asFrameForecasterVirtual : public wxFrame {
  ...
  public:
    asFrameForecasterVirtual(wxWindow* parent, wxWindowID id = wxID_ANY,
                             const wxString& title = _("AtmoSwing Forecaster"), const wxPoint& pos = wxDefaultPosition,
                             const wxSize& size = wxSize(600, 700),
...
class asPanelForecastVirtual : public wxPanel {
  ...
  protected:
    ...
    // Virtual event handlers, override them in your derived class
    virtual void OnEditForecastFile(wxCommandEvent& event) {
        event.Skip();
    }
    virtual void OnDetailsForecastFile(wxCommandEvent& event) {
        event.Skip();
    }
  ...
  public:
    asPanelForecastVirtual(wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition,
                           const wxSize& size = wxSize(-1, -1), long style = wxBORDER_NONE | wxTAB_TRAVERSAL,
...
class asFrameStyledTextCtrlVirtual : public wxFrame {
  ...
  public:
    asFrameStyledTextCtrlVirtual(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxEmptyString,
