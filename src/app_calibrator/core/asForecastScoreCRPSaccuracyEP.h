...
#ifndef ASFORECASTSCORECRPSaccuracyEP_H
#define ASFORECASTSCORECRPSaccuracyEP_H

#include <asIncludes.h>
#include "asForecastScore.h"

class asForecastScoreCRPSaccuracyEP: public asForecastScore
{
public:
