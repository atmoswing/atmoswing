...
using ra2f = Eigen::Ref<const a2f>;  // read-only view accepting both a2f and ma2f without copy
using ma2f = Eigen::Map<const a2f>;  // read-only map over external contiguous row-major data
