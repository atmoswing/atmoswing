...
asPredictorArchNcepReanalysis2::asPredictorArchNcepReanalysis2(const wxString &dataId)
...
asPredictorArchNcepReanalysis2::~asPredictorArchNcepReanalysis2()
{

}

bool asPredictorArchNcepReanalysis2::Init()
{
...
double asPredictorArchNcepReanalysis2::ConvertToMjd(double timeValue, double refValue) const
{
