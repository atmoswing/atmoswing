...
#ifndef ASPREDICTORARCHNCEPREANALYSIS2_H
#define ASPREDICTORARCHNCEPREANALYSIS2_H
...
class asPredictorArchNcepReanalysis2
...
#endif // ASPREDICTORARCHNCEPREANALYSIS2_H
