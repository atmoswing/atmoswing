...
VectorString asDataPredictorArchiveNcepReanalysis1Subset::GetDataIdList()
{
    VectorString list;
...
VectorString asDataPredictorArchiveNcepReanalysis1Subset::GetDataIdDescriptionList()
{
    VectorString list;
...
bool asDataPredictorArchiveNcepReanalysis1Subset::Load(asGeoAreaCompositeGrid *desiredArea, asTimeArray &timeArray)
{
    if (!m_Initialized)
    {
        if (!Init()) {
