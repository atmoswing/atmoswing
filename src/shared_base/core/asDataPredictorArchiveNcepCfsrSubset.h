...
#ifndef ASDATAPREDICTORARCHIVENCEPCFSR2SUBSET_H
#define ASDATAPREDICTORARCHIVENCEPCFSR2SUBSET_H
...
class asDataPredictorArchiveNcepCfsrSubset
        : public asDataPredictorArchive
{
public:
    asDataPredictorArchiveNcepCfsrSubset(const wxString &dataId);

    virtual ~asDataPredictorArchiveNcepCfsrSubset();
...
#endif // ASDATAPREDICTORARCHIVENCEPCFSR2SUBSET_H
