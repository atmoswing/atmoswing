...
#ifndef ASDATAPREDICTORARCHIVEECMWFERA20C_H
#define ASDATAPREDICTORARCHIVEECMWFERA20C_H
...
class asDataPredictorArchiveEcmwfEra20C
        : public asDataPredictorArchive
{
public:
    asDataPredictorArchiveEcmwfEra20C(const wxString &dataId);

    virtual ~asDataPredictorArchiveEcmwfEra20C();
...
#endif // ASDATAPREDICTORARCHIVEECMWFERA20C_H
