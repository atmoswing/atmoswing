...
#ifndef ASDATAPREDICTORARCHIVENOAA20CR2C_H
#define ASDATAPREDICTORARCHIVENOAA20CR2C_H
...
class asDataPredictorArchiveNoaa20Cr2c
        : public asDataPredictorArchive
{
public:
    asDataPredictorArchiveNoaa20Cr2c(const wxString &dataId);

    virtual ~asDataPredictorArchiveNoaa20Cr2c();
...
#endif // ASDATAPREDICTORARCHIVENOAA20CR2C_H
