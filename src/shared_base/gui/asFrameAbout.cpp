...
wxString asFrameAbout::GetLicense() {
  ...
  license.Append(
      ...
      "of the terms of, this License. For legal entities, 'You' includes any entity which controls, is controlled "
      "by, or is under common control with You. For purposes of this definition, 'control' means (a) the power, "
  ...
  license.Append(
      ...
      "use, practice, sell, and offer for sale, and/or otherwise dispose of the Original Software (or portions "
      "thereof).");
  license.Append("\n\n");
  license.Append(
  ...
  license.Append(
      ...
      "Original Software, or (2) for infringements caused by: (i) the modification of the Original Software, or (ii) "
  ...
  license.Append(
      ...
      "in Executable form as to how they can obtain such Covered Software in Source Code form in a reasonable manner "
  ...
  license.Append(
      ...
      "represent that You believe Your Modifications are Your original creation(s) and/or You have sufficient rights "
  ...
  license.Append(
      ...
      "Covered Software, or any notices of licensing or any descriptive text giving attribution to any Contributor "
  ...
  license.Append(
      ...
      "limit or alter the recipient's rights in the Source Code form from the rights set forth in this License. If "
  ...
  license.Append(
      ...
      "of the version of the License under which You originally received the Covered Software. If the Initial "
  ...
  license.Append(
      ...
      "the name of the license steward (except to note that the license differs from this License); and (b) "
  ...
  license.Append(
      ...
      "directly or indirectly infringes any patent, then any and all rights granted directly or indirectly to You by "
      "such Participant, the Initial Developer (if the Initial Developer is not the Participant) and all "
  ...
  license.Append(
      ...
      "validly granted by You or any distributor hereunder prior to termination (excluding licenses granted to You "
  ...
  license.Append(
      ...
      "consisting of 'commercial computer software' (as that term is defined at 48 C.F.R. paragraph "
      "252.227-7014(a)(1)) and 'commercial computer software documentation' as such terms are used in 48 C.F.R. "
      "12.212 (Sept. 1995). Consistent with 48 C.F.R. 12.212 and 48 C.F.R. 227.7202-1 through 227.7202-4 (June "
      "1995), all U.S. Government End Users acquire Covered Software with only those rights set forth herein. This "
  ...
  license.Append(
      ...
      "enforceable. This License shall be governed by the law of the jurisdiction specified in a notice contained "
  ...
  license.Append(
      ...
      "directly or indirectly, out of its utilization of rights under this License and You agree to work with "
  ...
  license.Append("\n\n");
  license.Append(
      "Notice pursuant to section 9 of the Common Development and Distribution License (CDDL): For Covered Software "
      "in this distribution, this License shall be governed by the laws of Switzerland. Legal venue shall be "
