...
asDialogFilePickerVirtual::asDialogFilePickerVirtual( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_filePicker = new wxFilePickerCtrl( this, wxID_ANY, wxEmptyString, _("Select a file"), _("*.*"), wxDefaultPosition, wxSize( -1,-1 ), wxFLP_USE_TEXTCTRL );
...
asDialogFileSaverVirtual::asDialogFileSaverVirtual( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_filePicker = new wxFilePickerCtrl( this, wxID_ANY, wxEmptyString, _("Select a file"), _("*.*"), wxDefaultPosition, wxSize( -1,-1 ), wxFLP_OVERWRITE_PROMPT|wxFLP_SAVE|wxFLP_USE_TEXTCTRL );
	bSizerMain->Add( m_filePicker, 0, wxALL|wxEXPAND, 5 );
...
asFramePredictandDBVirtual::asFramePredictandDBVirtual( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticTextDataParam = new wxStaticText( m_panelMain, wxID_ANY, _("Predictand parameter"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_choiceDataParam = new wxChoice( m_panelMain, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceDataParamNChoices, m_choiceDataParamChoices, 0 );
	m_choiceDataParam->SetSelection( 1 );
	fgSizer2->Add( m_choiceDataParam, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5 );

	m_staticTextDataTempResol = new wxStaticText( m_panelMain, wxID_ANY, _("Temporal resolution"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_choiceDataTempResol = new wxChoice( m_panelMain, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceDataTempResolNChoices, m_choiceDataTempResolChoices, 0 );
	m_choiceDataTempResol->SetSelection( 0 );
	fgSizer2->Add( m_choiceDataTempResol, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxEXPAND, 5 );

	m_staticTextDataSpatAggreg = new wxStaticText( m_panelMain, wxID_ANY, _("Spatial aggregation"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticTextCatalogPath = new wxStaticText( m_panelMain, wxID_ANY, _("Select the predictand catalog"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextCatalogPath->Wrap( -1 );
	m_sizerMainPanel->Add( m_staticTextCatalogPath, 0, wxALL, 5 );

	m_filePickerCatalogPath = new wxFilePickerCtrl( m_panelMain, wxID_ANY, wxEmptyString, _("Select a file"), _("*.*"), wxDefaultPosition, wxDefaultSize, wxFLP_USE_TEXTCTRL );
	m_sizerMainPanel->Add( m_filePickerCatalogPath, 0, wxEXPAND|wxBOTTOM|wxRIGHT|wxLEFT, 5 );

	m_staticTextDataDir = new wxStaticText( m_panelMain, wxID_ANY, _("Select the predictand data directory"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextDataDir->Wrap( -1 );
	m_sizerMainPanel->Add( m_staticTextDataDir, 0, wxALL, 5 );

	m_dirPickerDataDir = new wxDirPickerCtrl( m_panelMain, wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL );
	m_sizerMainPanel->Add( m_dirPickerDataDir, 0, wxEXPAND|wxBOTTOM|wxRIGHT|wxLEFT, 5 );

	m_staticTextPatternsDir = new wxStaticText( m_panelMain, wxID_ANY, _("Select the directory containing the file patterns description"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextPatternsDir->Wrap( -1 );
	m_sizerMainPanel->Add( m_staticTextPatternsDir, 0, wxALL, 5 );

	m_dirPickerPatternsDir = new wxDirPickerCtrl( m_panelMain, wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL );
	m_sizerMainPanel->Add( m_dirPickerPatternsDir, 0, wxBOTTOM|wxRIGHT|wxLEFT|wxEXPAND, 5 );

	m_staticDestinationDir = new wxStaticText( m_panelMain, wxID_ANY, _("Select the destination directory"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticDestinationDir->Wrap( -1 );
	m_sizerMainPanel->Add( m_staticDestinationDir, 0, wxALL, 5 );

	m_dirPickerDestinationDir = new wxDirPickerCtrl( m_panelMain, wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL );
...
asPanelProcessingPrecipitation::asPanelProcessingPrecipitation( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	m_staticText22 = new wxStaticText( this, wxID_ANY, _("Precipitation data normalization"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_checkBoxReturnPeriod = new wxCheckBox( this, wxID_ANY, _("Normalize by the return period of"), wxDefaultPosition, wxDefaultSize, 0 );
...
asPanelProcessingLightning::asPanelProcessingLightning( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	m_staticText23 = new wxStaticText( this, wxID_ANY, _("Lightning data normalization"), wxDefaultPosition, wxDefaultSize, 0 );
...
asFrameAboutVirtual::asFrameAboutVirtual( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticTextVersion = new wxStaticText( m_Panel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL );
	...
	m_staticTextDevelopers->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );

	bSizer28->Add( m_staticTextDevelopers, 0, wxALIGN_CENTER_HORIZONTAL|wxTOP|wxRIGHT|wxLEFT, 20 );

	m_staticTextDevelopersList = new wxStaticText( m_panelCredits, wxID_ANY, _("Pascal Horton"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL );
	...
	m_staticTextSupervision->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
