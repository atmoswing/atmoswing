...
asFramePredictandDBVirtual::asFramePredictandDBVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
  ...
  m_staticTextCatalogPath =
      new wxStaticText(m_panelMain, wxID_ANY, _("Select the predictand catalog"), wxDefaultPosition, wxDefaultSize, 0);
...
asFrameAboutVirtual::asFrameAboutVirtual(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos,
  ...
  m_staticTextThanksList = new wxStaticText(
      m_panelCredits, wxID_ANY, _("Charles Obled\nMichel Jaboyedoff\nLucien Schreiber\nRenaud Marty\nRichard Metzger"),
      wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL);
