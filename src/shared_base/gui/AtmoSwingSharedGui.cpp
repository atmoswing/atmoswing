...
asDialogFilePickerVirtual::asDialogFilePickerVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    _staticTextDescription = new wxStaticText(this, wxID_ANY, _("Please select the file."), wxDefaultPosition,
                                              wxDefaultSize, 0);
    _staticTextDescription->Wrap(-1);
    bSizerMain->Add(_staticTextDescription, 0, wxALL, 5);

    _filePicker = new wxFilePickerCtrl(this, wxID_ANY, wxEmptyString, _("Select a file"), _("*.*"), wxDefaultPosition,
...
asDialogFileSaverVirtual::asDialogFileSaverVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    _staticTextDescription = new wxStaticText(this, wxID_ANY, _("Please select the directory and the file name."),
...
asFramePredictandDBVirtual::asFramePredictandDBVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    _staticTextDataParam = new wxStaticText(_panelMain, wxID_ANY, _("Predictand parameter"), wxDefaultPosition,
                                            wxDefaultSize, 0);
    ...
    _choiceDataParam = new wxChoice(_panelMain, wxID_ANY, wxDefaultPosition, wxDefaultSize, _choiceDataParamNChoices,
                                    _choiceDataParamChoices, 0);
    _choiceDataParam->SetSelection(1);
    fgSizer2->Add(_choiceDataParam, 0, wxALL | wxALIGN_CENTER_VERTICAL | wxEXPAND, 5);

    _staticTextDataTempResol = new wxStaticText(_panelMain, wxID_ANY, _("Temporal resolution"), wxDefaultPosition,
                                                wxDefaultSize, 0);
    _staticTextDataTempResol->Wrap(-1);
    fgSizer2->Add(_staticTextDataTempResol, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    wxString _choiceDataTempResolChoices[] = {_("24 hours"), _("6 hours"),  _("1-hr MTW"),
                                              _("3-hr MTW"), _("6-hr MTW"), _("12-hr MTW")};
    int _choiceDataTempResolNChoices = sizeof(_choiceDataTempResolChoices) / sizeof(wxString);
    _choiceDataTempResol = new wxChoice(_panelMain, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                        _choiceDataTempResolNChoices, _choiceDataTempResolChoices, 0);
    _choiceDataTempResol->SetSelection(0);
    fgSizer2->Add(_choiceDataTempResol, 0, wxALL | wxALIGN_CENTER_VERTICAL | wxEXPAND, 5);

    _staticTextDataSpatAggreg = new wxStaticText(_panelMain, wxID_ANY, _("Spatial aggregation"), wxDefaultPosition,
                                                 wxDefaultSize, 0);
    ...
    _choiceDataSpatAggreg = new wxChoice(_panelMain, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                         _choiceDataSpatAggregNChoices, _choiceDataSpatAggregChoices, 0);
    ...
    _staticTextCatalogPath = new wxStaticText(_panelMain, wxID_ANY, _("Select the predictand catalog"),
                                              wxDefaultPosition, wxDefaultSize, 0);
    _staticTextCatalogPath->Wrap(-1);
    _sizerMainPanel->Add(_staticTextCatalogPath, 0, wxALL, 5);

    _filePickerCatalogPath = new wxFilePickerCtrl(_panelMain, wxID_ANY, wxEmptyString, _("Select a file"), _("*.*"),
    ...
    _staticTextDataDir = new wxStaticText(_panelMain, wxID_ANY, _("Select the predictand data directory"),
                                          wxDefaultPosition, wxDefaultSize, 0);
    _staticTextDataDir->Wrap(-1);
    _sizerMainPanel->Add(_staticTextDataDir, 0, wxALL, 5);

    _dirPickerDataDir = new wxDirPickerCtrl(_panelMain, wxID_ANY, wxEmptyString, _("Select a folder"),
    ...
    _staticTextPatternsDir = new wxStaticText(_panelMain, wxID_ANY,
                                              _("Select the directory containing the file patterns description"),
                                              wxDefaultPosition, wxDefaultSize, 0);
    _staticTextPatternsDir->Wrap(-1);
    _sizerMainPanel->Add(_staticTextPatternsDir, 0, wxALL, 5);

    _dirPickerPatternsDir = new wxDirPickerCtrl(_panelMain, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL);
    _sizerMainPanel->Add(_dirPickerPatternsDir, 0, wxBOTTOM | wxRIGHT | wxLEFT | wxEXPAND, 5);

    _staticDestinationDir = new wxStaticText(_panelMain, wxID_ANY, _("Select the destination directory"),
                                             wxDefaultPosition, wxDefaultSize, 0);
    _staticDestinationDir->Wrap(-1);
    _sizerMainPanel->Add(_staticDestinationDir, 0, wxALL, 5);

    _dirPickerDestinationDir = new wxDirPickerCtrl(_panelMain, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                   wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL);
    ...
    // Connect Events
    _choiceDataParam->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
...
asFramePredictandDBVirtual::~asFramePredictandDBVirtual() {
    // Disconnect Events
    _choiceDataParam->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                                 wxCommandEventHandler(asFramePredictandDBVirtual::OnDataSelection), NULL, this);
...
asPanelProcessingPrecipitation::asPanelProcessingPrecipitation(wxWindow* parent, wxWindowID id, const wxPoint& pos,
    ...
    _staticText22 = new wxStaticText(this, wxID_ANY, _("Precipitation data normalization"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    ...
    _checkBoxReturnPeriod = new wxCheckBox(this, wxID_ANY, _("Normalize by the return period of"), wxDefaultPosition,
                                           wxDefaultSize, 0);
...
asPanelProcessingLightning::asPanelProcessingLightning(wxWindow* parent, wxWindowID id, const wxPoint& pos,
    ...
    _staticText23 = new wxStaticText(this, wxID_ANY, _("Lightning data normalization"), wxDefaultPosition,
                                     wxDefaultSize, 0);
...
asFrameAboutVirtual::asFrameAboutVirtual(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos,
    ...
    _staticTextVersion = new wxStaticText(_panel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
                                          wxALIGN_CENTER_HORIZONTAL);
    _staticTextVersion->Wrap(-1);
    _staticTextVersion->SetFont(
    ...
    _staticTextDevelopers = new wxStaticText(_panelCredits, wxID_ANY, _("Main developer:"), wxDefaultPosition,
                                             wxDefaultSize, 0);
    _staticTextDevelopers->Wrap(-1);
    _staticTextDevelopers->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL,
    ...
    _staticTextDevelopersList = new wxStaticText(_panelCredits, wxID_ANY, _("Pascal Horton"), wxDefaultPosition,
    ...
    _staticTextSupervision = new wxStaticText(_panelCredits, wxID_ANY, _("Developed at:"), wxDefaultPosition,
                                              wxDefaultSize, 0);
    _staticTextSupervision->Wrap(-1);
    _staticTextSupervision->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL,
                                           wxFONTWEIGHT_BOLD, false, wxEmptyString));

    bSizer28->Add(_staticTextSupervision, 0, wxALIGN_CENTER_HORIZONTAL | wxTOP | wxRIGHT | wxLEFT, 10);

    _staticTextSupervisionList = new wxStaticText(_panelCredits, wxID_ANY,
                                                  _("University of Lausanne\nTerranum\nUniversity of Bern"),
                                                  wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL);
    _staticTextSupervisionList->Wrap(-1);
    bSizer28->Add(_staticTextSupervisionList, 0, wxALL | wxALIGN_CENTER_HORIZONTAL, 5);

    _staticTextThanks = new wxStaticText(_panelCredits, wxID_ANY, _("Special thanks to:"), wxDefaultPosition,
                                         wxDefaultSize, 0);
    _staticTextThanks->Wrap(-1);
    _staticTextThanks->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL,
                                      wxFONTWEIGHT_BOLD, false, wxEmptyString));

    bSizer28->Add(_staticTextThanks, 0, wxTOP | wxRIGHT | wxLEFT | wxALIGN_CENTER_HORIZONTAL, 10);

    _staticTextThanksList = new wxStaticText(
        _panelCredits, wxID_ANY, _("Charles Obled\nMichel Jaboyedoff\nLucien Schreiber\nRenaud Marty\nRichard Metzger"),
        wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL);
    ...
    _textCtrlLicense = new wxTextCtrl(_panelLicense, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
