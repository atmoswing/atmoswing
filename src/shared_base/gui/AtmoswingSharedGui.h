...
class asFramePredictandDBVirtual : public wxFrame {
 ...
 protected:
  ...
  virtual void OnDataSelection(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void CloseFrame(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void BuildDatabase(wxCommandEvent& event) {
    event.Skip();
  }
...
class asPanelProcessingPrecipitation : public wxPanel {
 ...
 public:
  ...
  asPanelProcessingPrecipitation(wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition,
