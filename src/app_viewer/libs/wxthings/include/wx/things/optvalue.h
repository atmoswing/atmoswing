...
class WXDLLIMPEXP_THINGS wxOptionValue : public wxObject {
 public:
  ...
  wxOptionValue(const wxOptionValue &optValue) {
    Create(optValue);
  }

  wxOptionValue(const wxString &str) {
    Create(str);
  }
  ...
  bool GetOption(const wxString &name, unsigned char *value, int count, const wxString &delims = wxT(" ,\t\r\n")) const;

  bool GetOption(const wxString &name, int *value, int count, const wxString &delims = wxT(" ,\t\r\n")) const;

  bool GetOption(const wxString &name, long *value, int count, const wxString &delims = wxT(" ,\t\r\n")) const;

  bool GetOption(const wxString &name, float *value, int count, const wxString &delims = wxT(" ,\t\r\n")) const;

  bool GetOption(const wxString &name, double *value, int count, const wxString &delims = wxT(" ,\t\r\n")) const;

  // Convience function to easily get common values
  bool GetOption(const wxString &name, int *v1, int *v2, const wxString &delims = wxT(" ,\t\r\n")) const;

  bool GetOption(const wxString &name, int *v1, int *v2, int *v3, const wxString &delims = wxT(" ,\t\r\n")) const;

  bool GetOption(const wxString &name, float *v1, float *v2, float *v3, const wxString &delims = wxT(" ,\t\r\n")) const;

  bool GetOption(const wxString &name, wxPoint &value, const wxString &delims = wxT(" ,\t\r\n")) const {
    return GetOption(name, &value.x, &value.y, delims);
  }

  bool GetOption(const wxString &name, wxSize &value, const wxString &delims = wxT(" ,\t\r\n")) const {
    return GetOption(name, &value.x, &value.y, delims);
  }

  bool GetOption(const wxString &name, wxRect &value, const wxString &delims = wxT(" ,\t\r\n")) const;
