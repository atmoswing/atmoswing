...
BEGIN_EVENT_TABLE(wxSpinCtrlDblTextCtrl, wxTextCtrl)
                ...
                EVT_KILL_FOCUS(wxSpinCtrlDblTextCtrl::OnKillFocus) END_EVENT_TABLE()
...
BEGIN_EVENT_TABLE(wxSpinCtrlDbl, wxControl)
                EVT_SPIN_UP   (wxID_ANY, wxSpinCtrlDbl::OnSpinUp) EVT_SPIN_DOWN (wxID_ANY, wxSpinCtrlDbl::OnSpinDown)
