...
class WXDLLIMPEXP_PLOTCTRL wxPlotDrawerBase
        : public wxObject
{
public:
...
class WXDLLIMPEXP_PLOTCTRL wxPlotDrawerAxisBase
        : public wxPlotDrawerBase
{
public:
...
public:
    ...
    virtual void Draw(wxDC *WXUNUSED(dc), bool WXUNUSED(refresh))
    {
    } // unused
