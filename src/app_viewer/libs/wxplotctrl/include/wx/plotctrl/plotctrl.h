...
public:
    ...
    double GetFixXAxisTickStep() const { return m_xAxisTick_step_fix; }
    void SetFixXAxisTickStep( double val ) { m_xAxisTick_step_fix = val; }
    double GetFixYAxisTickStep() const { return m_yAxisTick_step_fix; }
    void SetFixYAxisTickStep( double val ) { m_yAxisTick_step_fix = val; }

    // Set the axis type
    wxPlotCtrlAxis_TicksType GetXAxisTickType() const { return m_xAxisTickType; }
    void SetXAxisTickType( wxPlotCtrlAxis_TicksType val ) { m_xAxisTickType = val; }
    wxPlotCtrlAxis_TicksType GetYAxisTickType() const { return m_yAxisTickType; }
    void SetYAxisTickType( wxPlotCtrlAxis_TicksType val ) { m_yAxisTickType = val; }
    ...
    void SetYAxisTicksWidth(int txtWidth) { m_y_axis_text_width = txtWidth; }
    ...
    void FormatAxisTickLables(wxArrayString &axisLabels, double current, wxString tickFormat = wxEmptyString, wxPlotCtrlAxis_TicksType tickType = wxPLOTCTRL_VALUE);
