...
class asFrameForecastVirtual : public wxFrame {
 ...
 protected:
  ...
  virtual void OnLoadPreviousDay(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnLoadPreviousForecast(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnLoadNextForecast(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnLoadNextDay(wxCommandEvent& event) {
    event.Skip();
  }
  ...
  virtual void OnSaveWorkspaceAs(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnNewWorkspace(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnOpenForecast(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnOpenLayer(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnCloseLayer(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnMoveLayer(wxCommandEvent& event) {
    event.Skip();
  }
...
class asWizardWorkspaceVirtual : public wxWizard {
 ...
 protected:
  ...
  virtual void OnLoadExistingWorkspace(wxCommandEvent& event) {
    event.Skip();
  }
...
class asPanelSidebarVirtual : public wxPanel {
 ...
 protected:
  ...
  // Virtual event handlers, overide them in your derived class
  virtual void OnReducePanel(wxMouseEvent& event) {
    event.Skip();
  }
...
class asFramePlotTimeSeriesVirtual : public wxFrame {
 ...
 protected:
  ...
  virtual void OnTocSelectionChange(wxCommandEvent& event) {
    event.Skip();
  }

 public:
  asFramePlotTimeSeriesVirtual(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Forecast plots"),
...
class asFramePlotDistributionsVirutal : public wxFrame {
 ...
 protected:
  ...
  // Virtual event handlers, overide them in your derived class
  virtual void OnChoiceForecastChange(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnChoiceStationChange(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnChoiceDateChange(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnTocSelectionChange(wxCommandEvent& event) {
    event.Skip();
 ...
 public:
  ...
  void m_splitter4OnIdle(wxIdleEvent&) {
    ...
    m_splitter4->Disconnect(wxEVT_IDLE, wxIdleEventHandler(asFramePlotDistributionsVirutal::m_splitter4OnIdle), NULL,
                            this);
  }
};
...
class asFrameGridAnalogsValuesVirtual : public wxFrame {
 ...
 public:
  asFrameGridAnalogsValuesVirtual(wxWindow* parent, wxWindowID id = wxID_ANY,
                                  const wxString& title = _("Analogs details"), const wxPoint& pos = wxDefaultPosition,
                                  const wxSize& size = wxSize(473, 500),
                                  long style = wxDEFAULT_FRAME_STYLE | wxTAB_TRAVERSAL);
...
class asFramePredictorsVirtual : public wxFrame {
 ...
 protected:
  ...
  // Virtual event handlers, overide them in your derived class
  virtual void OnForecastChange(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnPredictorSelectionChange(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnTargetDateChange(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnSwitchRight(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnSwitchLeft(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnAnalogDateChange(wxCommandEvent& event) {
    event.Skip();
  }
  virtual void OnOpenLayer(wxCommandEvent& event) {
    event.Skip();
 ...
 public:
  asFramePredictorsVirtual(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Predictors overview"),
  ...
  void m_splitterTocOnIdle(wxIdleEvent&) {
    ...
    m_splitterToc->Disconnect(wxEVT_IDLE, wxIdleEventHandler(asFramePredictorsVirtual::m_splitterTocOnIdle), NULL,
                              this);
  }
};
...
class asFramePreferencesViewerVirtual : public wxFrame {
 ...
 public:
  asFramePreferencesViewerVirtual(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Preferences"),
