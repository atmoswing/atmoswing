...
class asFrameForecastVirtual : public wxFrame {
   ...
   public:
    ...
    void m_splitterGISOnIdle(wxIdleEvent&) {
        ...
        m_splitterGIS->Disconnect(wxEVT_IDLE, wxIdleEventHandler(asFrameForecastVirtual::m_splitterGISOnIdle), NULL,
                                  this);
    }
};
...
class asFramePlotTimeSeriesVirtual : public wxFrame {
   ...
   public:
    ...
    void m_splitterOnIdle(wxIdleEvent&) {
        ...
        m_splitter->Disconnect(wxEVT_IDLE, wxIdleEventHandler(asFramePlotTimeSeriesVirtual::m_splitterOnIdle), NULL,
                               this);
    }
};
...
class asFramePlotDistributionsVirutal : public wxFrame {
   ...
   public:
    ...
    void m_splitter4OnIdle(wxIdleEvent&) {
        ...
        m_splitter4->Disconnect(wxEVT_IDLE, wxIdleEventHandler(asFramePlotDistributionsVirutal::m_splitter4OnIdle),
                                NULL, this);
    }
};
