...
asFrameForecastVirtual::asFrameForecastVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    m_scrolledWindowOptions =
        new wxScrolledWindow(m_splitterGIS, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
    ...
    m_staticTextForecastDate =
        new wxStaticText(m_panelTop, wxID_ANY, _("No forecast opened"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextForecastDate->Wrap(-1);
    m_staticTextForecastDate->SetFont(
    ...
    m_staticTextForecast =
        new wxStaticText(m_panelTop, wxID_ANY, _("No forecast selected"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextForecast->Wrap(-1);
    m_staticTextForecast->SetFont(
    ...
    m_menuItemOpenWorkspace =
        new wxMenuItem(m_menuFile, wxID_ANY, wxString(_("Open a workspace")), wxEmptyString, wxITEM_NORMAL);
    m_menuFile->Append(m_menuItemOpenWorkspace);

    wxMenuItem* m_menuItemSaveWorkspace;
    m_menuItemSaveWorkspace =
        new wxMenuItem(m_menuFile, wxID_ANY, wxString(_("Save the workspace")), wxEmptyString, wxITEM_NORMAL);
    m_menuFile->Append(m_menuItemSaveWorkspace);

    wxMenuItem* m_menuItemSaveWorkspaceAs;
    m_menuItemSaveWorkspaceAs =
        new wxMenuItem(m_menuFile, wxID_ANY, wxString(_("Save the workspace as")), wxEmptyString, wxITEM_NORMAL);
    m_menuFile->Append(m_menuItemSaveWorkspaceAs);

    wxMenuItem* m_menuItemNewWorkspace;
    m_menuItemNewWorkspace =
        new wxMenuItem(m_menuFile, wxID_ANY, wxString(_("Create a new workspace")), wxEmptyString, wxITEM_NORMAL);
    m_menuFile->Append(m_menuItemNewWorkspace);

    m_menuFile->AppendSeparator();

    wxMenuItem* m_menuItemOpenForecast;
    m_menuItemOpenForecast =
        new wxMenuItem(m_menuFile, wxID_ANY, wxString(_("Open a forecast file")), wxEmptyString, wxITEM_NORMAL);
    m_menuFile->Append(m_menuItemOpenForecast);

    m_menuFile->AppendSeparator();

    wxMenuItem* m_menuItemOpenGISLayer;
    m_menuItemOpenGISLayer =
        new wxMenuItem(m_menuFile, wxID_OPEN, wxString(_("Open a GIS layer")), wxEmptyString, wxITEM_NORMAL);
    m_menuFile->Append(m_menuItemOpenGISLayer);

    wxMenuItem* m_menuItemCloseGISLayer;
    m_menuItemCloseGISLayer =
        new wxMenuItem(m_menuFile, wxID_ANY, wxString(_("Close a GIS layer")), wxEmptyString, wxITEM_NORMAL);
    m_menuFile->Append(m_menuItemCloseGISLayer);

    wxMenuItem* m_menuItemMoveGISLayer;
    m_menuItemMoveGISLayer =
        new wxMenuItem(m_menuFile, wxID_ANY, wxString(_("Move the selected layer")), wxEmptyString, wxITEM_NORMAL);
    ...
    m_menuItemPreferences =
        new wxMenuItem(m_menuOptions, wxID_ANY, wxString(_("Preferences")), wxEmptyString, wxITEM_NORMAL);
    ...
    m_menuItemBuildPredictandDB =
        new wxMenuItem(m_menuTools, wxID_ANY, wxString(_("Build predictand DB")), wxEmptyString, wxITEM_NORMAL);
    ...
    m_menuItemShowLog =
        new wxMenuItem(m_menuLog, wxID_ANY, wxString(_("Show Log Window")), wxEmptyString, wxITEM_NORMAL);
    m_menuLog->Append(m_menuItemShowLog);

    m_menuLogLevel = new wxMenu();
    wxMenuItem* m_menuLogLevelItem =
        new wxMenuItem(m_menuLog, wxID_ANY, _("Log level"), wxEmptyString, wxITEM_NORMAL, m_menuLogLevel);
    wxMenuItem* m_menuItemLogLevel1;
    m_menuItemLogLevel1 =
        new wxMenuItem(m_menuLogLevel, wxID_ANY, wxString(_("Only errors")), wxEmptyString, wxITEM_CHECK);
    m_menuLogLevel->Append(m_menuItemLogLevel1);

    wxMenuItem* m_menuItemLogLevel2;
    m_menuItemLogLevel2 =
        new wxMenuItem(m_menuLogLevel, wxID_ANY, wxString(_("Errors and warnings")), wxEmptyString, wxITEM_CHECK);
    ...
    // Connect Events
    m_button51->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameForecastVirtual::OnLoadPreviousDay),
                        NULL, this);
    m_button5->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                       wxCommandEventHandler(asFrameForecastVirtual::OnLoadPreviousForecast), NULL, this);
    m_button6->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameForecastVirtual::OnLoadNextForecast),
                       NULL, this);
    m_button61->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameForecastVirtual::OnLoadNextDay),
                        NULL, this);
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnOpenWorkspace), this,
                     m_menuItemOpenWorkspace->GetId());
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnSaveWorkspace), this,
                     m_menuItemSaveWorkspace->GetId());
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnSaveWorkspaceAs),
                     this, m_menuItemSaveWorkspaceAs->GetId());
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnNewWorkspace), this,
                     m_menuItemNewWorkspace->GetId());
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnOpenForecast), this,
                     m_menuItemOpenForecast->GetId());
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnOpenLayer), this,
                     m_menuItemOpenGISLayer->GetId());
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnCloseLayer), this,
                     m_menuItemCloseGISLayer->GetId());
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnMoveLayer), this,
                     m_menuItemMoveGISLayer->GetId());
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnQuit), this,
                     m_menuItemQuit->GetId());
    m_menuOptions->Bind(wxEVT_COMMAND_MENU_SELECTED,
                        wxCommandEventHandler(asFrameForecastVirtual::OpenFramePreferences), this,
                        m_menuItemPreferences->GetId());
    m_menuTools->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OpenFramePredictandDB),
                      this, m_menuItemBuildPredictandDB->GetId());
    m_menuLog->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnShowLog), this,
                    m_menuItemShowLog->GetId());
    m_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnLogLevel1), this,
                         m_menuItemLogLevel1->GetId());
    m_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnLogLevel2), this,
                         m_menuItemLogLevel2->GetId());
    m_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnLogLevel3), this,
                         m_menuItemLogLevel3->GetId());
    m_menuHelp->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OpenFrameAbout), this,
                     m_menuItemAbout->GetId());
}

asFrameForecastVirtual::~asFrameForecastVirtual() {
    // Disconnect Events
    m_button51->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                           wxCommandEventHandler(asFrameForecastVirtual::OnLoadPreviousDay), NULL, this);
    m_button5->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(asFrameForecastVirtual::OnLoadPreviousForecast), NULL, this);
    m_button6->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(asFrameForecastVirtual::OnLoadNextForecast), NULL, this);
    m_button61->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameForecastVirtual::OnLoadNextDay),
                           NULL, this);
}
...
asWizardWorkspaceVirtual::asWizardWorkspaceVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    m_staticText37 =
        new wxStaticText(m_wizPage1, wxID_ANY, _("Load / create a workspace"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticText37->Wrap(-1);
    m_staticText37->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer48->Add(m_staticText37, 0, wxALL | wxEXPAND, 5);

    m_staticText35 =
        new wxStaticText(m_wizPage1, wxID_ANY, _("Load an existing file"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText46 = new wxStaticText(m_wizPage1, wxID_ANY, _("or continue to create a new workspace"),
    ...
    m_staticText36 =
        new wxStaticText(m_wizPage2, wxID_ANY, _("Create a new workspace"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticText36->Wrap(-1);
    m_staticText36->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer49->Add(m_staticText36, 0, wxALL | wxEXPAND, 5);

    m_staticText43 =
        new wxStaticText(m_wizPage2, wxID_ANY, _("Path to save the new file"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticText43->Wrap(-1);
    bSizer49->Add(m_staticText43, 0, wxALL, 5);

    m_filePickerWorkspaceFile =
        new wxFilePickerCtrl(m_wizPage2, wxID_ANY, wxEmptyString, _("Select a file"), _("*.asvw"), wxDefaultPosition,
                             wxDefaultSize, wxFLP_SAVE | wxFLP_USE_TEXTCTRL);
    ...
    m_staticText44 =
        new wxStaticText(m_wizPage3, wxID_ANY, _("Workspace options"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticText44->Wrap(-1);
    m_staticText44->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer50->Add(m_staticText44, 0, wxALL | wxEXPAND, 5);

    m_staticTextForecastResultsDir = new wxStaticText(m_wizPage3, wxID_ANY, _("Path to the forecasts directory"),
                                                      wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextForecastResultsDir->Wrap(-1);
    bSizer50->Add(m_staticTextForecastResultsDir, 0, wxALL, 5);

    m_dirPickerForecastResults = new wxDirPickerCtrl(m_wizPage3, wxID_ANY, wxEmptyString, _("Select a folder"),
    ...
    m_staticText42 =
        new wxStaticText(m_wizPage3, wxID_ANY, _("Other workspace parameters can be defined in the preferences frame."),
                         wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticText45->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer51->Add(m_staticText45, 0, wxALL | wxEXPAND, 5);

    m_staticText40 = new wxStaticText(m_wizPage4, wxID_ANY, _("Choose the base map for your project"),
                                      wxDefaultPosition, wxDefaultSize, 0);
    m_staticText40->Wrap(-1);
    bSizer51->Add(m_staticText40, 0, wxALL, 5);

    wxString m_choiceBaseMapChoices[] = {_("Custom layers"),
    ...
    m_choiceBaseMap = new wxChoice(m_wizPage4, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceBaseMapNChoices,
                                   m_choiceBaseMapChoices, 0);
...
asFramePlotTimeSeriesVirtual::asFramePlotTimeSeriesVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    m_staticTextStationName =
        new wxStaticText(m_panelStationName, wxID_ANY, _("Station name"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextStationName->Wrap(-1);
    m_staticTextStationName->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL,
                                            wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer37->Add(m_staticTextStationName, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_buttonSaveTxt =
        new wxButton(m_panelStationName, wxID_ANY, _("Export as txt"), wxDefaultPosition, wxSize(-1, 25), 0);
    m_buttonSaveTxt->SetFont(
    ...
    m_checkListToc =
        new wxCheckListBox(m_panelLeft, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_checkListTocChoices, 0);
    bSizer27->Add(m_checkListToc, 1, wxEXPAND, 5);

    wxArrayString m_checkListPastChoices;
    m_checkListPast =
        new wxCheckListBox(m_panelLeft, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_checkListPastChoices, 0);
    ...
    m_panelRight =
        new wxPanel(m_splitter, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL | wxBORDER_SIMPLE);
    ...
    // Connect Events
    m_buttonSaveTxt->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                             wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnExportTXT), NULL, this);
    m_buttonPreview->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                             wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnPreview), NULL, this);
    m_buttonPrint->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnPrint),
                           NULL, this);
    m_checkListToc->Connect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                            wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnTocSelectionChange), NULL, this);
    m_checkListPast->Connect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                             wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnTocSelectionChange), NULL, this);
}

asFramePlotTimeSeriesVirtual::~asFramePlotTimeSeriesVirtual() {
    // Disconnect Events
    m_buttonSaveTxt->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnExportTXT), NULL, this);
    m_buttonPreview->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnPreview), NULL, this);
    m_buttonPrint->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                              wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnPrint), NULL, this);
    m_checkListToc->Disconnect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                               wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnTocSelectionChange), NULL, this);
    m_checkListPast->Disconnect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                                wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnTocSelectionChange), NULL, this);
}
...
asFramePlotDistributionsVirutal::asFramePlotDistributionsVirutal(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    m_staticTextForecast =
        new wxStaticText(m_panelOptions, wxID_ANY, _("Select forecast"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextForecast->Wrap(-1);
    fgSizer1->Add(m_staticTextForecast, 0, wxALIGN_CENTER_HORIZONTAL | wxTOP | wxRIGHT | wxLEFT, 5);

    m_staticTextStation =
        new wxStaticText(m_panelOptions, wxID_ANY, _("Select station"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextStation->Wrap(-1);
    fgSizer1->Add(m_staticTextStation, 0, wxALIGN_CENTER_HORIZONTAL | wxTOP | wxRIGHT | wxLEFT, 5);

    m_staticTextDate =
        new wxStaticText(m_panelOptions, wxID_ANY, _("Select date"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_choiceForecast =
        new wxChoice(m_panelOptions, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceForecastChoices, 0);
    ...
    m_choiceStation =
        new wxChoice(m_panelOptions, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceStationChoices, 0);
    ...
    m_splitter4->Connect(wxEVT_IDLE, wxIdleEventHandler(asFramePlotDistributionsVirutal::m_splitter4OnIdle), NULL,
                         this);
    ...
    m_checkListTocPredictands = new wxCheckListBox(m_panelPredictandsLeft, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                                   m_checkListTocPredictandsChoices, 0 | wxBORDER_NONE);
...
asFramePlotDistributionsVirutal::~asFramePlotDistributionsVirutal() {
    // Disconnect Events
    m_choiceForecast->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                                 wxCommandEventHandler(asFramePlotDistributionsVirutal::OnChoiceForecastChange), NULL,
                                 this);
    m_choiceStation->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                                wxCommandEventHandler(asFramePlotDistributionsVirutal::OnChoiceStationChange), NULL,
                                this);
    m_choiceDate->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                             wxCommandEventHandler(asFramePlotDistributionsVirutal::OnChoiceDateChange), NULL, this);
    m_checkListTocPredictands->Disconnect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                                          wxCommandEventHandler(asFramePlotDistributionsVirutal::OnTocSelectionChange),
                                          NULL, this);
}
...
asFrameGridAnalogsValuesVirtual::asFrameGridAnalogsValuesVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    m_grid->Connect(wxEVT_GRID_LABEL_LEFT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                    this);
    m_grid->Connect(wxEVT_GRID_LABEL_RIGHT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                    this);
    m_grid->Connect(wxEVT_GRID_LABEL_LEFT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                    this);
    m_grid->Connect(wxEVT_GRID_LABEL_RIGHT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
...
asFrameGridAnalogsValuesVirtual::~asFrameGridAnalogsValuesVirtual() {
    ...
    m_choiceDate->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                             wxCommandEventHandler(asFrameGridAnalogsValuesVirtual::OnChoiceDateChange), NULL, this);
    m_grid->Disconnect(wxEVT_GRID_LABEL_LEFT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                       this);
    m_grid->Disconnect(wxEVT_GRID_LABEL_RIGHT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid),
                       NULL, this);
    m_grid->Disconnect(wxEVT_GRID_LABEL_LEFT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                       this);
    m_grid->Disconnect(wxEVT_GRID_LABEL_RIGHT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid),
...
asFramePredictorsVirtual::asFramePredictorsVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    m_scrolledWindowOptions =
        new wxScrolledWindow(m_splitterToc, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
    m_scrolledWindowOptions->SetScrollRate(5, 5);
    m_sizerScrolledWindow = new wxBoxSizer(wxVERTICAL);

    m_staticTextChoiceForecast =
        new wxStaticText(m_scrolledWindowOptions, wxID_ANY, _("Forecast"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    wxArrayString m_choiceForecastChoices;
    m_choiceForecast =
        new wxChoice(m_scrolledWindowOptions, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceForecastChoices, 0);
    m_choiceForecast->SetSelection(0);
    m_choiceForecast->SetMaxSize(wxSize(150, -1));

    m_sizerScrolledWindow->Add(m_choiceForecast, 0, wxEXPAND | wxALL, 5);

    m_staticTextCheckListPredictors = new wxStaticText(m_scrolledWindowOptions, wxID_ANY, _("Possible predictors"),
                                                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_checkListPredictors = new wxCheckListBox(m_scrolledWindowOptions, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                               m_checkListPredictorsChoices, 0);
    m_sizerScrolledWindow->Add(m_checkListPredictors, 1, wxEXPAND, 5);

    m_staticTextTocLeft = new wxStaticText(m_scrolledWindowOptions, wxID_ANY, _("Layers of the left panel"),
                                           wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextTocLeft->Wrap(-1);
    m_sizerScrolledWindow->Add(m_staticTextTocLeft, 0, wxALL | wxALIGN_CENTER_HORIZONTAL, 5);

    m_staticTextTocRight = new wxStaticText(m_scrolledWindowOptions, wxID_ANY, _("Layers of the right panel"),
                                            wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextTargetDates =
        new wxStaticText(m_panelLeft, wxID_ANY, _("Forecast date"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_choiceTargetDates =
        new wxChoice(m_panelLeft, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceTargetDatesChoices, 0);
    ...
    m_panelGISLeft =
        new wxPanel(m_panelLeft, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL | wxBORDER_SIMPLE);
    ...
    m_bpButtonSwitchRight = new wxBitmapButton(m_panelSwitch, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize(10, 28),
    ...
    m_bpButtonSwitchLeft = new wxBitmapButton(m_panelSwitch, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize(10, 28),
                                              wxBU_AUTODRAW | 0 | wxBORDER_NONE);
    ...
    m_staticTextAnalogDates =
        new wxStaticText(m_panelRight, wxID_ANY, _("Analogs"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_choiceAnalogDates =
        new wxChoice(m_panelRight, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceAnalogDatesChoices, 0);
    ...
    m_panelGISRight =
        new wxPanel(m_panelRight, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL | wxBORDER_SIMPLE);
    ...
    wxMenuItem* m_menuItemOpenGisLayer;
    m_menuItemOpenGisLayer =
        new wxMenuItem(m_menuFile, wxID_ANY, wxString(_("Open GIS layer")), wxEmptyString, wxITEM_NORMAL);
    m_menuFile->Append(m_menuItemOpenGisLayer);
    ...
    m_checkListPredictors->Connect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                                   wxCommandEventHandler(asFramePredictorsVirtual::OnPredictorSelectionChange), NULL,
                                   this);
    m_choiceTargetDates->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                                 wxCommandEventHandler(asFramePredictorsVirtual::OnTargetDateChange), NULL, this);
    m_bpButtonSwitchRight->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                   wxCommandEventHandler(asFramePredictorsVirtual::OnSwitchRight), NULL, this);
    m_bpButtonSwitchLeft->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                  wxCommandEventHandler(asFramePredictorsVirtual::OnSwitchLeft), NULL, this);
    m_choiceAnalogDates->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                                 wxCommandEventHandler(asFramePredictorsVirtual::OnAnalogDateChange), NULL, this);
    m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFramePredictorsVirtual::OnOpenLayer), this,
                     m_menuItemOpenGisLayer->GetId());
}
...
asFramePredictorsVirtual::~asFramePredictorsVirtual() {
    ...
    m_choiceForecast->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                                 wxCommandEventHandler(asFramePredictorsVirtual::OnForecastChange), NULL, this);
    m_checkListPredictors->Disconnect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                                      wxCommandEventHandler(asFramePredictorsVirtual::OnPredictorSelectionChange), NULL,
                                      this);
    m_choiceTargetDates->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                                    wxCommandEventHandler(asFramePredictorsVirtual::OnTargetDateChange), NULL, this);
    m_bpButtonSwitchRight->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                      wxCommandEventHandler(asFramePredictorsVirtual::OnSwitchRight), NULL, this);
    m_bpButtonSwitchLeft->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                     wxCommandEventHandler(asFramePredictorsVirtual::OnSwitchLeft), NULL, this);
    m_choiceAnalogDates->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                                    wxCommandEventHandler(asFramePredictorsVirtual::OnAnalogDateChange), NULL, this);
}
...
asFramePreferencesViewerVirtual::asFramePreferencesViewerVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    m_staticTextForecastResultsDir = new wxStaticText(
        m_panelWorkspace, wxID_ANY, _("Directory containing the forecasts"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextForecastResultsDir->Wrap(-1);
    bSizer55->Add(m_staticTextForecastResultsDir, 0, wxTOP | wxRIGHT | wxLEFT, 5);

    m_dirPickerForecastResults = new wxDirPickerCtrl(m_panelWorkspace, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                     wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL);
    ...
    m_staticTextColorbarMaxValue =
        new wxStaticText(m_panelWorkspace, wxID_ANY, _("Set the maximum rainfall value for the colorbar"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextColorbarMaxValue->Wrap(-1);
    fgSizer81->Add(m_staticTextColorbarMaxValue, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_textCtrlColorbarMaxValue =
        new wxTextCtrl(m_panelWorkspace, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(40, -1), 0);
    fgSizer81->Add(m_textCtrlColorbarMaxValue, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_staticTextColorbarMaxUnit =
        new wxStaticText(m_panelWorkspace, wxID_ANY, _("mm/d"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextColorbarMaxUnit->Wrap(-1);
    fgSizer81->Add(m_staticTextColorbarMaxUnit, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_staticTextPastDaysNb =
        new wxStaticText(m_panelWorkspace, wxID_ANY, _("Number of past days to display on the timeseries"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextPastDaysNb->Wrap(-1);
    fgSizer81->Add(m_staticTextPastDaysNb, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_textCtrlPastDaysNb =
        new wxTextCtrl(m_panelWorkspace, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(40, -1), 0);
    ...
    m_staticTextAlarmsReturnPeriod = new wxStaticText(
    ...
    m_choiceAlarmsReturnPeriod = new wxChoice(sbSizer191->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                              m_choiceAlarmsReturnPeriodNChoices, m_choiceAlarmsReturnPeriodChoices, 0);
    m_choiceAlarmsReturnPeriod->SetSelection(0);
    fgSizer13->Add(m_choiceAlarmsReturnPeriod, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_staticTextAlarmsReturnPeriodYears =
        new wxStaticText(sbSizer191->GetStaticBox(), wxID_ANY, _("years"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextAlarmsQuantile = new wxStaticText(sbSizer191->GetStaticBox(), wxID_ANY, _("Quantile to display"),
                                                  wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextAlarmsQuantile->Wrap(-1);
    fgSizer13->Add(m_staticTextAlarmsQuantile, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_textCtrlAlarmsQuantile =
        new wxTextCtrl(sbSizer191->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(40, -1), 0);
    fgSizer13->Add(m_textCtrlAlarmsQuantile, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_staticTextAlarmsQuantileRange = new wxStaticText(sbSizer191->GetStaticBox(), wxID_ANY, _("(in between 0 - 1)"),
                                                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_radioBtnLogLevel1 = new wxRadioButton(sbSizer7->GetStaticBox(), wxID_ANY, _("Errors only (recommanded)"),
                                            wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
    bSizer62->Add(m_radioBtnLogLevel1, 0, wxALL, 5);

    m_radioBtnLogLevel2 = new wxRadioButton(sbSizer7->GetStaticBox(), wxID_ANY, _("Errors and warnings"),
                                            wxDefaultPosition, wxDefaultSize, 0);
    bSizer62->Add(m_radioBtnLogLevel2, 0, wxALL, 5);

    m_radioBtnLogLevel3 =
        new wxRadioButton(sbSizer7->GetStaticBox(), wxID_ANY, _("Verbose"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_checkBoxDisplayLogWindow =
        new wxCheckBox(sbSizer7->GetStaticBox(), wxID_ANY, _("Display window"), wxDefaultPosition, wxDefaultSize, 0);
    m_checkBoxDisplayLogWindow->SetValue(true);
    bSizer21->Add(m_checkBoxDisplayLogWindow, 0, wxALL, 5);

    m_checkBoxSaveLogFile =
        new wxCheckBox(sbSizer7->GetStaticBox(), wxID_ANY, _("Save to a file"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    sbSizer14 =
        new wxStaticBoxSizer(new wxStaticBox(m_panelGeneralCommon, wxID_ANY, _("Proxy configuration")), wxVERTICAL);

    m_checkBoxProxy = new wxCheckBox(sbSizer14->GetStaticBox(), wxID_ANY, _("Internet connection uses a proxy"),
                                     wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextProxyAddress =
        new wxStaticText(sbSizer14->GetStaticBox(), wxID_ANY, _("Proxy address"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextProxyAddress->Wrap(-1);
    bSizer34->Add(m_staticTextProxyAddress, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_textCtrlProxyAddress =
        new wxTextCtrl(sbSizer14->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(180, -1), 0);
    bSizer34->Add(m_textCtrlProxyAddress, 1, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_staticTextProxyPort =
        new wxStaticText(sbSizer14->GetStaticBox(), wxID_ANY, _("Port"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextProxyPort->Wrap(-1);
    bSizer34->Add(m_staticTextProxyPort, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_textCtrlProxyPort =
        new wxTextCtrl(sbSizer14->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextProxyUser =
        new wxStaticText(sbSizer14->GetStaticBox(), wxID_ANY, _("Username"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextProxyUser->Wrap(-1);
    bSizer35->Add(m_staticTextProxyUser, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_textCtrlProxyUser =
        new wxTextCtrl(sbSizer14->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(-1, -1), 0);
    bSizer35->Add(m_textCtrlProxyUser, 1, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_staticTextProxyPasswd =
        new wxStaticText(sbSizer14->GetStaticBox(), wxID_ANY, _("Password"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextProxyPasswd->Wrap(-1);
    bSizer35->Add(m_staticTextProxyPasswd, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_textCtrlProxyPasswd = new wxTextCtrl(sbSizer14->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
    ...
    m_checkBoxMultiInstancesViewer = new wxCheckBox(
        m_panelAdvanced, wxID_ANY, _("Allow multiple instances of the viewer"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextUserDirLabel = new wxStaticText(sbSizer17->GetStaticBox(), wxID_ANY, _("User working directory:"),
                                                wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextUserDirLabel->Wrap(-1);
    fgSizer9->Add(m_staticTextUserDirLabel, 0, wxALL, 5);

    m_staticTextUserDir =
        new wxStaticText(sbSizer17->GetStaticBox(), wxID_ANY, _("..."), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextUserDir->Wrap(-1);
    fgSizer9->Add(m_staticTextUserDir, 0, wxALL, 5);

    m_staticTextLogFileLabel =
        new wxStaticText(sbSizer17->GetStaticBox(), wxID_ANY, _("Log file:"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextPrefFileLabel = new wxStaticText(sbSizer17->GetStaticBox(), wxID_ANY, _("Preferences file:"),
                                                 wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextPrefFileLabel->Wrap(-1);
    fgSizer9->Add(m_staticTextPrefFileLabel, 0, wxALL, 5);

    m_staticTextPrefFile =
        new wxStaticText(sbSizer17->GetStaticBox(), wxID_ANY, _("..."), wxDefaultPosition, wxDefaultSize, 0);
...
asFramePreferencesViewerVirtual::~asFramePreferencesViewerVirtual() {
    // Disconnect Events
    m_buttonsConfirmationApply->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFramePreferencesViewerVirtual::ApplyChanges), NULL, this);
    m_buttonsConfirmationCancel->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFramePreferencesViewerVirtual::CloseFrame), NULL, this);
    m_buttonsConfirmationOK->Disconnect(
