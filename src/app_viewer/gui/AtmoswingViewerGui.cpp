...
asFrameForecastVirtual::asFrameForecastVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
  ...
  m_button6->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameForecastVirtual::OnLoadNextForecast),
                     NULL, this);
  m_button61->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameForecastVirtual::OnLoadNextDay), NULL,
                      this);
  ...
  m_menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OnSaveWorkspaceAs), this,
                   m_menuItemSaveWorkspaceAs->GetId());
  ...
  m_menuOptions->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameForecastVirtual::OpenFramePreferences),
                      this, m_menuItemPreferences->GetId());
...
asFrameForecastVirtual::~asFrameForecastVirtual() {
  // Disconnect Events
  m_button51->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameForecastVirtual::OnLoadPreviousDay),
                         NULL, this);
  m_button5->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                        wxCommandEventHandler(asFrameForecastVirtual::OnLoadPreviousForecast), NULL, this);
  m_button6->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameForecastVirtual::OnLoadNextForecast),
                        NULL, this);
...
asWizardWorkspaceVirtual::asWizardWorkspaceVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
  ...
  m_staticText46 = new wxStaticText(m_wizPage1, wxID_ANY, _("or continue to create a new workspace"), wxDefaultPosition,
                                    wxDefaultSize, 0);
  ...
  m_filePickerWorkspaceFile = new wxFilePickerCtrl(m_wizPage2, wxID_ANY, wxEmptyString, _("Select a file"), _("*.asvw"),
  ...
  m_staticTextForecastResultsDir =
      new wxStaticText(m_wizPage3, wxID_ANY, _("Path to the forecasts directory"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText40 = new wxStaticText(m_wizPage4, wxID_ANY, _("Choose the base map for your project"), wxDefaultPosition,
                                    wxDefaultSize, 0);
  ...
  m_staticText41 =
      new wxStaticText(m_wizPage4, wxID_ANY,
...
asFramePlotTimeSeriesVirtual::asFramePlotTimeSeriesVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
  ...
  m_buttonPreview->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnPreview),
                           NULL, this);
...
asFramePlotTimeSeriesVirtual::~asFramePlotTimeSeriesVirtual() {
  ...
  m_buttonPrint->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnPrint),
                            NULL, this);
...
asFramePlotDistributionsVirutal::asFramePlotDistributionsVirutal(wxWindow* parent, wxWindowID id, const wxString& title,
  ...
  m_choiceForecast->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                            wxCommandEventHandler(asFramePlotDistributionsVirutal::OnChoiceForecastChange), NULL, this);
  ...
  m_checkListTocPredictands->Connect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                                     wxCommandEventHandler(asFramePlotDistributionsVirutal::OnTocSelectionChange), NULL,
                                     this);
}
...
asFrameGridAnalogsValuesVirtual::asFrameGridAnalogsValuesVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
  ...
  // Connect Events
  m_choiceForecast->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                            wxCommandEventHandler(asFrameGridAnalogsValuesVirtual::OnChoiceForecastChange), NULL, this);
  m_choiceStation->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
...
asFrameGridAnalogsValuesVirtual::~asFrameGridAnalogsValuesVirtual() {
  ...
  m_grid->Disconnect(wxEVT_GRID_LABEL_LEFT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                     this);
  m_grid->Disconnect(wxEVT_GRID_LABEL_RIGHT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                     this);
  m_grid->Disconnect(wxEVT_GRID_LABEL_LEFT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                     this);
  m_grid->Disconnect(wxEVT_GRID_LABEL_RIGHT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
...
asFramePreferencesViewerVirtual::asFramePreferencesViewerVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
  ...
  m_staticTextForecastResultsDir = new wxStaticText(m_panelWorkspace, wxID_ANY, _("Directory containing the forecasts"),
                                                    wxDefaultPosition, wxDefaultSize, 0);
  m_staticTextForecastResultsDir->Wrap(-1);
  ...
  m_staticTextAlarmsReturnPeriod = new wxStaticText(sbSizer191->GetStaticBox(), wxID_ANY, _("Return period to display"),
                                                    wxDefaultPosition, wxDefaultSize, 0);
  ...
  // Connect Events
  m_buttonsConfirmationApply->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                      wxCommandEventHandler(asFramePreferencesViewerVirtual::ApplyChanges), NULL, this);
