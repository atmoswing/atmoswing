...
class asFrameViewerVirtual : public wxFrame {
  ...
  public:
    asFrameViewerVirtual(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("AtmoSwing Viewer"),
...
class asFramePlotTimeSeriesVirtual : public wxFrame {
  ...
  protected:
    ...
    virtual void ResetExtent(wxCommandEvent& event) {
        event.Skip();
    }
  ...
  public:
    ...
    void _splitterOnIdle(wxIdleEvent&) {
        ...
        _splitter->Disconnect(wxEVT_IDLE, wxIdleEventHandler(asFramePlotTimeSeriesVirtual::_splitterOnIdle), NULL,
                              this);
    }
};
...
class asFramePlotDistributionsVirutal : public wxFrame {
  ...
  public:
    ...
    void _splitter4OnIdle(wxIdleEvent&) {
        ...
        _splitter4->Disconnect(wxEVT_IDLE, wxIdleEventHandler(asFramePlotDistributionsVirutal::_splitter4OnIdle), NULL,
                               this);
    }
};
...
class asFramePredictorsVirtual : public wxFrame {
  ...
  public:
    ...
    void _splitterTocOnIdle(wxIdleEvent&) {
        ...
        _splitterToc->Disconnect(wxEVT_IDLE, wxIdleEventHandler(asFramePredictorsVirtual::_splitterTocOnIdle), NULL,
                                 this);
    }
};
