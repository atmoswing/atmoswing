...
asFrameViewerVirtual::asFrameViewerVirtual(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos,
    ...
    _scrolledWindowOptions = new wxScrolledWindow(_splitterGIS, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                                  wxHSCROLL | wxVSCROLL);
    ...
    _staticTextForecastDate = new wxStaticText(_panelTop, wxID_ANY, _("No forecast opened"), wxDefaultPosition,
                                               wxDefaultSize, 0);
    _staticTextForecastDate->Wrap(-1);
    _staticTextForecastDate->SetFont(
    ...
    _staticTextForecast = new wxStaticText(_panelTop, wxID_ANY, _("No forecast selected"), wxDefaultPosition,
                                           wxDefaultSize, 0);
    _staticTextForecast->Wrap(-1);
    _staticTextForecast->SetFont(
    ...
    _menuItemOpenWorkspace = new wxMenuItem(_menuFile, wxID_ANY, wxString(_("Open a workspace")), wxEmptyString,
                                            wxITEM_NORMAL);
    _menuFile->Append(_menuItemOpenWorkspace);

    wxMenuItem* _menuItemSaveWorkspace;
    _menuItemSaveWorkspace = new wxMenuItem(_menuFile, wxID_ANY, wxString(_("Save the workspace")), wxEmptyString,
                                            wxITEM_NORMAL);
    _menuFile->Append(_menuItemSaveWorkspace);

    wxMenuItem* _menuItemSaveWorkspaceAs;
    _menuItemSaveWorkspaceAs = new wxMenuItem(_menuFile, wxID_ANY, wxString(_("Save the workspace as")), wxEmptyString,
                                              wxITEM_NORMAL);
    _menuFile->Append(_menuItemSaveWorkspaceAs);

    wxMenuItem* _menuItemNewWorkspace;
    _menuItemNewWorkspace = new wxMenuItem(_menuFile, wxID_ANY, wxString(_("Create a new workspace")), wxEmptyString,
                                           wxITEM_NORMAL);
    ...
    _menuItemOpenForecast = new wxMenuItem(_menuFile, wxID_ANY, wxString(_("Open a forecast file")), wxEmptyString,
                                           wxITEM_NORMAL);
    ...
    _menuItemOpenGISLayer = new wxMenuItem(_menuFile, wxID_OPEN, wxString(_("Open a GIS layer")), wxEmptyString,
                                           wxITEM_NORMAL);
    _menuFile->Append(_menuItemOpenGISLayer);

    wxMenuItem* _menuItemCloseGISLayer;
    _menuItemCloseGISLayer = new wxMenuItem(_menuFile, wxID_ANY, wxString(_("Close a GIS layer")), wxEmptyString,
                                            wxITEM_NORMAL);
    _menuFile->Append(_menuItemCloseGISLayer);

    wxMenuItem* _menuItemMoveGISLayer;
    _menuItemMoveGISLayer = new wxMenuItem(_menuFile, wxID_ANY, wxString(_("Move the selected layer")), wxEmptyString,
                                           wxITEM_NORMAL);
    ...
    _menuItemBuildPredictandDB = new wxMenuItem(_menuTools, wxID_ANY, wxString(_("Build predictand DB")), wxEmptyString,
                                                wxITEM_NORMAL);
    ...
    // Connect Events
    _button51->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameViewerVirtual::OnLoadPreviousDay),
                       NULL, this);
    _button5->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameViewerVirtual::OnLoadPreviousForecast),
                      NULL, this);
    _button6->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameViewerVirtual::OnLoadNextForecast),
                      NULL, this);
    _button61->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameViewerVirtual::OnLoadNextDay), NULL,
                       this);
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OnOpenWorkspace), this,
                    _menuItemOpenWorkspace->GetId());
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OnSaveWorkspace), this,
                    _menuItemSaveWorkspace->GetId());
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OnSaveWorkspaceAs), this,
                    _menuItemSaveWorkspaceAs->GetId());
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OnNewWorkspace), this,
                    _menuItemNewWorkspace->GetId());
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OnOpenForecast), this,
                    _menuItemOpenForecast->GetId());
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OnOpenLayer), this,
                    _menuItemOpenGISLayer->GetId());
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OnCloseLayer), this,
                    _menuItemCloseGISLayer->GetId());
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OnMoveLayer), this,
                    _menuItemMoveGISLayer->GetId());
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OnQuit), this,
                    _menuItemQuit->GetId());
    _menuOptions->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OpenFramePreferences),
                       this, _menuItemPreferences->GetId());
    _menuTools->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OpenFramePredictandDB),
                     this, _menuItemBuildPredictandDB->GetId());
    _menuLog->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OnShowLog), this,
                   _menuItemShowLog->GetId());
    _menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OnLogLevel1), this,
                        _menuItemLogLevel1->GetId());
    _menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OnLogLevel2), this,
                        _menuItemLogLevel2->GetId());
    _menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OnLogLevel3), this,
                        _menuItemLogLevel3->GetId());
    _menuHelp->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameViewerVirtual::OpenFrameAbout), this,
                    _menuItemAbout->GetId());
}

asFrameViewerVirtual::~asFrameViewerVirtual() {
    // Disconnect Events
    _button51->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameViewerVirtual::OnLoadPreviousDay),
                          NULL, this);
    _button5->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                         wxCommandEventHandler(asFrameViewerVirtual::OnLoadPreviousForecast), NULL, this);
    _button6->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameViewerVirtual::OnLoadNextForecast),
                         NULL, this);
    _button61->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFrameViewerVirtual::OnLoadNextDay),
                          NULL, this);
}

asWizardWorkspaceVirtual::asWizardWorkspaceVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    _pages.Add(_wizPage1);

    wxBoxSizer* bSizer48;
    bSizer48 = new wxBoxSizer(wxVERTICAL);

    _staticText37 = new wxStaticText(_wizPage1, wxID_ANY, _("Load / create a workspace"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    _staticText37->Wrap(-1);
    _staticText37->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer48->Add(_staticText37, 0, wxALL | wxEXPAND, 5);

    _staticText35 = new wxStaticText(_wizPage1, wxID_ANY, _("Load an existing file"), wxDefaultPosition, wxDefaultSize,
                                     0);
    ...
    _staticText46 = new wxStaticText(_wizPage1, wxID_ANY, _("or continue to create a new workspace"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    ...
    _pages.Add(_wizPage2);

    wxBoxSizer* bSizer49;
    bSizer49 = new wxBoxSizer(wxVERTICAL);

    _staticText36 = new wxStaticText(_wizPage2, wxID_ANY, _("Create a new workspace"), wxDefaultPosition, wxDefaultSize,
                                     0);
    _staticText36->Wrap(-1);
    _staticText36->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer49->Add(_staticText36, 0, wxALL | wxEXPAND, 5);

    _staticText43 = new wxStaticText(_wizPage2, wxID_ANY, _("Path to save the new file"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    _staticText43->Wrap(-1);
    bSizer49->Add(_staticText43, 0, wxALL, 5);

    _filePickerWorkspaceFile = new wxFilePickerCtrl(_wizPage2, wxID_ANY, wxEmptyString, _("Select a file"), _("*.asvw"),
    ...
    _staticText44->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer50->Add(_staticText44, 0, wxALL | wxEXPAND, 5);

    _staticTextForecastResultsDir = new wxStaticText(_wizPage3, wxID_ANY, _("Path to the forecasts directory"),
                                                     wxDefaultPosition, wxDefaultSize, 0);
    _staticTextForecastResultsDir->Wrap(-1);
    bSizer50->Add(_staticTextForecastResultsDir, 0, wxALL, 5);

    _dirPickerForecastResults = new wxDirPickerCtrl(_wizPage3, wxID_ANY, wxEmptyString, _("Select a folder"),
    ...
    _staticText42 = new wxStaticText(_wizPage3, wxID_ANY,
                                     _("Other workspace parameters can be defined in the preferences frame."),
                                     wxDefaultPosition, wxDefaultSize, 0);
    ...
    _staticText45->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer51->Add(_staticText45, 0, wxALL | wxEXPAND, 5);

    _staticText40 = new wxStaticText(_wizPage4, wxID_ANY, _("Choose the base map for your project"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    _staticText40->Wrap(-1);
    bSizer51->Add(_staticText40, 0, wxALL, 5);

    wxString _choiceBaseMapChoices[] = {_("Custom layers"),
                                        _("Terrain from Google maps (recommended)"),
                                        _("Map from Google maps"),
                                        _("Map from Openstreetmap"),
                                        _("Map from ArcGIS Mapserver"),
                                        _("Satellite imagery from Google maps"),
                                        _("Satellite imagery from VirtualEarth")};
    int _choiceBaseMapNChoices = sizeof(_choiceBaseMapChoices) / sizeof(wxString);
    _choiceBaseMap = new wxChoice(_wizPage4, wxID_ANY, wxDefaultPosition, wxDefaultSize, _choiceBaseMapNChoices,
                                  _choiceBaseMapChoices, 0);
    _choiceBaseMap->SetSelection(0);
    bSizer51->Add(_choiceBaseMap, 0, wxBOTTOM | wxRIGHT | wxLEFT | wxEXPAND, 5);

    _staticText41 = new wxStaticText(
        _wizPage4, wxID_ANY,
        _("Other GIS layers can be added in the viewer frame directly, and be saved to the workspace."),
        wxDefaultPosition, wxDefaultSize, 0);
    ...
    for (unsigned int i = 1; i < _pages.GetCount(); i++) {
        _pages.Item(i)->SetPrev(_pages.Item(i - 1));
        _pages.Item(i - 1)->SetNext(_pages.Item(i));
    }

    // Connect Events
    this->Connect(wxID_ANY, wxEVT_WIZARD_FINISHED, wxWizardEventHandler(asWizardWorkspaceVirtual::OnWizardFinished));
    _button4->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                      wxCommandEventHandler(asWizardWorkspaceVirtual::OnLoadExistingWorkspace), NULL, this);
}
...
asWizardWorkspaceVirtual::~asWizardWorkspaceVirtual() {
    ...
    _button4->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                         wxCommandEventHandler(asWizardWorkspaceVirtual::OnLoadExistingWorkspace), NULL, this);

    _pages.Clear();
}

asPanelSidebarVirtual::asPanelSidebarVirtual(wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size,
...
asFramePlotTimeSeriesVirtual::asFramePlotTimeSeriesVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    _staticTextStationName = new wxStaticText(_panelStationName, wxID_ANY, _("Station name"), wxDefaultPosition,
                                              wxDefaultSize, 0);
    _staticTextStationName->Wrap(-1);
    _staticTextStationName->SetFont(wxFont(wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL,
                                           wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer37->Add(_staticTextStationName, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _buttonSaveTxt = new wxButton(_panelStationName, wxID_ANY, _("Export as txt"), wxDefaultPosition, wxSize(-1, -1),
                                  0);
    _buttonSaveTxt->SetFont(
        wxFont(8, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));
    ...
    _checkListPast = new wxCheckListBox(_panelLeft, wxID_ANY, wxDefaultPosition, wxDefaultSize, _checkListPastChoices,
                                        0);
    ...
    // Connect Events
    _buttonSaveTxt->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                            wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnExportTXT), NULL, this);
    _buttonPreview->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                            wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnPreview), NULL, this);
    _buttonPrint->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnPrint),
                          NULL, this);
    _buttonReset->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(asFramePlotTimeSeriesVirtual::ResetExtent), NULL, this);
    _checkListToc->Connect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                           wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnTocSelectionChange), NULL, this);
    _checkListPast->Connect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                            wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnTocSelectionChange), NULL, this);
}

asFramePlotTimeSeriesVirtual::~asFramePlotTimeSeriesVirtual() {
    // Disconnect Events
    _buttonSaveTxt->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                               wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnExportTXT), NULL, this);
    _buttonPreview->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                               wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnPreview), NULL, this);
    _buttonPrint->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnPrint),
                             NULL, this);
    _buttonReset->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                             wxCommandEventHandler(asFramePlotTimeSeriesVirtual::ResetExtent), NULL, this);
    _checkListToc->Disconnect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                              wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnTocSelectionChange), NULL, this);
    _checkListPast->Disconnect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                               wxCommandEventHandler(asFramePlotTimeSeriesVirtual::OnTocSelectionChange), NULL, this);
}

asFramePlotDistributionsVirutal::asFramePlotDistributionsVirutal(wxWindow* parent, wxWindowID id, const wxString& title,
                                                                 const wxPoint& pos, const wxSize& size, long style)
    : wxFrame(parent, id, title, pos, size, style) {
    ...
    _staticTextForecast = new wxStaticText(_panelOptions, wxID_ANY, _("Select forecast"), wxDefaultPosition,
                                           wxDefaultSize, 0);
    _staticTextForecast->Wrap(-1);
    fgSizer1->Add(_staticTextForecast, 0, wxALIGN_CENTER_HORIZONTAL | wxTOP | wxRIGHT | wxLEFT, 5);

    _staticTextStation = new wxStaticText(_panelOptions, wxID_ANY, _("Select station"), wxDefaultPosition,
                                          wxDefaultSize, 0);
    ...
    _choiceForecast = new wxChoice(_panelOptions, wxID_ANY, wxDefaultPosition, wxDefaultSize, _choiceForecastChoices,
                                   0);
    ...
    _checkListTocPredictands = new wxCheckListBox(_panelPredictandsLeft, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                                  _checkListTocPredictandsChoices, 0 | wxBORDER_NONE);
    bSizer55->Add(_checkListTocPredictands, 1, wxEXPAND | wxTOP | wxBOTTOM | wxLEFT, 5);

    _buttonResetZoom = new wxButton(_panelPredictandsLeft, wxID_ANY, _("Reset zoom"), wxDefaultPosition, wxDefaultSize,
                                    0);
    ...
    // Connect Events
    _choiceForecast->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                             wxCommandEventHandler(asFramePlotDistributionsVirutal::OnChoiceForecastChange), NULL,
                             this);
    _choiceStation->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                            wxCommandEventHandler(asFramePlotDistributionsVirutal::OnChoiceStationChange), NULL, this);
    _choiceDate->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                         wxCommandEventHandler(asFramePlotDistributionsVirutal::OnChoiceDateChange), NULL, this);
    _checkListTocPredictands->Connect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                                      wxCommandEventHandler(asFramePlotDistributionsVirutal::OnTocSelectionChange),
                                      NULL, this);
    _buttonResetZoom->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                              wxCommandEventHandler(asFramePlotDistributionsVirutal::ResetExtent), NULL, this);
}

asFramePlotDistributionsVirutal::~asFramePlotDistributionsVirutal() {
    // Disconnect Events
    _choiceForecast->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                                wxCommandEventHandler(asFramePlotDistributionsVirutal::OnChoiceForecastChange), NULL,
                                this);
    _choiceStation->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                               wxCommandEventHandler(asFramePlotDistributionsVirutal::OnChoiceStationChange), NULL,
                               this);
    _choiceDate->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                            wxCommandEventHandler(asFramePlotDistributionsVirutal::OnChoiceDateChange), NULL, this);
    _checkListTocPredictands->Disconnect(wxEVT_COMMAND_CHECKLISTBOX_TOGGLED,
                                         wxCommandEventHandler(asFramePlotDistributionsVirutal::OnTocSelectionChange),
                                         NULL, this);
    _buttonResetZoom->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                 wxCommandEventHandler(asFramePlotDistributionsVirutal::ResetExtent), NULL, this);
}

asFrameGridAnalogsValuesVirtual::asFrameGridAnalogsValuesVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
                                                                 const wxPoint& pos, const wxSize& size, long style)
    : wxFrame(parent, id, title, pos, size, style) {
    this->SetSizeHints(wxSize(-1, -1), wxSize(-1, -1));
    ...
    // Connect Events
    _choiceForecast->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                             wxCommandEventHandler(asFrameGridAnalogsValuesVirtual::OnChoiceForecastChange), NULL,
                             this);
    _choiceStation->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                            wxCommandEventHandler(asFrameGridAnalogsValuesVirtual::OnChoiceStationChange), NULL, this);
    _choiceDate->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                         wxCommandEventHandler(asFrameGridAnalogsValuesVirtual::OnChoiceDateChange), NULL, this);
    _grid->Connect(wxEVT_GRID_LABEL_LEFT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                   this);
    _grid->Connect(wxEVT_GRID_LABEL_RIGHT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                   this);
    _grid->Connect(wxEVT_GRID_LABEL_LEFT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                   this);
    _grid->Connect(wxEVT_GRID_LABEL_RIGHT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
...
asFrameGridAnalogsValuesVirtual::~asFrameGridAnalogsValuesVirtual() {
    ...
    _choiceForecast->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                                ...
                                this);
    _choiceStation->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                               wxCommandEventHandler(asFrameGridAnalogsValuesVirtual::OnChoiceStationChange), NULL,
                               this);
    _choiceDate->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                            wxCommandEventHandler(asFrameGridAnalogsValuesVirtual::OnChoiceDateChange), NULL, this);
    _grid->Disconnect(wxEVT_GRID_LABEL_LEFT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                      this);
    _grid->Disconnect(wxEVT_GRID_LABEL_RIGHT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                      this);
    _grid->Disconnect(wxEVT_GRID_LABEL_LEFT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
                      this);
    _grid->Disconnect(wxEVT_GRID_LABEL_RIGHT_CLICK, wxGridEventHandler(asFrameGridAnalogsValuesVirtual::SortGrid), NULL,
...
asFramePredictorsVirtual::asFramePredictorsVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
                                                   const wxPoint& pos, const wxSize& size, long style)
    : wxFrame(parent, id, title, pos, size, style) {
    ...
    _scrolledWindowOptions = new wxScrolledWindow(_splitterToc, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                                  wxHSCROLL | wxVSCROLL);
    _scrolledWindowOptions->SetScrollRate(5, 5);
    _sizerScrolledWindow = new wxBoxSizer(wxVERTICAL);

    _staticTextChoiceMethod = new wxStaticText(_scrolledWindowOptions, wxID_ANY, _("Method"), wxDefaultPosition,
                                               wxDefaultSize, 0);
    ...
    _choiceMethod = new wxChoice(_scrolledWindowOptions, wxID_ANY, wxDefaultPosition, wxSize(220, -1),
                                 _choiceMethodChoices, 0);
    _choiceMethod->SetSelection(0);
    _sizerScrolledWindow->Add(_choiceMethod, 0, wxEXPAND | wxBOTTOM, 5);

    _staticTextChoiceForecast = new wxStaticText(_scrolledWindowOptions, wxID_ANY, _("Configuration"),
                                                 wxDefaultPosition, wxDefaultSize, 0);
    _staticTextChoiceForecast->Wrap(-1);
    _sizerScrolledWindow->Add(_staticTextChoiceForecast, 0, wxTOP | wxRIGHT | wxLEFT, 5);

    wxArrayString _choiceForecastChoices;
    _choiceForecast = new wxChoice(_scrolledWindowOptions, wxID_ANY, wxDefaultPosition, wxSize(220, -1),
                                   _choiceForecastChoices, 0);
    _choiceForecast->SetSelection(0);
    _sizerScrolledWindow->Add(_choiceForecast, 0, wxEXPAND | wxBOTTOM, 5);

    _staticTextCheckListPredictors = new wxStaticText(_scrolledWindowOptions, wxID_ANY, _("Possible predictors"),
                                                      wxDefaultPosition, wxDefaultSize, 0);
    ...
    _staticTextTocLeft = new wxStaticText(_scrolledWindowOptions, wxID_ANY, _("Layers of the left panel"),
                                          wxDefaultPosition, wxDefaultSize, 0);
    _staticTextTocLeft->Wrap(-1);
    _sizerScrolledWindow->Add(_staticTextTocLeft, 0, wxTOP | wxRIGHT | wxLEFT, 5);

    _staticTextTocRight = new wxStaticText(_scrolledWindowOptions, wxID_ANY, _("Layers of the right panel"),
                                           wxDefaultPosition, wxDefaultSize, 0);
    ...
    _choiceTargetDates = new wxChoice(_panelLeft, wxID_ANY, wxDefaultPosition, wxDefaultSize, _choiceTargetDatesChoices,
                                      0);
    ...
    _panelGISLeft = new wxPanel(_panelLeft, wxID_ANY, wxDefaultPosition, wxDefaultSize,
    ...
    _bpButtonSwitchRight = new wxBitmapButton(_panelSwitch, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize(10, 28),
                                              wxBU_AUTODRAW | 0 | wxBORDER_NONE);
    _sizerSwitch->Add(_bpButtonSwitchRight, 0, wxALIGN_CENTER_VERTICAL | wxALIGN_CENTER_HORIZONTAL | wxRIGHT | wxLEFT,
                      1);

    _bpButtonSwitchLeft = new wxBitmapButton(_panelSwitch, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize(10, 28),
                                             wxBU_AUTODRAW | 0 | wxBORDER_NONE);
    ...
    _choiceAnalogDates = new wxChoice(_panelRight, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                      _choiceAnalogDatesChoices, 0);
    ...
    _panelGISRight = new wxPanel(_panelRight, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                 wxTAB_TRAVERSAL | wxBORDER_SIMPLE);
    ...
    _menuFile = new wxMenu();
    wxMenuItem* _menuItemOpenGisLayer;
    _menuItemOpenGisLayer = new wxMenuItem(_menuFile, wxID_ANY, wxString(_("Open GIS layer")), wxEmptyString,
                                           wxITEM_NORMAL);
    _menuFile->Append(_menuItemOpenGisLayer);
    ...
    // Connect Events
    _choiceMethod->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                           wxCommandEventHandler(asFramePredictorsVirtual::OnMethodChange), NULL, this);
    _choiceForecast->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                             wxCommandEventHandler(asFramePredictorsVirtual::OnForecastChange), NULL, this);
    _listPredictors->Connect(wxEVT_COMMAND_LISTBOX_SELECTED,
                             wxCommandEventHandler(asFramePredictorsVirtual::OnPredictorSelectionChange), NULL, this);
    _choiceTargetDates->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                                wxCommandEventHandler(asFramePredictorsVirtual::OnTargetDateChange), NULL, this);
    _bpButtonSwitchRight->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                  wxCommandEventHandler(asFramePredictorsVirtual::OnSwitchRight), NULL, this);
    _bpButtonSwitchLeft->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                 wxCommandEventHandler(asFramePredictorsVirtual::OnSwitchLeft), NULL, this);
    _choiceAnalogDates->Connect(wxEVT_COMMAND_CHOICE_SELECTED,
                                wxCommandEventHandler(asFramePredictorsVirtual::OnAnalogDateChange), NULL, this);
    _menuFile->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFramePredictorsVirtual::OnOpenLayer), this,
                    _menuItemOpenGisLayer->GetId());
}

asFramePredictorsVirtual::~asFramePredictorsVirtual() {
    // Disconnect Events
    _choiceMethod->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                              wxCommandEventHandler(asFramePredictorsVirtual::OnMethodChange), NULL, this);
    _choiceForecast->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                                wxCommandEventHandler(asFramePredictorsVirtual::OnForecastChange), NULL, this);
    _listPredictors->Disconnect(wxEVT_COMMAND_LISTBOX_SELECTED,
                                wxCommandEventHandler(asFramePredictorsVirtual::OnPredictorSelectionChange), NULL,
                                this);
    _choiceTargetDates->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                                   wxCommandEventHandler(asFramePredictorsVirtual::OnTargetDateChange), NULL, this);
    _bpButtonSwitchRight->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                     wxCommandEventHandler(asFramePredictorsVirtual::OnSwitchRight), NULL, this);
    _bpButtonSwitchLeft->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                    wxCommandEventHandler(asFramePredictorsVirtual::OnSwitchLeft), NULL, this);
    _choiceAnalogDates->Disconnect(wxEVT_COMMAND_CHOICE_SELECTED,
                                   wxCommandEventHandler(asFramePredictorsVirtual::OnAnalogDateChange), NULL, this);
}

asFramePreferencesViewerVirtual::asFramePreferencesViewerVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
                                                                 const wxPoint& pos, const wxSize& size, long style)
    : wxFrame(parent, id, title, pos, size, style) {
    ...
    _staticTextForecastResultsDir = new wxStaticText(_panelWorkspace, wxID_ANY, _("Directory containing the forecasts"),
                                                     wxDefaultPosition, wxDefaultSize, 0);
    _staticTextForecastResultsDir->Wrap(-1);
    bSizer55->Add(_staticTextForecastResultsDir, 0, wxTOP | wxRIGHT | wxLEFT, 5);

    _dirPickerForecastResults = new wxDirPickerCtrl(_panelWorkspace, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                    wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL);
    ...
    _staticTextColorbarMaxValue = new wxStaticText(_panelWorkspace, wxID_ANY,
                                                   _("Set the maximum rainfall value for the colorbar"),
                                                   wxDefaultPosition, wxDefaultSize, 0);
    _staticTextColorbarMaxValue->Wrap(-1);
    fgSizer81->Add(_staticTextColorbarMaxValue, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _textCtrlColorbarMaxValue = new wxTextCtrl(_panelWorkspace, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                               wxSize(40, -1), 0);
    fgSizer81->Add(_textCtrlColorbarMaxValue, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _staticTextColorbarMaxUnit = new wxStaticText(_panelWorkspace, wxID_ANY, _("mm/d"), wxDefaultPosition,
                                                  wxDefaultSize, 0);
    _staticTextColorbarMaxUnit->Wrap(-1);
    fgSizer81->Add(_staticTextColorbarMaxUnit, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _staticTextPastDaysNb = new wxStaticText(_panelWorkspace, wxID_ANY,
                                             _("Number of past days to display on the timeseries"), wxDefaultPosition,
                                             wxDefaultSize, 0);
    _staticTextPastDaysNb->Wrap(-1);
    fgSizer81->Add(_staticTextPastDaysNb, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _textCtrlPastDaysNb = new wxTextCtrl(_panelWorkspace, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(40, -1),
                                         0);
    ...
    _staticTextAlarmsReturnPeriod = new wxStaticText(
        sbSizer191->GetStaticBox(), wxID_ANY, _("Return period to display"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    _choiceAlarmsReturnPeriod = new wxChoice(sbSizer191->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                             _choiceAlarmsReturnPeriodNChoices, _choiceAlarmsReturnPeriodChoices, 0);
    _choiceAlarmsReturnPeriod->SetSelection(0);
    fgSizer13->Add(_choiceAlarmsReturnPeriod, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _staticTextAlarmsReturnPeriodYears = new wxStaticText(sbSizer191->GetStaticBox(), wxID_ANY, _("years"),
                                                          wxDefaultPosition, wxDefaultSize, 0);
    ...
    _staticTextAlarmsQuantile = new wxStaticText(sbSizer191->GetStaticBox(), wxID_ANY, _("Quantile to display"),
                                                 wxDefaultPosition, wxDefaultSize, 0);
    _staticTextAlarmsQuantile->Wrap(-1);
    fgSizer13->Add(_staticTextAlarmsQuantile, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _textCtrlAlarmsQuantile = new wxTextCtrl(sbSizer191->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                             wxSize(40, -1), 0);
    fgSizer13->Add(_textCtrlAlarmsQuantile, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _staticTextAlarmsQuantileRange = new wxStaticText(sbSizer191->GetStaticBox(), wxID_ANY, _("(in between 0 - 1)"),
                                                      wxDefaultPosition, wxDefaultSize, 0);
    ...
    sbSizer8 = new wxStaticBoxSizer(
        new wxStaticBox(_panelWorkspace, wxID_ANY, _("Maximum length of time series to display")), wxVERTICAL);

    _staticText581 = new wxStaticText(sbSizer8->GetStaticBox(), wxID_ANY,
                                      _("Requires a restart or opening new forecasts."), wxDefaultPosition,
                                      wxDefaultSize, 0);
    ...
    _staticText541 = new wxStaticText(sbSizer8->GetStaticBox(), wxID_ANY, _("Daily forecasts"), wxDefaultPosition,
                                      wxDefaultSize, 0);
    _staticText541->Wrap(-1);
    fgSizer8->Add(_staticText541, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _textCtrlMaxLengthDaily = new wxTextCtrl(sbSizer8->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                             wxSize(50, -1), 0);
    fgSizer8->Add(_textCtrlMaxLengthDaily, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _staticText56 = new wxStaticText(sbSizer8->GetStaticBox(), wxID_ANY, _("days"), wxDefaultPosition, wxDefaultSize,
                                     0);
    _staticText56->Wrap(-1);
    fgSizer8->Add(_staticText56, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _staticText55 = new wxStaticText(sbSizer8->GetStaticBox(), wxID_ANY, _("Sub-daily forecasts"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    _staticText55->Wrap(-1);
    fgSizer8->Add(_staticText55, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _textCtrlMaxLengthSubDaily = new wxTextCtrl(sbSizer8->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                wxSize(50, -1), 0);
    fgSizer8->Add(_textCtrlMaxLengthSubDaily, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _staticText571 = new wxStaticText(sbSizer8->GetStaticBox(), wxID_ANY, _("hours"), wxDefaultPosition, wxDefaultSize,
                                      0);
    ...
    sbSizer5 = new wxStaticBoxSizer(new wxStaticBox(_panelPaths, wxID_ANY, _("Path to the predictor datasets")),
                                    wxVERTICAL);
    ...
    _staticPredictorID = new wxStaticText(sbSizer5->GetStaticBox(), wxID_ANY, _("Dataset ID"), wxDefaultPosition,
                                          wxDefaultSize, 0);
    _staticPredictorID->Wrap(-1);
    fgSizer6->Add(_staticPredictorID, 0, wxALL, 5);

    _staticPredictorPaths = new wxStaticText(sbSizer5->GetStaticBox(), wxID_ANY, _("Path to the directory"),
                                             wxDefaultPosition, wxDefaultSize, 0);
    _staticPredictorPaths->Wrap(-1);
    fgSizer6->Add(_staticPredictorPaths, 0, wxALL, 5);

    _textCtrlDatasetId1 = new wxTextCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                         wxSize(150, -1), 0);
    fgSizer6->Add(_textCtrlDatasetId1, 1, wxALL | wxEXPAND, 5);

    _dirPickerDataset1 = new wxDirPickerCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a folder"),
                                             wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE);
    fgSizer6->Add(_dirPickerDataset1, 0, wxALL | wxEXPAND, 5);

    _textCtrlDatasetId2 = new wxTextCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                         wxSize(150, -1), 0);
    fgSizer6->Add(_textCtrlDatasetId2, 0, wxALL, 5);

    _dirPickerDataset2 = new wxDirPickerCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a folder"),
                                             wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE);
    fgSizer6->Add(_dirPickerDataset2, 0, wxALL | wxEXPAND, 5);

    _textCtrlDatasetId3 = new wxTextCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                         wxSize(150, -1), 0);
    fgSizer6->Add(_textCtrlDatasetId3, 0, wxALL, 5);

    _dirPickerDataset3 = new wxDirPickerCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a folder"),
                                             wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE);
    fgSizer6->Add(_dirPickerDataset3, 0, wxALL | wxEXPAND, 5);

    _textCtrlDatasetId4 = new wxTextCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                         wxSize(150, -1), 0);
    fgSizer6->Add(_textCtrlDatasetId4, 0, wxALL, 5);

    _dirPickerDataset4 = new wxDirPickerCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a folder"),
                                             wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE);
    fgSizer6->Add(_dirPickerDataset4, 0, wxALL | wxEXPAND, 5);

    _textCtrlDatasetId5 = new wxTextCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                         wxSize(150, -1), 0);
    fgSizer6->Add(_textCtrlDatasetId5, 0, wxALL, 5);

    _dirPickerDataset5 = new wxDirPickerCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a folder"),
                                             wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE);
    fgSizer6->Add(_dirPickerDataset5, 0, wxALL | wxEXPAND, 5);

    _textCtrlDatasetId6 = new wxTextCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                         wxSize(150, -1), 0);
    fgSizer6->Add(_textCtrlDatasetId6, 0, wxALL, 5);

    _dirPickerDataset6 = new wxDirPickerCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a folder"),
                                             wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE);
    fgSizer6->Add(_dirPickerDataset6, 0, wxALL | wxEXPAND, 5);

    _textCtrlDatasetId7 = new wxTextCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                         wxSize(150, -1), 0);
    fgSizer6->Add(_textCtrlDatasetId7, 0, wxALL, 5);

    _dirPickerDataset7 = new wxDirPickerCtrl(sbSizer5->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a folder"),
                                             wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE);
    ...
    sbSizer51 = new wxStaticBoxSizer(new wxStaticBox(_panelColors, wxID_ANY, _("Paths to the color tables")),
                                     wxVERTICAL);
    ...
    _staticText54 = new wxStaticText(sbSizer51->GetStaticBox(), wxID_ANY, _("Geopotential height"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    _staticText54->Wrap(-1);
    fgSizer61->Add(_staticText54, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _filePickerColorZ = new wxFilePickerCtrl(sbSizer51->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a file"),
                                             _("*.*"), wxDefaultPosition, wxDefaultSize, wxFLP_DEFAULT_STYLE);
    fgSizer61->Add(_filePickerColorZ, 0, wxALL | wxEXPAND, 5);

    RelativeHumidity = new wxStaticText(sbSizer51->GetStaticBox(), wxID_ANY, _("Precipitable water"), wxDefaultPosition,
                                        wxDefaultSize, 0);
    RelativeHumidity->Wrap(-1);
    fgSizer61->Add(RelativeHumidity, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _filePickerColorPwat = new wxFilePickerCtrl(sbSizer51->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a file"),
                                                _("*.*"), wxDefaultPosition, wxDefaultSize, wxFLP_DEFAULT_STYLE);
    fgSizer61->Add(_filePickerColorPwat, 0, wxALL | wxEXPAND, 5);

    _staticText57 = new wxStaticText(sbSizer51->GetStaticBox(), wxID_ANY, _("Relative humidity"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    _staticText57->Wrap(-1);
    fgSizer61->Add(_staticText57, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _filePickerColorRh = new wxFilePickerCtrl(sbSizer51->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a file"),
                                              _("*.*"), wxDefaultPosition, wxDefaultSize, wxFLP_DEFAULT_STYLE);
    fgSizer61->Add(_filePickerColorRh, 0, wxALL | wxEXPAND, 5);

    _staticText58 = new wxStaticText(sbSizer51->GetStaticBox(), wxID_ANY, _("Specific humidity"), wxDefaultPosition,
                                     wxDefaultSize, 0);
    _staticText58->Wrap(-1);
    fgSizer61->Add(_staticText58, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _filePickerColorSh = new wxFilePickerCtrl(sbSizer51->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a file"),
                                              _("*.*"), wxDefaultPosition, wxDefaultSize, wxFLP_DEFAULT_STYLE);
    ...
    _choiceLocale = new wxChoice(sbSizer71->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                 _choiceLocaleNChoices, _choiceLocaleChoices, 0);
    _choiceLocale->SetSelection(0);
    sbSizer71->Add(_choiceLocale, 0, wxALL, 5);

    _staticText53 = new wxStaticText(sbSizer71->GetStaticBox(), wxID_ANY,
    ...
    sbSizer14 = new wxStaticBoxSizer(new wxStaticBox(_panelGeneralCommon, wxID_ANY, _("Proxy configuration")),
                                     wxVERTICAL);

    _checkBoxProxy = new wxCheckBox(sbSizer14->GetStaticBox(), wxID_ANY, _("Internet connection uses a proxy"),
                                    wxDefaultPosition, wxDefaultSize, 0);
    ...
    _staticTextProxyAddress = new wxStaticText(sbSizer14->GetStaticBox(), wxID_ANY, _("Proxy address"),
                                               wxDefaultPosition, wxDefaultSize, 0);
    _staticTextProxyAddress->Wrap(-1);
    bSizer34->Add(_staticTextProxyAddress, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _textCtrlProxyAddress = new wxTextCtrl(sbSizer14->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                           wxSize(180, -1), 0);
    bSizer34->Add(_textCtrlProxyAddress, 1, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _staticTextProxyPort = new wxStaticText(sbSizer14->GetStaticBox(), wxID_ANY, _("Port"), wxDefaultPosition,
                                            wxDefaultSize, 0);
    _staticTextProxyPort->Wrap(-1);
    bSizer34->Add(_staticTextProxyPort, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _textCtrlProxyPort = new wxTextCtrl(sbSizer14->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                        wxDefaultSize, 0);
    ...
    _staticTextProxyUser = new wxStaticText(sbSizer14->GetStaticBox(), wxID_ANY, _("Username"), wxDefaultPosition,
                                            wxDefaultSize, 0);
    _staticTextProxyUser->Wrap(-1);
    bSizer35->Add(_staticTextProxyUser, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _textCtrlProxyUser = new wxTextCtrl(sbSizer14->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                        wxSize(-1, -1), 0);
    bSizer35->Add(_textCtrlProxyUser, 1, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _staticTextProxyPasswd = new wxStaticText(sbSizer14->GetStaticBox(), wxID_ANY, _("Password"), wxDefaultPosition,
                                              wxDefaultSize, 0);
    _staticTextProxyPasswd->Wrap(-1);
    bSizer35->Add(_staticTextProxyPasswd, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    _textCtrlProxyPasswd = new wxTextCtrl(sbSizer14->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
    ...
    _checkBoxMultiInstancesViewer = new wxCheckBox(
        _panelAdvanced, wxID_ANY, _("Allow multiple instances of the viewer"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    _staticTextLogFileLabel = new wxStaticText(sbSizer17->GetStaticBox(), wxID_ANY, _("Log file:"), wxDefaultPosition,
                                               wxDefaultSize, 0);
    ...
    // Connect Events
    _buttonsConfirmationApply->Connect(
        wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFramePreferencesViewerVirtual::ApplyChanges), NULL, this);
    _buttonsConfirmationCancel->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                        wxCommandEventHandler(asFramePreferencesViewerVirtual::CloseFrame), NULL, this);
    _buttonsConfirmationOK->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                    wxCommandEventHandler(asFramePreferencesViewerVirtual::SaveAndClose), NULL, this);
}

asFramePreferencesViewerVirtual::~asFramePreferencesViewerVirtual() {
    // Disconnect Events
    _buttonsConfirmationApply->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFramePreferencesViewerVirtual::ApplyChanges), NULL, this);
    _buttonsConfirmationCancel->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFramePreferencesViewerVirtual::CloseFrame), NULL, this);
    _buttonsConfirmationOK->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFramePreferencesViewerVirtual::SaveAndClose), NULL, this);
}
