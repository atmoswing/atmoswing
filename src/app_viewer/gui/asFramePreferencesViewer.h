...
/**
@file
Subclass of asFramePreferencesViewerVirtual, which is generated by wxFormBuilder.
*/

#include "AtmoswingViewerGui.h"
#include <asIncludes.h>

/** Implementing asFramePreferencesViewerVirtual */
class asFramePreferencesViewer : public asFramePreferencesViewerVirtual
{
public:
    /** Constructor */
    asFramePreferencesViewer( wxWindow* parent, wxWindowID id = asWINDOW_PREFERENCES );
    //// end generated class members

protected:
    // Handlers for asFramePreferencesViewerVirtual events.
