...
asFrameOptimizerVirtual::asFrameOptimizerVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    _staticTextMethod = new wxStaticText(_panelControls, wxID_ANY, _("Select the calibration method"),
                                         wxDefaultPosition, wxDefaultSize, 0);
    _staticTextMethod->Wrap(-1);
    bSizer5->Add(_staticTextMethod, 0, wxALL, 5);

    wxString _choiceMethodChoices[] = {_("Single assessment"),
    ...
    _staticTextFileParameters = new wxStaticText(_panelControls, wxID_ANY,
                                                 _("Select the parameters file for the calibration"), wxDefaultPosition,
                                                 wxDefaultSize, 0);
    ...
    _staticTextPredictorDir = new wxStaticText(_panelControls, wxID_ANY, _("Select the predictors directory"),
                                               wxDefaultPosition, wxDefaultSize, 0);
    _staticTextPredictorDir->Wrap(-1);
    bSizer5->Add(_staticTextPredictorDir, 0, wxALL, 5);

    _dirPickerPredictor = new wxDirPickerCtrl(_panelControls, wxID_ANY, wxEmptyString, _("Select a folder"),
                                              wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE);
    bSizer5->Add(_dirPickerPredictor, 0, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 5);

    _staticTextCalibrationResultsDir = new wxStaticText(
        _panelControls, wxID_ANY, _("Directory to save calibration outputs"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextCalibrationResultsDir->Wrap(-1);
    bSizer5->Add(_staticTextCalibrationResultsDir, 0, wxALL, 5);

    _dirPickerCalibrationResults = new wxDirPickerCtrl(_panelControls, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                       wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE);
    ...
    _staticTextStateLabel = new wxStaticText(_panelControls, wxID_ANY, _("Calibration state: "), wxDefaultPosition,
                                             wxDefaultSize, 0);
    ...
    _staticTextClassicPlusStepsLonPertinenceMap = new wxStaticText(sbSizer10->GetStaticBox(), wxID_ANY,
                                                                   _("Multiple of the steps in lon for pertinence map"),
                                                                   wxDefaultPosition, wxDefaultSize, 0);
    _staticTextClassicPlusStepsLonPertinenceMap->Wrap(-1);
    fgSizer21->Add(_staticTextClassicPlusStepsLonPertinenceMap, 0, wxALL, 5);

    _textCtrlClassicPlusStepsLonPertinenceMap = new wxTextCtrl(sbSizer10->GetStaticBox(), wxID_ANY, wxEmptyString,
                                                               wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer21->Add(_textCtrlClassicPlusStepsLonPertinenceMap, 0, wxRIGHT | wxLEFT, 5);

    _staticTextClassicPlusStepsLatPertinenceMap = new wxStaticText(sbSizer10->GetStaticBox(), wxID_ANY,
                                                                   _("Multiple of the steps in lat for pertinence map"),
                                                                   wxDefaultPosition, wxDefaultSize, 0);
    _staticTextClassicPlusStepsLatPertinenceMap->Wrap(-1);
    fgSizer21->Add(_staticTextClassicPlusStepsLatPertinenceMap, 0, wxALL, 5);

    _textCtrlClassicPlusStepsLatPertinenceMap = new wxTextCtrl(sbSizer10->GetStaticBox(), wxID_ANY, wxEmptyString,
                                                               wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer21->Add(_textCtrlClassicPlusStepsLatPertinenceMap, 0, wxRIGHT | wxLEFT, 5);

    _staticTextClassicPlusResizingIterations = new wxStaticText(sbSizer10->GetStaticBox(), wxID_ANY,
                                                                _("Iterations in final resizing attempts"),
                                                                wxDefaultPosition, wxDefaultSize, 0);
    _staticTextClassicPlusResizingIterations->Wrap(-1);
    fgSizer21->Add(_staticTextClassicPlusResizingIterations, 0, wxALL, 5);

    _textCtrlClassicPlusResizingIterations = new wxTextCtrl(sbSizer10->GetStaticBox(), wxID_ANY, wxEmptyString,
                                                            wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer21->Add(_textCtrlClassicPlusResizingIterations, 0, wxRIGHT | wxLEFT, 5);

    _checkBoxProceedSequentially = new wxCheckBox(
    ...
    _staticTextSpacer = new wxStaticText(sbSizer10->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                         wxDefaultSize, 0);
    _staticTextSpacer->Wrap(-1);
    fgSizer21->Add(_staticTextSpacer, 0, wxALL, 5);

    _checkBoxClassicPlusResize = new wxCheckBox(sbSizer10->GetStaticBox(), wxID_ANY,
                                                _("Resize the spatial windows separately"), wxDefaultPosition,
                                                wxDefaultSize, 0);
    ...
    _staticTextMonteCarloRandomNb = new wxStaticText(
    ...
    _textCtrlMonteCarloRandomNb = new wxTextCtrl(sbSizer12->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                 wxSize(50, -1), 0);
    ...
    _staticTextVarExploStepToExplore = new wxStaticText(
    ...
    _textCtrlVarExploStepToExplore = new wxTextCtrl(sbSizer91->GetStaticBox(), wxID_ANY, wxEmptyString,
                                                    wxDefaultPosition, wxSize(50, -1), 0);
    ...
    _staticTextGAsNaturalSelectionOperator = new wxStaticText(
    ...
    int _choiceGAsNaturalSelectionOperatorNChoices = sizeof(_choiceGAsNaturalSelectionOperatorChoices) /
                                                     sizeof(wxString);
    _choiceGAsNaturalSelectionOperator = new wxChoice(sbSizer5->GetStaticBox(), wxID_ANY, wxDefaultPosition,
                                                      wxDefaultSize, _choiceGAsNaturalSelectionOperatorNChoices,
                                                      _choiceGAsNaturalSelectionOperatorChoices, 0);
    _choiceGAsNaturalSelectionOperator->SetSelection(0);
    fgSizer11->Add(_choiceGAsNaturalSelectionOperator, 0, wxALL | wxEXPAND, 5);

    _staticTextGAsCouplesSelectionOperator = new wxStaticText(
    ...
    wxString _choiceGAsCouplesSelectionOperatorChoices[] = {
        _("Rank pairing"), _("Randomly"), _("Roulette wheel on rank"), _("Roulette wheel on score"), _("Tournament")};
    int _choiceGAsCouplesSelectionOperatorNChoices = sizeof(_choiceGAsCouplesSelectionOperatorChoices) /
                                                     sizeof(wxString);
    _choiceGAsCouplesSelectionOperator = new wxChoice(sbSizer5->GetStaticBox(), wxID_ANY, wxDefaultPosition,
                                                      wxDefaultSize, _choiceGAsCouplesSelectionOperatorNChoices,
                                                      _choiceGAsCouplesSelectionOperatorChoices, 0);
    _choiceGAsCouplesSelectionOperator->SetSelection(0);
    fgSizer11->Add(_choiceGAsCouplesSelectionOperator, 0, wxALL | wxEXPAND, 5);

    _staticTextGAsCrossoverOperator = new wxStaticText(sbSizer5->GetStaticBox(), wxID_ANY, _("Crossover"),
                                                       wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsCrossoverOperator->Wrap(-1);
    fgSizer11->Add(_staticTextGAsCrossoverOperator, 0, wxALL, 5);

    wxString _choiceGAsCrossoverOperatorChoices[] = {_("Single point crossover"),    _("Double points crossover"),
    ...
    _choiceGAsCrossoverOperator = new wxChoice(sbSizer5->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                               _choiceGAsCrossoverOperatorNChoices, _choiceGAsCrossoverOperatorChoices,
                                               0);
    _choiceGAsCrossoverOperator->SetSelection(0);
    fgSizer11->Add(_choiceGAsCrossoverOperator, 0, wxALL | wxEXPAND, 5);

    _staticTextGAsMutationOperator = new wxStaticText(sbSizer5->GetStaticBox(), wxID_ANY, _("Mutation"),
                                                      wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationOperator->Wrap(-1);
    fgSizer11->Add(_staticTextGAsMutationOperator, 0, wxALL, 5);

    wxString _choiceGAsMutationOperatorChoices[] = {_("Uniform constant"),
                                                    _("Uniform variable"),
                                                    _("Normal constant"),
                                                    _("Normal variable"),
                                                    _("Non-uniform"),
    ...
    _choiceGAsMutationOperator = new wxChoice(sbSizer5->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                              _choiceGAsMutationOperatorNChoices, _choiceGAsMutationOperatorChoices, 0);
    ...
    sbSizer6 = new wxStaticBoxSizer(new wxStaticBox(_panelGeneticAlgoritms, wxID_ANY, _("General options")),
                                    wxVERTICAL);
    ...
    _staticTextGAsRunNumbers = new wxStaticText(sbSizer6->GetStaticBox(), wxID_ANY, _("Runs number"), wxDefaultPosition,
                                                wxDefaultSize, 0);
    _staticTextGAsRunNumbers->Wrap(-1);
    fgSizer121->Add(_staticTextGAsRunNumbers, 0, wxALL, 5);

    _textCtrlGAsRunNumbers = new wxTextCtrl(sbSizer6->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                            wxSize(50, -1), 0);
    fgSizer121->Add(_textCtrlGAsRunNumbers, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsPopulationSize = new wxStaticText(sbSizer6->GetStaticBox(), wxID_ANY, _("Population's size"),
                                                    wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsPopulationSize->Wrap(-1);
    fgSizer121->Add(_staticTextGAsPopulationSize, 0, wxALL, 5);

    _textCtrlGAsPopulationSize = new wxTextCtrl(sbSizer6->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                wxSize(50, -1), 0);
    fgSizer121->Add(_textCtrlGAsPopulationSize, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsConvergenceNb = new wxStaticText(sbSizer6->GetStaticBox(), wxID_ANY, _("Convergence after"),
                                                   wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsConvergenceNb->Wrap(-1);
    fgSizer121->Add(_staticTextGAsConvergenceNb, 0, wxALL, 5);

    _textCtrlGAsConvergenceNb = new wxTextCtrl(sbSizer6->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                               wxSize(50, -1), 0);
    fgSizer121->Add(_textCtrlGAsConvergenceNb, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsRatioIntermGen = new wxStaticText(sbSizer6->GetStaticBox(), wxID_ANY, _("Ratio interm. gen."),
                                                    wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsRatioIntermGen->Wrap(-1);
    fgSizer121->Add(_staticTextGAsRatioIntermGen, 0, wxALL, 5);

    _textCtrlGAsRatioIntermGen = new wxTextCtrl(sbSizer6->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                wxSize(50, -1), 0);
    fgSizer121->Add(_textCtrlGAsRatioIntermGen, 0, wxRIGHT | wxLEFT, 5);

    sbSizer6->Add(fgSizer121, 0, wxEXPAND, 5);

    _checkBoxGAsAllowElitism = new wxCheckBox(sbSizer6->GetStaticBox(), wxID_ANY, _("Allow elitism for the best"),
                                              wxDefaultPosition, wxDefaultSize, 0);
    ...
    _staticTextGAsNaturalSlctTournamentProb = new wxStaticText(
        _panelSelections, wxID_ANY, _("Natural slct tournament: prob"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsNaturalSlctTournamentProb->Wrap(-1);
    fgSizer141->Add(_staticTextGAsNaturalSlctTournamentProb, 0, wxALL, 5);

    _textCtrlGAsNaturalSlctTournamentProb = new wxTextCtrl(_panelSelections, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                           wxSize(50, -1), 0);
    ...
    _staticTextGAsCouplesSlctTournamentNb = new wxStaticText(
        _panelSelections, wxID_ANY, _("Couples slct tournament: nb ind."), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsCouplesSlctTournamentNb->Wrap(-1);
    fgSizer151->Add(_staticTextGAsCouplesSlctTournamentNb, 0, wxALL, 5);

    _textCtrlGAsCouplesSlctTournamentNb = new wxTextCtrl(_panelSelections, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                         wxSize(50, -1), 0);
    ...
    _staticTextGAsCrossoverMultipleNbPts = new wxStaticText(
        _panelCrossover, wxID_ANY, _("Multiple crossover: nb points"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsCrossoverMultipleNbPts->Wrap(-1);
    fgSizer14->Add(_staticTextGAsCrossoverMultipleNbPts, 0, wxALL, 5);

    _textCtrlGAsCrossoverMultipleNbPts = new wxTextCtrl(_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                        wxSize(50, -1), 0);
    fgSizer14->Add(_textCtrlGAsCrossoverMultipleNbPts, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsCrossoverBlendingNbPts = new wxStaticText(
        _panelCrossover, wxID_ANY, _("Blending crossover: nb points"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsCrossoverBlendingNbPts->Wrap(-1);
    fgSizer14->Add(_staticTextGAsCrossoverBlendingNbPts, 0, wxALL, 5);

    _textCtrlGAsCrossoverBlendingNbPts = new wxTextCtrl(_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                        wxSize(50, -1), 0);
    fgSizer14->Add(_textCtrlGAsCrossoverBlendingNbPts, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsCrossoverBlendingShareBeta = new wxStaticText(
        _panelCrossover, wxID_ANY, _("Blending crossover: share beta"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsCrossoverBlendingShareBeta->Wrap(-1);
    fgSizer14->Add(_staticTextGAsCrossoverBlendingShareBeta, 0, wxALL, 5);

    _checkBoxGAsCrossoverBlendingShareBeta = new wxCheckBox(_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                            wxDefaultSize, 0);
    fgSizer14->Add(_checkBoxGAsCrossoverBlendingShareBeta, 0, wxALL, 5);

    _staticTextGAsCrossoverLinearNbPts = new wxStaticText(_panelCrossover, wxID_ANY, _("Linear crossover: nb points"),
                                                          wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsCrossoverLinearNbPts->Wrap(-1);
    fgSizer14->Add(_staticTextGAsCrossoverLinearNbPts, 0, wxALL, 5);

    _textCtrlGAsCrossoverLinearNbPts = new wxTextCtrl(_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                      wxSize(50, -1), 0);
    ...
    _staticTextGAsCrossoverHeuristicNbPts = new wxStaticText(
        _panelCrossover, wxID_ANY, _("Heuristic crossover: nb points"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsCrossoverHeuristicNbPts->Wrap(-1);
    fgSizer15->Add(_staticTextGAsCrossoverHeuristicNbPts, 0, wxALL, 5);

    _textCtrlGAsCrossoverHeuristicNbPts = new wxTextCtrl(_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                         wxSize(50, -1), 0);
    fgSizer15->Add(_textCtrlGAsCrossoverHeuristicNbPts, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsCrossoverHeuristicShareBeta = new wxStaticText(
        _panelCrossover, wxID_ANY, _("Heuristic crossover: share beta"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsCrossoverHeuristicShareBeta->Wrap(-1);
    fgSizer15->Add(_staticTextGAsCrossoverHeuristicShareBeta, 0, wxALL, 5);

    _checkBoxGAsCrossoverHeuristicShareBeta = new wxCheckBox(_panelCrossover, wxID_ANY, wxEmptyString,
                                                             wxDefaultPosition, wxDefaultSize, 0);
    fgSizer15->Add(_checkBoxGAsCrossoverHeuristicShareBeta, 0, wxALL, 5);

    _staticTextGAsCrossoverBinLikeNbPts = new wxStaticText(
        _panelCrossover, wxID_ANY, _("Binary-like crossover: nb points"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsCrossoverBinLikeNbPts->Wrap(-1);
    fgSizer15->Add(_staticTextGAsCrossoverBinLikeNbPts, 0, wxALL, 5);

    _textCtrlGAsCrossoverBinLikeNbPts = new wxTextCtrl(_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                       wxSize(50, -1), 0);
    fgSizer15->Add(_textCtrlGAsCrossoverBinLikeNbPts, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsCrossoverBinLikeShareBeta = new wxStaticText(
        _panelCrossover, wxID_ANY, _("Binary-like crossover: share beta"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsCrossoverBinLikeShareBeta->Wrap(-1);
    fgSizer15->Add(_staticTextGAsCrossoverBinLikeShareBeta, 0, wxALL, 5);

    _checkBoxGAsCrossoverBinLikeShareBeta = new wxCheckBox(_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                           wxDefaultSize, 0);
    ...
    _staticTextGAsMutationsUniformCstProb = new wxStaticText(
        _panelMutation, wxID_ANY, _("Uniform constant: probability"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsUniformCstProb->Wrap(-1);
    fgSizer13->Add(_staticTextGAsMutationsUniformCstProb, 0, wxALL, 5);

    _textCtrlGAsMutationsUniformCstProb = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                         wxSize(50, -1), 0);
    fgSizer13->Add(_textCtrlGAsMutationsUniformCstProb, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsNormalCstProb = new wxStaticText(_panelMutation, wxID_ANY, _("Normal constant: probability"),
                                                            wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsNormalCstProb->Wrap(-1);
    fgSizer13->Add(_staticTextGAsMutationsNormalCstProb, 0, wxALL, 5);

    _textCtrlGAsMutationsNormalCstProb = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                        wxSize(50, -1), 0);
    fgSizer13->Add(_textCtrlGAsMutationsNormalCstProb, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsNormalCstStdDev = new wxStaticText(_panelMutation, wxID_ANY, _("Normal constant: std dev"),
                                                              wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsNormalCstStdDev->Wrap(-1);
    fgSizer13->Add(_staticTextGAsMutationsNormalCstStdDev, 0, wxALL, 5);

    _textCtrlGAsMutationsNormalCstStdDev = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                          wxSize(50, -1), 0);
    fgSizer13->Add(_textCtrlGAsMutationsNormalCstStdDev, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsUniformVarMaxGensNb = new wxStaticText(
        _panelMutation, wxID_ANY, _("Uniform variable: on # generations"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsUniformVarMaxGensNb->Wrap(-1);
    fgSizer13->Add(_staticTextGAsMutationsUniformVarMaxGensNb, 0, wxALL, 5);

    _textCtrlGAsMutationsUniformVarMaxGensNb = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString,
                                                              wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer13->Add(_textCtrlGAsMutationsUniformVarMaxGensNb, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsUniformVarProbStart = new wxStaticText(
        _panelMutation, wxID_ANY, _("Uniform variable: starting probability"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsUniformVarProbStart->Wrap(-1);
    fgSizer13->Add(_staticTextGAsMutationsUniformVarProbStart, 0, wxALL, 5);

    _textCtrlGAsMutationsUniformVarProbStart = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString,
                                                              wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer13->Add(_textCtrlGAsMutationsUniformVarProbStart, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsUniformVarProbEnd = new wxStaticText(
        _panelMutation, wxID_ANY, _("Uniform variable: ending probability"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsUniformVarProbEnd->Wrap(-1);
    fgSizer13->Add(_staticTextGAsMutationsUniformVarProbEnd, 0, wxALL, 5);

    _textCtrlGAsMutationsUniformVarProbEnd = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                            wxSize(50, -1), 0);
    fgSizer13->Add(_textCtrlGAsMutationsUniformVarProbEnd, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsMultiScaleProb = new wxStaticText(_panelMutation, wxID_ANY, _("Multi-scale: probability"),
                                                             wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsMultiScaleProb->Wrap(-1);
    fgSizer13->Add(_staticTextGAsMutationsMultiScaleProb, 0, wxALL, 5);

    _textCtrlGAsMutationsMultiScaleProb = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                         wxSize(50, -1), 0);
    ...
    _staticTextGAsMutationsNormalVarMaxGensNbProb = new wxStaticText(
        _panelMutation, wxID_ANY, _("Normal variable: prob on # generations"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    _textCtrlGAsMutationsNormalVarMaxGensNbProb = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString,
                                                                 wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer191->Add(_textCtrlGAsMutationsNormalVarMaxGensNbProb, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsNormalVarMaxGensNbStdDev = new wxStaticText(
        _panelMutation, wxID_ANY, _("Normal variable: std dev on # generations"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    _textCtrlGAsMutationsNormalVarMaxGensNbStdDev = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString,
                                                                   wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer191->Add(_textCtrlGAsMutationsNormalVarMaxGensNbStdDev, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsNormalVarProbStart = new wxStaticText(
        _panelMutation, wxID_ANY, _("Normal variable: starting probability"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsNormalVarProbStart->Wrap(-1);
    fgSizer191->Add(_staticTextGAsMutationsNormalVarProbStart, 0, wxALL, 5);

    _textCtrlGAsMutationsNormalVarProbStart = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                             wxSize(50, -1), 0);
    fgSizer191->Add(_textCtrlGAsMutationsNormalVarProbStart, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsNormalVarProbEnd = new wxStaticText(
        _panelMutation, wxID_ANY, _("Normal variable: ending probability"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsNormalVarProbEnd->Wrap(-1);
    fgSizer191->Add(_staticTextGAsMutationsNormalVarProbEnd, 0, wxALL, 5);

    _textCtrlGAsMutationsNormalVarProbEnd = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                           wxSize(50, -1), 0);
    fgSizer191->Add(_textCtrlGAsMutationsNormalVarProbEnd, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsNormalVarStdDevStart = new wxStaticText(
        _panelMutation, wxID_ANY, _("Normal variable: starting std dev"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsNormalVarStdDevStart->Wrap(-1);
    fgSizer191->Add(_staticTextGAsMutationsNormalVarStdDevStart, 0, wxALL, 5);

    _textCtrlGAsMutationsNormalVarStdDevStart = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString,
                                                               wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer191->Add(_textCtrlGAsMutationsNormalVarStdDevStart, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsNormalVarStdDevEnd = new wxStaticText(
        _panelMutation, wxID_ANY, _("Normal variable: ending std dev"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsNormalVarStdDevEnd->Wrap(-1);
    fgSizer191->Add(_staticTextGAsMutationsNormalVarStdDevEnd, 0, wxALL, 5);

    _textCtrlGAsMutationsNormalVarStdDevEnd = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                             wxSize(50, -1), 0);
    fgSizer191->Add(_textCtrlGAsMutationsNormalVarStdDevEnd, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsNonUniformProb = new wxStaticText(_panelMutation, wxID_ANY, _("Non-uniform: probability"),
                                                             wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsNonUniformProb->Wrap(-1);
    fgSizer191->Add(_staticTextGAsMutationsNonUniformProb, 0, wxALL, 5);

    _textCtrlGAsMutationsNonUniformProb = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                         wxSize(50, -1), 0);
    fgSizer191->Add(_textCtrlGAsMutationsNonUniformProb, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsNonUniformGensNb = new wxStaticText(
        _panelMutation, wxID_ANY, _("Non-uniform: on # generations"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsNonUniformGensNb->Wrap(-1);
    fgSizer191->Add(_staticTextGAsMutationsNonUniformGensNb, 0, wxALL, 5);

    _textCtrlGAsMutationsNonUniformGensNb = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                           wxSize(50, -1), 0);
    fgSizer191->Add(_textCtrlGAsMutationsNonUniformGensNb, 0, wxRIGHT | wxLEFT, 5);

    _staticTextGAsMutationsNonUniformMinRate = new wxStaticText(
        _panelMutation, wxID_ANY, _("Non-uniform: minimum rate"), wxDefaultPosition, wxDefaultSize, 0);
    _staticTextGAsMutationsNonUniformMinRate->Wrap(-1);
    fgSizer191->Add(_staticTextGAsMutationsNonUniformMinRate, 0, wxALL, 5);

    _textCtrlGAsMutationsNonUniformMinRate = new wxTextCtrl(_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition,
                                                            wxSize(50, -1), 0);
    ...
    _menuTools->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameOptimizerVirtual::OpenFramePredictandDB),
                     this, _menuItemBuildPredictandDB->GetId());
    _menuLog->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameOptimizerVirtual::OnShowLog), this,
                   _menuItemShowLog->GetId());
    _menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameOptimizerVirtual::OnLogLevel1), this,
                        _menuItemLogLevel1->GetId());
    _menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameOptimizerVirtual::OnLogLevel2), this,
                        _menuItemLogLevel2->GetId());
    _menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameOptimizerVirtual::OnLogLevel3), this,
                        _menuItemLogLevel3->GetId());
    _menuHelp->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameOptimizerVirtual::OpenFrameAbout), this,
...
asFramePreferencesOptimizerVirtual::asFramePreferencesOptimizerVirtual(wxWindow* parent, wxWindowID id,
    ...
    _choiceLocale = new wxChoice(sbSizer11->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                 _choiceLocaleNChoices, _choiceLocaleChoices, 0);
    _choiceLocale->SetSelection(0);
    sbSizer11->Add(_choiceLocale, 0, wxALL, 5);

    _staticText59 = new wxStaticText(sbSizer11->GetStaticBox(), wxID_ANY,
