...
asFrameOptimizerVirtual::asFrameOptimizerVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    m_staticTextMethod = new wxStaticText(m_panelControls, wxID_ANY, _("Select the calibration method"),
                                          wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextMethod->Wrap(-1);
    bSizer5->Add(m_staticTextMethod, 0, wxALL, 5);

    wxString m_choiceMethodChoices[] = {_("Single assessment"),
                                        _("Classic calibration"),
                                        _("Classic+ calibration"),
                                        _("Variables exploration Classic+"),
                                        _("Monte-Carlo"),
                                        _("Genetic algorithms"),
                                        _("Evaluate all scores"),
                                        _("Only predictand values"),
                                        _("Only analog dates (and criteria)")};
    int m_choiceMethodNChoices = sizeof(m_choiceMethodChoices) / sizeof(wxString);
    m_choiceMethod = new wxChoice(m_panelControls, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceMethodNChoices,
                                  m_choiceMethodChoices, 0);
    m_choiceMethod->SetSelection(0);
    bSizer5->Add(m_choiceMethod, 0, wxBOTTOM | wxRIGHT | wxLEFT, 5);

    m_staticTextFileParameters =
        new wxStaticText(m_panelControls, wxID_ANY, _("Select the parameters file for the calibration"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextFileParameters->Wrap(-1);
    bSizer5->Add(m_staticTextFileParameters, 0, wxALL, 5);

    m_filePickerParameters = new wxFilePickerCtrl(m_panelControls, wxID_ANY, wxEmptyString, _("Select a file"),
    ...
    m_staticTextFilePredictand = new wxStaticText(m_panelControls, wxID_ANY, _("Select the predictand DB file"),
                                                  wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextFilePredictand->Wrap(-1);
    bSizer5->Add(m_staticTextFilePredictand, 0, wxALL, 5);

    m_filePickerPredictand = new wxFilePickerCtrl(m_panelControls, wxID_ANY, wxEmptyString, _("Select a file"),
                                                  _("*.nc"), wxDefaultPosition, wxSize(-1, -1), wxFLP_DEFAULT_STYLE);
    bSizer5->Add(m_filePickerPredictand, 0, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 5);

    m_staticTextPredictorDir = new wxStaticText(m_panelControls, wxID_ANY, _("Select the predictors directory"),
                                                wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextPredictorDir->Wrap(-1);
    bSizer5->Add(m_staticTextPredictorDir, 0, wxALL, 5);

    m_dirPickerPredictor = new wxDirPickerCtrl(m_panelControls, wxID_ANY, wxEmptyString, _("Select a folder"),
    ...
    m_staticTextCalibrationResultsDir = new wxStaticText(
        m_panelControls, wxID_ANY, _("Directory to save calibration outputs"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextCalibrationResultsDir->Wrap(-1);
    bSizer5->Add(m_staticTextCalibrationResultsDir, 0, wxALL, 5);

    m_dirPickerCalibrationResults = new wxDirPickerCtrl(m_panelControls, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                        wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE);
    ...
    m_staticTextStateLabel =
        new wxStaticText(m_panelControls, wxID_ANY, _("Calibration state: "), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextState =
        new wxStaticText(m_panelControls, wxID_ANY, _("Not running."), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextClassicPlusStepsLonPertinenceMap =
        new wxStaticText(sbSizer10->GetStaticBox(), wxID_ANY, _("Multiple of the steps in lon for pertinence map"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextClassicPlusStepsLonPertinenceMap->Wrap(-1);
    fgSizer21->Add(m_staticTextClassicPlusStepsLonPertinenceMap, 0, wxALL, 5);

    m_textCtrlClassicPlusStepsLonPertinenceMap =
        new wxTextCtrl(sbSizer10->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer21->Add(m_textCtrlClassicPlusStepsLonPertinenceMap, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextClassicPlusStepsLatPertinenceMap =
        new wxStaticText(sbSizer10->GetStaticBox(), wxID_ANY, _("Multiple of the steps in lat for pertinence map"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextClassicPlusStepsLatPertinenceMap->Wrap(-1);
    fgSizer21->Add(m_staticTextClassicPlusStepsLatPertinenceMap, 0, wxALL, 5);

    m_textCtrlClassicPlusStepsLatPertinenceMap =
        new wxTextCtrl(sbSizer10->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer21->Add(m_textCtrlClassicPlusStepsLatPertinenceMap, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextClassicPlusResizingIterations =
        new wxStaticText(sbSizer10->GetStaticBox(), wxID_ANY, _("Iterations in final resizing attempts"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextClassicPlusResizingIterations->Wrap(-1);
    fgSizer21->Add(m_staticTextClassicPlusResizingIterations, 0, wxALL, 5);

    m_textCtrlClassicPlusResizingIterations =
        new wxTextCtrl(sbSizer10->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer21->Add(m_textCtrlClassicPlusResizingIterations, 0, wxRIGHT | wxLEFT, 5);

    m_checkBoxProceedSequentially = new wxCheckBox(
        sbSizer10->GetStaticBox(), wxID_ANY, _("Proceed sequentially (standard)"), wxDefaultPosition, wxDefaultSize, 0);
    fgSizer21->Add(m_checkBoxProceedSequentially, 0, wxALL, 5);

    m_staticTextSpacer =
        new wxStaticText(sbSizer10->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextSpacer->Wrap(-1);
    fgSizer21->Add(m_staticTextSpacer, 0, wxALL, 5);

    m_checkBoxClassicPlusResize =
        new wxCheckBox(sbSizer10->GetStaticBox(), wxID_ANY, _("Resize the spatial windows separately"),
                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    sbSizer12 = new wxStaticBoxSizer(new wxStaticBox(m_panelSingle, wxID_ANY, _("Monte-Carlo")), wxHORIZONTAL);

    m_staticTextMonteCarloRandomNb = new wxStaticText(
        sbSizer12->GetStaticBox(), wxID_ANY, _("Number of random param. sets"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextMonteCarloRandomNb->Wrap(-1);
    sbSizer12->Add(m_staticTextMonteCarloRandomNb, 0, wxALL, 5);

    m_textCtrlMonteCarloRandomNb =
        new wxTextCtrl(sbSizer12->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    sbSizer12->Add(m_textCtrlMonteCarloRandomNb, 0, wxBOTTOM | wxLEFT | wxRIGHT, 5);

    bSizer24->Add(sbSizer12, 0, wxALL | wxEXPAND, 5);

    wxStaticBoxSizer* sbSizer91;
    sbSizer91 =
        new wxStaticBoxSizer(new wxStaticBox(m_panelSingle, wxID_ANY, _("Variables exploration")), wxHORIZONTAL);

    m_staticTextVarExploStepToExplore = new wxStaticText(
        sbSizer91->GetStaticBox(), wxID_ANY, _("Step to explore (0-based)"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextVarExploStepToExplore->Wrap(-1);
    sbSizer91->Add(m_staticTextVarExploStepToExplore, 0, wxALL, 5);

    m_textCtrlVarExploStepToExplore =
        new wxTextCtrl(sbSizer91->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    sbSizer91->Add(m_textCtrlVarExploStepToExplore, 0, wxBOTTOM | wxLEFT | wxRIGHT, 5);

    bSizer24->Add(sbSizer91, 0, wxEXPAND | wxALL, 5);

    m_panelSingle->SetSizer(bSizer24);
    m_panelSingle->Layout();
    bSizer24->Fit(m_panelSingle);
    m_notebookOptions->AddPage(m_panelSingle, _("Calibration"), true);
    m_panelGeneticAlgoritms =
        new wxPanel(m_notebookOptions, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL);
    ...
    m_staticTextGAsNaturalSelectionOperator = new wxStaticText(
        sbSizer5->GetStaticBox(), wxID_ANY, _("Natural selection"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    int m_choiceGAsNaturalSelectionOperatorNChoices =
        sizeof(m_choiceGAsNaturalSelectionOperatorChoices) / sizeof(wxString);
    m_choiceGAsNaturalSelectionOperator =
        new wxChoice(sbSizer5->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize,
                     m_choiceGAsNaturalSelectionOperatorNChoices, m_choiceGAsNaturalSelectionOperatorChoices, 0);
    m_choiceGAsNaturalSelectionOperator->SetSelection(0);
    fgSizer11->Add(m_choiceGAsNaturalSelectionOperator, 0, wxALL | wxEXPAND, 5);

    m_staticTextGAsCouplesSelectionOperator = new wxStaticText(
        sbSizer5->GetStaticBox(), wxID_ANY, _("Couples selection"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsCouplesSelectionOperator->Wrap(-1);
    fgSizer11->Add(m_staticTextGAsCouplesSelectionOperator, 0, wxALL, 5);

    wxString m_choiceGAsCouplesSelectionOperatorChoices[] = {
        _("Rank pairing"), _("Randomly"), _("Roulette wheel on rank"), _("Roulette wheel on score"), _("Tournament")};
    int m_choiceGAsCouplesSelectionOperatorNChoices =
        sizeof(m_choiceGAsCouplesSelectionOperatorChoices) / sizeof(wxString);
    m_choiceGAsCouplesSelectionOperator =
        new wxChoice(sbSizer5->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize,
                     m_choiceGAsCouplesSelectionOperatorNChoices, m_choiceGAsCouplesSelectionOperatorChoices, 0);
    m_choiceGAsCouplesSelectionOperator->SetSelection(0);
    fgSizer11->Add(m_choiceGAsCouplesSelectionOperator, 0, wxALL | wxEXPAND, 5);

    m_staticTextGAsCrossoverOperator =
        new wxStaticText(sbSizer5->GetStaticBox(), wxID_ANY, _("Crossover"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsCrossoverOperator->Wrap(-1);
    fgSizer11->Add(m_staticTextGAsCrossoverOperator, 0, wxALL, 5);

    wxString m_choiceGAsCrossoverOperatorChoices[] = {_("Single point crossover"),    _("Double points crossover"),
                                                      _("Multiple points crossover"), _("Uniform crossover"),
                                                      _("Limited blending"),          _("Linear crossover"),
                                                      _("Heuristic crossover"),       _("Binary-like crossover"),
                                                      _("Linear interpolation"),      _("Free interpolation")};
    int m_choiceGAsCrossoverOperatorNChoices = sizeof(m_choiceGAsCrossoverOperatorChoices) / sizeof(wxString);
    m_choiceGAsCrossoverOperator =
        new wxChoice(sbSizer5->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize,
                     m_choiceGAsCrossoverOperatorNChoices, m_choiceGAsCrossoverOperatorChoices, 0);
    m_choiceGAsCrossoverOperator->SetSelection(0);
    fgSizer11->Add(m_choiceGAsCrossoverOperator, 0, wxALL | wxEXPAND, 5);

    m_staticTextGAsMutationOperator =
        new wxStaticText(sbSizer5->GetStaticBox(), wxID_ANY, _("Mutation"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationOperator->Wrap(-1);
    fgSizer11->Add(m_staticTextGAsMutationOperator, 0, wxALL, 5);

    wxString m_choiceGAsMutationOperatorChoices[] = {_("Uniform constant"),
                                                     _("Uniform variable"),
                                                     _("Normal constant"),
                                                     _("Normal variable"),
                                                     _("Non-uniform"),
                                                     _("Self adaptation rate"),
                                                     _("Self adaptation radius"),
                                                     _("Self adaptation rate chromosome"),
                                                     _("Self adaptation radius chromosome"),
                                                     _("Multi scale")};
    int m_choiceGAsMutationOperatorNChoices = sizeof(m_choiceGAsMutationOperatorChoices) / sizeof(wxString);
    m_choiceGAsMutationOperator =
        new wxChoice(sbSizer5->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize,
                     m_choiceGAsMutationOperatorNChoices, m_choiceGAsMutationOperatorChoices, 0);
    ...
    sbSizer6 =
        new wxStaticBoxSizer(new wxStaticBox(m_panelGeneticAlgoritms, wxID_ANY, _("General options")), wxVERTICAL);
    ...
    m_staticTextGAsRunNumbers =
        new wxStaticText(sbSizer6->GetStaticBox(), wxID_ANY, _("Runs number"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsRunNumbers->Wrap(-1);
    fgSizer121->Add(m_staticTextGAsRunNumbers, 0, wxALL, 5);

    m_textCtrlGAsRunNumbers =
        new wxTextCtrl(sbSizer6->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer121->Add(m_textCtrlGAsRunNumbers, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsPopulationSize = new wxStaticText(sbSizer6->GetStaticBox(), wxID_ANY, _("Population's size"),
                                                     wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsPopulationSize->Wrap(-1);
    fgSizer121->Add(m_staticTextGAsPopulationSize, 0, wxALL, 5);

    m_textCtrlGAsPopulationSize =
        new wxTextCtrl(sbSizer6->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer121->Add(m_textCtrlGAsPopulationSize, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsConvergenceNb = new wxStaticText(sbSizer6->GetStaticBox(), wxID_ANY, _("Convergence after"),
                                                    wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsConvergenceNb->Wrap(-1);
    fgSizer121->Add(m_staticTextGAsConvergenceNb, 0, wxALL, 5);

    m_textCtrlGAsConvergenceNb =
        new wxTextCtrl(sbSizer6->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer121->Add(m_textCtrlGAsConvergenceNb, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsRatioIntermGen = new wxStaticText(sbSizer6->GetStaticBox(), wxID_ANY, _("Ratio interm. gen."),
                                                     wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsRatioIntermGen->Wrap(-1);
    fgSizer121->Add(m_staticTextGAsRatioIntermGen, 0, wxALL, 5);

    m_textCtrlGAsRatioIntermGen =
        new wxTextCtrl(sbSizer6->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer121->Add(m_textCtrlGAsRatioIntermGen, 0, wxRIGHT | wxLEFT, 5);

    sbSizer6->Add(fgSizer121, 0, wxEXPAND, 5);

    m_checkBoxGAsAllowElitism = new wxCheckBox(sbSizer6->GetStaticBox(), wxID_ANY, _("Allow elitism for the best"),
                                               wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextGAsNaturalSlctTournamentProb = new wxStaticText(
        m_panelSelections, wxID_ANY, _("Natural slct tournament: prob"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsNaturalSlctTournamentProb->Wrap(-1);
    fgSizer141->Add(m_staticTextGAsNaturalSlctTournamentProb, 0, wxALL, 5);

    m_textCtrlGAsNaturalSlctTournamentProb =
        new wxTextCtrl(m_panelSelections, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    ...
    m_staticTextGAsCouplesSlctTournamentNb = new wxStaticText(
        m_panelSelections, wxID_ANY, _("Couples slct tournament: nb ind."), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsCouplesSlctTournamentNb->Wrap(-1);
    fgSizer151->Add(m_staticTextGAsCouplesSlctTournamentNb, 0, wxALL, 5);

    m_textCtrlGAsCouplesSlctTournamentNb =
        new wxTextCtrl(m_panelSelections, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    ...
    m_staticTextGAsCrossoverMultipleNbPts = new wxStaticText(
        m_panelCrossover, wxID_ANY, _("Multiple crossover: nb points"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsCrossoverMultipleNbPts->Wrap(-1);
    fgSizer14->Add(m_staticTextGAsCrossoverMultipleNbPts, 0, wxALL, 5);

    m_textCtrlGAsCrossoverMultipleNbPts =
        new wxTextCtrl(m_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer14->Add(m_textCtrlGAsCrossoverMultipleNbPts, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsCrossoverBlendingNbPts = new wxStaticText(
        m_panelCrossover, wxID_ANY, _("Blending crossover: nb points"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsCrossoverBlendingNbPts->Wrap(-1);
    fgSizer14->Add(m_staticTextGAsCrossoverBlendingNbPts, 0, wxALL, 5);

    m_textCtrlGAsCrossoverBlendingNbPts =
        new wxTextCtrl(m_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer14->Add(m_textCtrlGAsCrossoverBlendingNbPts, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsCrossoverBlendingShareBeta = new wxStaticText(
        m_panelCrossover, wxID_ANY, _("Blending crossover: share beta"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsCrossoverBlendingShareBeta->Wrap(-1);
    fgSizer14->Add(m_staticTextGAsCrossoverBlendingShareBeta, 0, wxALL, 5);

    m_checkBoxGAsCrossoverBlendingShareBeta =
        new wxCheckBox(m_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
    fgSizer14->Add(m_checkBoxGAsCrossoverBlendingShareBeta, 0, wxALL, 5);

    m_staticTextGAsCrossoverLinearNbPts = new wxStaticText(m_panelCrossover, wxID_ANY, _("Linear crossover: nb points"),
                                                           wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsCrossoverLinearNbPts->Wrap(-1);
    fgSizer14->Add(m_staticTextGAsCrossoverLinearNbPts, 0, wxALL, 5);

    m_textCtrlGAsCrossoverLinearNbPts =
        new wxTextCtrl(m_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    ...
    m_staticTextGAsCrossoverHeuristicNbPts = new wxStaticText(
        m_panelCrossover, wxID_ANY, _("Heuristic crossover: nb points"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsCrossoverHeuristicNbPts->Wrap(-1);
    fgSizer15->Add(m_staticTextGAsCrossoverHeuristicNbPts, 0, wxALL, 5);

    m_textCtrlGAsCrossoverHeuristicNbPts =
        new wxTextCtrl(m_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer15->Add(m_textCtrlGAsCrossoverHeuristicNbPts, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsCrossoverHeuristicShareBeta = new wxStaticText(
        m_panelCrossover, wxID_ANY, _("Heuristic crossover: share beta"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsCrossoverHeuristicShareBeta->Wrap(-1);
    fgSizer15->Add(m_staticTextGAsCrossoverHeuristicShareBeta, 0, wxALL, 5);

    m_checkBoxGAsCrossoverHeuristicShareBeta =
        new wxCheckBox(m_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
    fgSizer15->Add(m_checkBoxGAsCrossoverHeuristicShareBeta, 0, wxALL, 5);

    m_staticTextGAsCrossoverBinLikeNbPts = new wxStaticText(
        m_panelCrossover, wxID_ANY, _("Binary-like crossover: nb points"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsCrossoverBinLikeNbPts->Wrap(-1);
    fgSizer15->Add(m_staticTextGAsCrossoverBinLikeNbPts, 0, wxALL, 5);

    m_textCtrlGAsCrossoverBinLikeNbPts =
        new wxTextCtrl(m_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer15->Add(m_textCtrlGAsCrossoverBinLikeNbPts, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsCrossoverBinLikeShareBeta = new wxStaticText(
        m_panelCrossover, wxID_ANY, _("Binary-like crossover: share beta"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsCrossoverBinLikeShareBeta->Wrap(-1);
    fgSizer15->Add(m_staticTextGAsCrossoverBinLikeShareBeta, 0, wxALL, 5);

    m_checkBoxGAsCrossoverBinLikeShareBeta =
        new wxCheckBox(m_panelCrossover, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextGAsMutationsUniformCstProb = new wxStaticText(
        m_panelMutation, wxID_ANY, _("Uniform constant: probability"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsUniformCstProb->Wrap(-1);
    fgSizer13->Add(m_staticTextGAsMutationsUniformCstProb, 0, wxALL, 5);

    m_textCtrlGAsMutationsUniformCstProb =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer13->Add(m_textCtrlGAsMutationsUniformCstProb, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsNormalCstProb = new wxStaticText(
        m_panelMutation, wxID_ANY, _("Normal constant: probability"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsNormalCstProb->Wrap(-1);
    fgSizer13->Add(m_staticTextGAsMutationsNormalCstProb, 0, wxALL, 5);

    m_textCtrlGAsMutationsNormalCstProb =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer13->Add(m_textCtrlGAsMutationsNormalCstProb, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsNormalCstStdDev =
        new wxStaticText(m_panelMutation, wxID_ANY, _("Normal constant: std dev"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsNormalCstStdDev->Wrap(-1);
    fgSizer13->Add(m_staticTextGAsMutationsNormalCstStdDev, 0, wxALL, 5);

    m_textCtrlGAsMutationsNormalCstStdDev =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer13->Add(m_textCtrlGAsMutationsNormalCstStdDev, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsUniformVarMaxGensNb = new wxStaticText(
        m_panelMutation, wxID_ANY, _("Uniform variable: on # generations"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsUniformVarMaxGensNb->Wrap(-1);
    fgSizer13->Add(m_staticTextGAsMutationsUniformVarMaxGensNb, 0, wxALL, 5);

    m_textCtrlGAsMutationsUniformVarMaxGensNb =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer13->Add(m_textCtrlGAsMutationsUniformVarMaxGensNb, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsUniformVarProbStart = new wxStaticText(
        m_panelMutation, wxID_ANY, _("Uniform variable: starting probability"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsUniformVarProbStart->Wrap(-1);
    fgSizer13->Add(m_staticTextGAsMutationsUniformVarProbStart, 0, wxALL, 5);

    m_textCtrlGAsMutationsUniformVarProbStart =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer13->Add(m_textCtrlGAsMutationsUniformVarProbStart, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsUniformVarProbEnd = new wxStaticText(
        m_panelMutation, wxID_ANY, _("Uniform variable: ending probability"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsUniformVarProbEnd->Wrap(-1);
    fgSizer13->Add(m_staticTextGAsMutationsUniformVarProbEnd, 0, wxALL, 5);

    m_textCtrlGAsMutationsUniformVarProbEnd =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer13->Add(m_textCtrlGAsMutationsUniformVarProbEnd, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsMultiScaleProb =
        new wxStaticText(m_panelMutation, wxID_ANY, _("Multi-scale: probability"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsMultiScaleProb->Wrap(-1);
    fgSizer13->Add(m_staticTextGAsMutationsMultiScaleProb, 0, wxALL, 5);

    m_textCtrlGAsMutationsMultiScaleProb =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    ...
    m_staticTextGAsMutationsNormalVarMaxGensNbProb = new wxStaticText(
        m_panelMutation, wxID_ANY, _("Normal variable: prob on # generations"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_textCtrlGAsMutationsNormalVarMaxGensNbProb =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer191->Add(m_textCtrlGAsMutationsNormalVarMaxGensNbProb, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsNormalVarMaxGensNbStdDev = new wxStaticText(
        m_panelMutation, wxID_ANY, _("Normal variable: std dev on # generations"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_textCtrlGAsMutationsNormalVarMaxGensNbStdDev =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer191->Add(m_textCtrlGAsMutationsNormalVarMaxGensNbStdDev, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsNormalVarProbStart = new wxStaticText(
        m_panelMutation, wxID_ANY, _("Normal variable: starting probability"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsNormalVarProbStart->Wrap(-1);
    fgSizer191->Add(m_staticTextGAsMutationsNormalVarProbStart, 0, wxALL, 5);

    m_textCtrlGAsMutationsNormalVarProbStart =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer191->Add(m_textCtrlGAsMutationsNormalVarProbStart, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsNormalVarProbEnd = new wxStaticText(
        m_panelMutation, wxID_ANY, _("Normal variable: ending probability"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsNormalVarProbEnd->Wrap(-1);
    fgSizer191->Add(m_staticTextGAsMutationsNormalVarProbEnd, 0, wxALL, 5);

    m_textCtrlGAsMutationsNormalVarProbEnd =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer191->Add(m_textCtrlGAsMutationsNormalVarProbEnd, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsNormalVarStdDevStart = new wxStaticText(
        m_panelMutation, wxID_ANY, _("Normal variable: starting std dev"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsNormalVarStdDevStart->Wrap(-1);
    fgSizer191->Add(m_staticTextGAsMutationsNormalVarStdDevStart, 0, wxALL, 5);

    m_textCtrlGAsMutationsNormalVarStdDevStart =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer191->Add(m_textCtrlGAsMutationsNormalVarStdDevStart, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsNormalVarStdDevEnd = new wxStaticText(
        m_panelMutation, wxID_ANY, _("Normal variable: ending std dev"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsNormalVarStdDevEnd->Wrap(-1);
    fgSizer191->Add(m_staticTextGAsMutationsNormalVarStdDevEnd, 0, wxALL, 5);

    m_textCtrlGAsMutationsNormalVarStdDevEnd =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer191->Add(m_textCtrlGAsMutationsNormalVarStdDevEnd, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsNonUniformProb =
        new wxStaticText(m_panelMutation, wxID_ANY, _("Non-uniform: probability"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsNonUniformProb->Wrap(-1);
    fgSizer191->Add(m_staticTextGAsMutationsNonUniformProb, 0, wxALL, 5);

    m_textCtrlGAsMutationsNonUniformProb =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer191->Add(m_textCtrlGAsMutationsNonUniformProb, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsNonUniformGensNb = new wxStaticText(
        m_panelMutation, wxID_ANY, _("Non-uniform: on # generations"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsNonUniformGensNb->Wrap(-1);
    fgSizer191->Add(m_staticTextGAsMutationsNonUniformGensNb, 0, wxALL, 5);

    m_textCtrlGAsMutationsNonUniformGensNb =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    fgSizer191->Add(m_textCtrlGAsMutationsNonUniformGensNb, 0, wxRIGHT | wxLEFT, 5);

    m_staticTextGAsMutationsNonUniformMinRate = new wxStaticText(
        m_panelMutation, wxID_ANY, _("Non-uniform: minimum rate"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextGAsMutationsNonUniformMinRate->Wrap(-1);
    fgSizer191->Add(m_staticTextGAsMutationsNonUniformMinRate, 0, wxALL, 5);

    m_textCtrlGAsMutationsNonUniformMinRate =
        new wxTextCtrl(m_panelMutation, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(50, -1), 0);
    ...
    m_buttonSaveDefault =
        new wxButton(m_panelMain, wxID_ANY, _("Save as default"), wxDefaultPosition, wxDefaultSize, 0);
    ...
    // Connect Events
    m_buttonSaveDefault->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                 wxCommandEventHandler(asFrameOptimizerVirtual::OnSaveDefault), NULL, this);
    m_menuOptions->Bind(wxEVT_COMMAND_MENU_SELECTED,
                        wxCommandEventHandler(asFrameOptimizerVirtual::OpenFramePreferences), this,
                        m_menuItemPreferences->GetId());
    m_menuTools->Bind(wxEVT_COMMAND_MENU_SELECTED,
                      wxCommandEventHandler(asFrameOptimizerVirtual::OpenFramePredictandDB), this,
                      m_menuItemBuildPredictandDB->GetId());
    m_menuLog->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameOptimizerVirtual::OnShowLog), this,
                    m_menuItemShowLog->GetId());
    m_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameOptimizerVirtual::OnLogLevel1), this,
                         m_MenuItemLogLevel1->GetId());
    m_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameOptimizerVirtual::OnLogLevel2), this,
                         m_MenuItemLogLevel2->GetId());
    m_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameOptimizerVirtual::OnLogLevel3), this,
                         m_MenuItemLogLevel3->GetId());
    m_menuHelp->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameOptimizerVirtual::OpenFrameAbout), this,
                     m_menuItemAbout->GetId());
}

asFrameOptimizerVirtual::~asFrameOptimizerVirtual() {
    // Disconnect Events
    m_buttonSaveDefault->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                    wxCommandEventHandler(asFrameOptimizerVirtual::OnSaveDefault), NULL, this);
}

asFramePreferencesOptimizerVirtual::asFramePreferencesOptimizerVirtual(wxWindow* parent, wxWindowID id,
    ...
    m_staticTextArchivePredictorsDir =
        new wxStaticText(sbSizer18->GetStaticBox(), wxID_ANY, _("Directory containing archive predictors"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextArchivePredictorsDir->Wrap(-1);
    sbSizer18->Add(m_staticTextArchivePredictorsDir, 0, wxRIGHT | wxLEFT, 5);

    m_dirPickerArchivePredictors =
        new wxDirPickerCtrl(sbSizer18->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition,
                            wxDefaultSize, wxDIRP_USE_TEXTCTRL);
    sbSizer18->Add(m_dirPickerArchivePredictors, 0, wxBOTTOM | wxRIGHT | wxLEFT | wxEXPAND, 5);

    m_staticTextPredictandDBDir = new wxStaticText(
    ...
    wxString m_radioBoxGuiChoices[] = {_("Silent (no progressbar, much faster)"), _("Standard (recommanded)"),
                                       _("Verbose (not much used)")};
    int m_radioBoxGuiNChoices = sizeof(m_radioBoxGuiChoices) / sizeof(wxString);
    m_radioBoxGui = new wxRadioBox(m_panelGeneral, wxID_ANY, _("GUI options"), wxDefaultPosition, wxDefaultSize,
                                   m_radioBoxGuiNChoices, m_radioBoxGuiChoices, 1, wxRA_SPECIFY_COLS);
    m_radioBoxGui->SetSelection(1);
    bSizer271->Add(m_radioBoxGui, 0, wxALL | wxEXPAND, 5);

    m_checkBoxResponsiveness =
        new wxCheckBox(m_panelGeneral, wxID_ANY, _("Let the software be responsive while processing (recommended)."),
                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_checkBoxAllowMultithreading = new wxCheckBox(sbSizer15->GetStaticBox(), wxID_ANY, _("Allow multithreading"),
                                                   wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextThreadsNb = new wxStaticText(sbSizer15->GetStaticBox(), wxID_ANY, _("Max nb of threads"),
                                             wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextThreadsNb->Wrap(-1);
    bSizer221->Add(m_staticTextThreadsNb, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_textCtrlThreadsNb =
        new wxTextCtrl(sbSizer15->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(30, -1), 0);
    ...
    m_staticTextThreadsPriority = new wxStaticText(sbSizer15->GetStaticBox(), wxID_ANY, _("Threads priority"),
                                                   wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextThreadsPriority->Wrap(-1);
    bSizer241->Add(m_staticTextThreadsPriority, 0, wxALL, 5);

    m_sliderThreadsPriority = new wxSlider(sbSizer15->GetStaticBox(), wxID_ANY, 95, 0, 100, wxDefaultPosition,
    ...
    wxString m_radioBoxProcessingMethodsChoices[] = {_("Multithreaded (only if allowed hereabove)"),
                                                     _("Standard (slower)")};
    int m_radioBoxProcessingMethodsNChoices = sizeof(m_radioBoxProcessingMethodsChoices) / sizeof(wxString);
    m_radioBoxProcessingMethods =
        new wxRadioBox(m_panelProcessing, wxID_ANY, _("Processing options"), wxDefaultPosition, wxDefaultSize,
                       m_radioBoxProcessingMethodsNChoices, m_radioBoxProcessingMethodsChoices, 1, wxRA_SPECIFY_COLS);
    m_radioBoxProcessingMethods->SetSelection(0);
    m_radioBoxProcessingMethods->SetToolTip(
        _("These options don't affect the results, only the processor efficiency."));
    ...
    m_panelUserDirectories =
        new wxPanel(m_notebookAdvanced, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL);
    wxBoxSizer* bSizer24;
    bSizer24 = new wxBoxSizer(wxVERTICAL);

    wxStaticBoxSizer* sbSizer411;
    sbSizer411 =
        new wxStaticBoxSizer(new wxStaticBox(m_panelUserDirectories, wxID_ANY, _("Working directories")), wxVERTICAL);

    m_staticTextIntermediateResultsDir =
        new wxStaticText(sbSizer411->GetStaticBox(), wxID_ANY, _("Directory to save intermediate temporary results"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextIntermediateResultsDir->Wrap(-1);
    sbSizer411->Add(m_staticTextIntermediateResultsDir, 0, wxALL, 5);

    m_dirPickerIntermediateResults =
        new wxDirPickerCtrl(sbSizer411->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a folder"),
    ...
    sbSizer17 =
        new wxStaticBoxSizer(new wxStaticBox(m_panelUserDirectories, wxID_ANY, _("User specific paths")), wxVERTICAL);
    ...
    // Connect Events
    m_checkBoxAllowMultithreading->Connect(
        wxEVT_COMMAND_CHECKBOX_CLICKED,
        wxCommandEventHandler(asFramePreferencesOptimizerVirtual::OnChangeMultithreadingCheckBox), NULL, this);
    m_buttonsConfirmationApply->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                        wxCommandEventHandler(asFramePreferencesOptimizerVirtual::ApplyChanges), NULL,
                                        this);
    m_buttonsConfirmationCancel->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                         wxCommandEventHandler(asFramePreferencesOptimizerVirtual::CloseFrame), NULL,
                                         this);
    m_buttonsConfirmationOK->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                     wxCommandEventHandler(asFramePreferencesOptimizerVirtual::SaveAndClose), NULL,
                                     this);
}

asFramePreferencesOptimizerVirtual::~asFramePreferencesOptimizerVirtual() {
    // Disconnect Events
    m_checkBoxAllowMultithreading->Disconnect(
        wxEVT_COMMAND_CHECKBOX_CLICKED,
        wxCommandEventHandler(asFramePreferencesOptimizerVirtual::OnChangeMultithreadingCheckBox), NULL, this);
    m_buttonsConfirmationApply->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                           wxCommandEventHandler(asFramePreferencesOptimizerVirtual::ApplyChanges),
                                           NULL, this);
