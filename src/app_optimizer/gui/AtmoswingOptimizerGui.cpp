...
asFrameOptimizerVirtual::asFrameOptimizerVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
  ...
  m_filePickerPredictand = new wxFilePickerCtrl(m_panelControls, wxID_ANY, wxEmptyString, _("Select a file"), _("*.nc"),
  ...
  m_checkBoxClassicPlusResize =
      new wxCheckBox(sbSizer10->GetStaticBox(), wxID_ANY, _("Resize the spatial windows separately"), wxDefaultPosition,
                     wxDefaultSize, 0);
  ...
  sbSizer91 = new wxStaticBoxSizer(new wxStaticBox(m_panelSingle, wxID_ANY, _("Variables exploration")), wxHORIZONTAL);
  ...
  m_staticTextGAsNaturalSelectionOperator =
      new wxStaticText(sbSizer5->GetStaticBox(), wxID_ANY, _("Natural selection"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticTextGAsCouplesSelectionOperator =
      new wxStaticText(sbSizer5->GetStaticBox(), wxID_ANY, _("Couples selection"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticTextGAsPopulationSize =
      new wxStaticText(sbSizer6->GetStaticBox(), wxID_ANY, _("Population's size"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticTextGAsConvergenceNb =
      new wxStaticText(sbSizer6->GetStaticBox(), wxID_ANY, _("Convergence after"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticTextGAsMutationsNormalCstProb = new wxStaticText(m_panelMutation, wxID_ANY, _("Normal constant: probability"),
                                                           wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticTextGAsMutationsNonUniformMinRate =
      new wxStaticText(m_panelMutation, wxID_ANY, _("Non-uniform: minimum rate"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_menuOptions->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameOptimizerVirtual::OpenFramePreferences),
                      this, m_menuItemPreferences->GetId());
  m_menuTools->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameOptimizerVirtual::OpenFramePredictandDB),
...
asFramePreferencesOptimizerVirtual::asFramePreferencesOptimizerVirtual(wxWindow* parent, wxWindowID id,
  ...
  m_staticTextThreadsPriority =
      new wxStaticText(sbSizer15->GetStaticBox(), wxID_ANY, _("Threads priority"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_dirPickerIntermediateResults =
      new wxDirPickerCtrl(sbSizer411->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition,
                          wxDefaultSize, wxDIRP_USE_TEXTCTRL);
  ...
  m_buttonsConfirmationCancel->Connect(
      wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(asFramePreferencesOptimizerVirtual::CloseFrame), NULL, this);
  m_buttonsConfirmationOK->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                                   wxCommandEventHandler(asFramePreferencesOptimizerVirtual::SaveAndClose), NULL, this);
}
