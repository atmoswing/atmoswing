...
#ifndef ASFORECASTSCORECRPSsharpnessAR_H
#define ASFORECASTSCORECRPSsharpnessAR_H

#include <asIncludes.h>
#include "asForecastScore.h"

class asForecastScoreCRPSsharpnessAR: public asForecastScore
{
public:
     ...
     */
    asForecastScoreCRPSsharpnessAR();
