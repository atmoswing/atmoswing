...
public:
    ...
    Array1DFloat AssessOnArray(const Array1DFloat &targetDates, const Array1DFloat &forecastScores, const asTimeArray &timeArray) const;
...
#endif // ASFORECASTSCOREFINALRANKHISTOGRAM_H
