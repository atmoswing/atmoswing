...
class asTotalScoreCRPSreliability
        : public asTotalScore
{
public:
    asTotalScoreCRPSreliability(Period period);

    asTotalScoreCRPSreliability(const wxString &periodString);

    virtual ~asTotalScoreCRPSreliability();
