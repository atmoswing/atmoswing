...
float asForecastScoreRMSE::Assess(float ObservedVal, const a1f &ForcastVals, int nbElements) const
{
...
bool asForecastScoreRMSE::ProcessScoreClimatology(const a1f &refVals, const a1f &climatologyData)
{
    return true;
}
