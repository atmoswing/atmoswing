...
class asFramePreferencesDownscaler
        : public asFramePreferencesDownscalerVirtual
{
public:
    asFramePreferencesDownscaler(wxWindow *parent, wxWindowID id = asWINDOW_PREFERENCES);
