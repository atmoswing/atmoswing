...
asFrameDownscalerVirtual::asFrameDownscalerVirtual( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	wxString m_choiceMethodChoices[] = { _("Single assessment"), _("Classic downscaling"), _("Classic+ downscaling"), _("Variables exploration Classic+"), _("Monte-Carlo"), _("Genetic algorithms"), _("Evaluate all scores"), _("Only predictand values") };
	...
	sbSizer10 = new wxStaticBoxSizer( new wxStaticBox( m_panelSingle, wxID_ANY, _("Classic+ downscaling") ), wxVERTICAL );
	...
	m_staticText67 = new wxStaticText( sbSizer9->GetStaticBox(), wxID_ANY, _("Classic downscaling"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_notebookOptions->AddPage( m_panelSingle, _("Downscaling"), false );
	...
	this->Connect( m_MenuItemLogLevel3->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( asFrameDownscalerVirtual::OnLogLevel3 ) );
	this->Connect( m_menuItemAbout->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( asFrameDownscalerVirtual::OpenFrameAbout ) );
}
...
asFrameDownscalerVirtual::~asFrameDownscalerVirtual()
{
	...
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( asFrameDownscalerVirtual::OnLogLevel3 ) );
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( asFrameDownscalerVirtual::OpenFrameAbout ) );
