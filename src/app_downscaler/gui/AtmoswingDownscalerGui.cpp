...
asFrameDownscalerVirtual::asFrameDownscalerVirtual(wxWindow* parent, wxWindowID id, const wxString& title,
    ...
    m_staticTextMethod = new wxStaticText(m_panelControls, wxID_ANY, _("Select the downscaling method"),
    ...
    m_staticTextFileParameters =
        new wxStaticText(m_panelControls, wxID_ANY, _("Select the parameters file for the downscaling"),
                         wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextArchivePredictorDir = new wxStaticText(
        m_panelControls, wxID_ANY, _("Select the archive predictors directory"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextArchivePredictorDir->Wrap(-1);
    bSizer5->Add(m_staticTextArchivePredictorDir, 0, wxALL, 5);

    m_dirPickerArchivePredictor = new wxDirPickerCtrl(m_panelControls, wxID_ANY, wxEmptyString, _("Select a folder"),
    ...
    m_staticTextScenarioPredictorDir =
        new wxStaticText(m_panelControls, wxID_ANY, _("Select the predictors directory for the target period"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextScenarioPredictorDir->Wrap(-1);
    bSizer5->Add(m_staticTextScenarioPredictorDir, 0, wxALL, 5);

    m_dirPickerScenarioPredictor = new wxDirPickerCtrl(m_panelControls, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                       wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE);
    bSizer5->Add(m_dirPickerScenarioPredictor, 0, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 5);

    m_staticTextDownscalingResultsDir = new wxStaticText(
        m_panelControls, wxID_ANY, _("Directory to save downscaling outputs"), wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextDownscalingResultsDir->Wrap(-1);
    bSizer5->Add(m_staticTextDownscalingResultsDir, 0, wxALL, 5);

    m_dirPickerDownscalingResults = new wxDirPickerCtrl(m_panelControls, wxID_ANY, wxEmptyString, _("Select a folder"),
                                                        wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE);
    bSizer5->Add(m_dirPickerDownscalingResults, 0, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 5);

    m_checkBoxParallelEvaluations =
        new wxCheckBox(m_panelControls, wxID_ANY,
                       _("Parallel evaluations when possible (competes with multithreading in the processor)"),
                       wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_staticTextStateLabel =
        new wxStaticText(m_panelControls, wxID_ANY, _("Downscaling state: "), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_menuLog->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameDownscalerVirtual::OnShowLog), this,
                    m_menuItemShowLog->GetId());
    m_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameDownscalerVirtual::OnLogLevel1),
                         this, m_MenuItemLogLevel1->GetId());
    m_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameDownscalerVirtual::OnLogLevel2),
                         this, m_MenuItemLogLevel2->GetId());
    m_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameDownscalerVirtual::OnLogLevel3),
                         this, m_MenuItemLogLevel3->GetId());
    m_menuHelp->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(asFrameDownscalerVirtual::OpenFrameAbout), this,
...
asFramePreferencesDownscalerVirtual::asFramePreferencesDownscalerVirtual(wxWindow* parent, wxWindowID id,
    ...
    m_staticTextScenarioPredictorsDir =
        new wxStaticText(sbSizer18->GetStaticBox(), wxID_ANY, _("Directory containing scenario predictors"),
                         wxDefaultPosition, wxDefaultSize, 0);
    m_staticTextScenarioPredictorsDir->Wrap(-1);
    sbSizer18->Add(m_staticTextScenarioPredictorsDir, 0, wxRIGHT | wxLEFT, 5);

    m_dirPickerScenarioPredictors =
        new wxDirPickerCtrl(sbSizer18->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition,
                            wxDefaultSize, wxDIRP_USE_TEXTCTRL);
...
asFramePreferencesDownscalerVirtual::~asFramePreferencesDownscalerVirtual() {
    ...
    m_buttonsConfirmationCancel->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                            wxCommandEventHandler(asFramePreferencesDownscalerVirtual::CloseFrame),
                                            NULL, this);
