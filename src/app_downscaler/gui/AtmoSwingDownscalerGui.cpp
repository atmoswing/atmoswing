...
asFrameDownscalerVirtual::asFrameDownscalerVirtual( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	_staticTextMethod = new wxStaticText( _panelControls, wxID_ANY, _("Select the downscaling method"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	_staticTextFileParameters = new wxStaticText( _panelControls, wxID_ANY, _("Select the parameters file for the downscaling"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	_staticTextArchivePredictorDir = new wxStaticText( _panelControls, wxID_ANY, _("Select the archive predictors directory"), wxDefaultPosition, wxDefaultSize, 0 );
	_staticTextArchivePredictorDir->Wrap( -1 );
	bSizer5->Add( _staticTextArchivePredictorDir, 0, wxALL, 5 );

	_dirPickerArchivePredictor = new wxDirPickerCtrl( _panelControls, wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE );
	bSizer5->Add( _dirPickerArchivePredictor, 0, wxEXPAND|wxBOTTOM|wxRIGHT|wxLEFT, 5 );

	_staticTextScenarioPredictorDir = new wxStaticText( _panelControls, wxID_ANY, _("Select the predictors directory for the target period"), wxDefaultPosition, wxDefaultSize, 0 );
	_staticTextScenarioPredictorDir->Wrap( -1 );
	bSizer5->Add( _staticTextScenarioPredictorDir, 0, wxALL, 5 );

	_dirPickerScenarioPredictor = new wxDirPickerCtrl( _panelControls, wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE );
	bSizer5->Add( _dirPickerScenarioPredictor, 0, wxEXPAND|wxBOTTOM|wxRIGHT|wxLEFT, 5 );

	_staticTextDownscalingResultsDir = new wxStaticText( _panelControls, wxID_ANY, _("Directory to save downscaling outputs"), wxDefaultPosition, wxDefaultSize, 0 );
	_staticTextDownscalingResultsDir->Wrap( -1 );
	bSizer5->Add( _staticTextDownscalingResultsDir, 0, wxALL, 5 );

	_dirPickerDownscalingResults = new wxDirPickerCtrl( _panelControls, wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE );
	bSizer5->Add( _dirPickerDownscalingResults, 0, wxEXPAND|wxBOTTOM|wxRIGHT|wxLEFT, 5 );

	_checkBoxParallelEvaluations = new wxCheckBox( _panelControls, wxID_ANY, _("Parallel evaluations when possible (competes with multithreading in the processor)"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer5->Add( _checkBoxParallelEvaluations, 0, wxALL, 5 );

	wxBoxSizer* bSizer23;
	bSizer23 = new wxBoxSizer( wxHORIZONTAL );

	_staticTextStateLabel = new wxStaticText( _panelControls, wxID_ANY, _("Downscaling state: "), wxDefaultPosition, wxDefaultSize, 0 );
	...
	menuItemBuildPredictandDB = new wxMenuItem( _menuTools, wxID_ANY, wxString( _("Build predictand DB") ) , wxEmptyString, wxITEM_NORMAL );
	...
	// Connect Events
	_buttonSaveDefault->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( asFrameDownscalerVirtual::OnSaveDefault ), NULL, this );
	_menuOptions->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( asFrameDownscalerVirtual::OpenFramePreferences ), this, _menuItemPreferences->GetId());
	_menuTools->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( asFrameDownscalerVirtual::OpenFramePredictandDB ), this, menuItemBuildPredictandDB->GetId());
	_menuLog->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( asFrameDownscalerVirtual::OnShowLog ), this, _menuItemShowLog->GetId());
	_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( asFrameDownscalerVirtual::OnLogLevel1 ), this, _menuItemLogLevel1->GetId());
	_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( asFrameDownscalerVirtual::OnLogLevel2 ), this, _menuItemLogLevel2->GetId());
	_menuLogLevel->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( asFrameDownscalerVirtual::OnLogLevel3 ), this, _menuItemLogLevel3->GetId());
	_menuHelp->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( asFrameDownscalerVirtual::OpenFrameAbout ), this, _menuItemAbout->GetId());
}

asFrameDownscalerVirtual::~asFrameDownscalerVirtual()
{
	// Disconnect Events
	_buttonSaveDefault->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( asFrameDownscalerVirtual::OnSaveDefault ), NULL, this );
...
asFramePreferencesDownscalerVirtual::asFramePreferencesDownscalerVirtual( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	_choiceLocale = new wxChoice( sbSizer6->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, _choiceLocaleNChoices, _choiceLocaleChoices, 0 );
	_choiceLocale->SetSelection( 0 );
	sbSizer6->Add( _choiceLocale, 0, wxALL, 5 );

	_staticText21 = new wxStaticText( sbSizer6->GetStaticBox(), wxID_ANY, _("Restart AtmoSwing for the change to take effect."), wxDefaultPosition, wxDefaultSize, 0 );
	...
	_staticTextScenarioPredictorsDir = new wxStaticText( sbSizer18->GetStaticBox(), wxID_ANY, _("Directory containing scenario predictors"), wxDefaultPosition, wxDefaultSize, 0 );
	_staticTextScenarioPredictorsDir->Wrap( -1 );
	sbSizer18->Add( _staticTextScenarioPredictorsDir, 0, wxRIGHT|wxLEFT, 5 );

	_dirPickerScenarioPredictors = new wxDirPickerCtrl( sbSizer18->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a folder"), wxDefaultPosition, wxDefaultSize, wxDIRP_USE_TEXTCTRL );
	...
	// Connect Events
	_checkBoxAllowMultithreading->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( asFramePreferencesDownscalerVirtual::OnChangeMultithreadingCheckBox ), NULL, this );
	_buttonsConfirmationApply->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( asFramePreferencesDownscalerVirtual::ApplyChanges ), NULL, this );
	_buttonsConfirmationCancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( asFramePreferencesDownscalerVirtual::CloseFrame ), NULL, this );
	_buttonsConfirmationOK->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( asFramePreferencesDownscalerVirtual::SaveAndClose ), NULL, this );
}

asFramePreferencesDownscalerVirtual::~asFramePreferencesDownscalerVirtual()
{
	// Disconnect Events
	_checkBoxAllowMultithreading->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( asFramePreferencesDownscalerVirtual::OnChangeMultithreadingCheckBox ), NULL, this );
	_buttonsConfirmationApply->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( asFramePreferencesDownscalerVirtual::ApplyChanges ), NULL, this );
	_buttonsConfirmationCancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( asFramePreferencesDownscalerVirtual::CloseFrame ), NULL, this );
	_buttonsConfirmationOK->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( asFramePreferencesDownscalerVirtual::SaveAndClose ), NULL, this );
