...
asFileParametersDownscaling::asFileParametersDownscaling(const wxString &fileName, const ListFileMode &fileMode)
...
bool asFileParametersDownscaling::CheckRootElement() const
{
    ...
    if (!GetRoot()->GetAttribute("target").IsSameAs("downscaler", false) &
        !GetRoot()->GetAttribute("target").IsSameAs("downscaler", false)) {
