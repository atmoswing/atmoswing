...
TEST(DataPredictorArchiveNasaMerra2Regular, LoadEasy)
{
    double Xmin = 2.5;
    double Xwidth = 5;
    double Xstep = 0.625;
    ...
    */
    EXPECT_NEAR(91.8, hgt[0](0, 0), 0.1);
    EXPECT_NEAR(91.1, hgt[0](0, 1), 0.1);
    EXPECT_NEAR(90.3, hgt[0](0, 2), 0.1);
    EXPECT_NEAR(89.5, hgt[0](0, 3), 0.1);
    EXPECT_NEAR(86.5, hgt[0](0, 8), 0.1);
    EXPECT_NEAR(84.1, hgt[0](1, 0), 0.1);
    EXPECT_NEAR(75.2, hgt[0](2, 0), 0.1);
    EXPECT_NEAR(56.5, hgt[0](4, 0), 0.1);
    EXPECT_NEAR(61.3, hgt[0](4, 8), 0.1);
    ...
    */
    EXPECT_NEAR(83.4, hgt[7](0, 0), 0.1);
    EXPECT_NEAR(83.3, hgt[7](0, 1), 0.1);
    EXPECT_NEAR(82.8, hgt[7](0, 2), 0.1);
    EXPECT_NEAR(82.1, hgt[7](0, 3), 0.1);
    EXPECT_NEAR(78.7, hgt[7](0, 8), 0.1);
    EXPECT_NEAR(81.4, hgt[7](1, 0), 0.1);
    EXPECT_NEAR(77.6, hgt[7](2, 0), 0.1);
    EXPECT_NEAR(65.9, hgt[7](4, 0), 0.1);
    EXPECT_NEAR(57.1, hgt[7](4, 8), 0.1);

    wxDELETE(predictor);
}

TEST(DataPredictorArchiveNasaMerra2Regular, LoadComposite)
{
    double Xmin = 177.5;
    double Xwidth = 5;
    double Xstep = 0.625;
    ...
    */
    EXPECT_NEAR(18.7, hgt[0](0, 0), 0.1);
    EXPECT_NEAR(16.8, hgt[0](0, 1), 0.1);
    EXPECT_NEAR(14.8, hgt[0](0, 2), 0.1);
    EXPECT_NEAR(12.8, hgt[0](0, 3), 0.1);
    //EXPECT_NEAR(10.8, hgt[0](0, 4), 0.1);
    //EXPECT_NEAR(2.7, hgt[0](0, 8), 0.1);
    EXPECT_NEAR(24.1, hgt[0](1, 0), 0.1);
    EXPECT_NEAR(30.5, hgt[0](2, 0), 0.1);
    EXPECT_NEAR(45.7, hgt[0](4, 0), 0.1);
    //EXPECT_NEAR(30.3, hgt[0](4, 8), 0.1);
    ...
    */
    EXPECT_NEAR(-68.0, hgt[7](0, 0), 0.1);
    EXPECT_NEAR(-66.8, hgt[7](0, 1), 0.1);
    EXPECT_NEAR(-65.7, hgt[7](0, 2), 0.1);
    EXPECT_NEAR(-64.5, hgt[7](0, 3), 0.1);
    //EXPECT_NEAR(-63.3, hgt[7](0, 4), 0.1);
    //EXPECT_NEAR(-58.8, hgt[7](0, 8), 0.1);
    EXPECT_NEAR(-63.7, hgt[7](1, 0), 0.1);
    EXPECT_NEAR(-57.5, hgt[7](2, 0), 0.1);
    EXPECT_NEAR(-43.8, hgt[7](4, 0), 0.1);
    //EXPECT_NEAR(-42.4, hgt[7](4, 8), 0.1);
