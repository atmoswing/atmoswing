...
TEST(ParametersOptimizationLoadFromFile)
{
    ...
    CHECK_EQUAL(2, params.GetPreprocessLevelVector(0,1,0).size());
    CHECK_EQUAL(850, params.GetPreprocessLevelVector(0,1,0)[0]);
    CHECK_EQUAL(1000, params.GetPreprocessLevelVector(0,1,0)[1]);
    CHECK_EQUAL(6, params.GetPreprocessTimeHoursIteration(0,1,0));
    CHECK_EQUAL(-6, params.GetPreprocessTimeHoursLowerLimit(0,1,0));
    CHECK_EQUAL(24, params.GetPreprocessTimeHoursUpperLimit(0,1,0));
