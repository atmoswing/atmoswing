...
TEST(DataPredictorArchiveNcepR2Gaussian, LoadEasy)
{
    double Xmin = 7.5;
    int Xptsnb = 5;
    double Ymin = 29.523;
    ...
    asDataPredictorArchive *predictor = asDataPredictorArchive::GetInstance("NCEP_Reanalysis_v2", "flux/air2m",
                                                                            predictorDataDir);
...
TEST(DataPredictorArchiveNcepR2Gaussian, LoadComposite)
{
    double Xmin = -7.5;
    int Xptsnb = 7;
    double Ymin = 29.523;
...
TEST(DataPredictorArchiveNcepR2Gaussian, LoadBorderLeft)
{
    double Xmin = 0;
    int Xptsnb = 3;
    double Ymin = 29.523;
...
TEST(DataPredictorArchiveNcepR2Gaussian, LoadBorderLeftOn720)
{
    double Xmin = 360;
    int Xptsnb = 3;
    double Ymin = 29.523;
...
TEST(DataPredictorArchiveNcepR2Gaussian, LoadBorderRight)
{
    double Xmin = 352.5;
    int Xptsnb = 5;
    double Ymin = 29.523;
