...
TEST(DataPredictorArchiveNcepR1v2014General, LoadEasy)
{
    double Xmin = 10;
    int Xptsnb = 5;
    double Ymin = 35;
...
TEST(DataPredictorArchiveNcepR1v2014General, LoadComposite)
{
    double Xmin = -10;
    int Xptsnb = 7;
    double Ymin = 35;
...
TEST(DataPredictorArchiveNcepR1v2014General, LoadBorderLeft)
{
    double Xmin = 0;
    int Xptsnb = 3;
    double Ymin = 35;
...
TEST(DataPredictorArchiveNcepR1v2014General, LoadBorderLeftOn720)
{
    double Xmin = 360;
    int Xptsnb = 3;
    double Ymin = 35;
...
TEST(DataPredictorArchiveNcepR1v2014General, LoadBorderRight)
{
    double Xmin = 350;
    int Xptsnb = 5;
    double Ymin = 35;
...
TEST(DataPredictorArchiveNcepR1v2014General, LoadCompositeStepLon)
{
    double Xmin = -10;
    int Xptsnb = 7;
    double Ymin = 35;
...
TEST(DataPredictorArchiveNcepR1v2014General, LoadCompositeStepLonMoved)
{
    double Xmin = -7.5;
    int Xptsnb = 5;
    double Ymin = 35;
...
TEST(DataPredictorArchiveNcepR1v2014General, LoadCompositeStepLonLat)
{
    double Xmin = -10;
    int Xptsnb = 4;
    double Ymin = 35;
...
TEST(DataPredictorArchiveNcepR1v2014General, LoadCompositeStepLonLatTime)
{
    double Xmin = -10;
    int Xptsnb = 4;
    double Ymin = 35;
...
TEST(DataPredictorArchiveNcepR1v2014General, SetData)
{
    double Xmin = -10;
    int Xptsnb = 4;
    double Ymin = 35;
