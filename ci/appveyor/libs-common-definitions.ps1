...
$PROJ_URL="https://github.com/OSGeo/proj.4/archive/6.2.0.zip"
$HDF5_URL="https://support.hdfgroup.org/ftp/HDF5/releases/hdf5-1.10/hdf5-1.10.5/src/CMake-hdf5-1.10.5.zip"
$NETCDF_URL="https://github.com/Unidata/netcdf-c/archive/v4.7.2.zip"
$GDAL_URL="https://github.com/OSGeo/gdal/releases/download/v3.0.1/gdal301.zip"
